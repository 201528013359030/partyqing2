...
class Leamaterials  extends \common\models\WebService{
	...
	function __construct(){
        parent::init();
        parent::registerApi("Leamaterial.list.get",
            "getLeamateriallist",
            [
                "info"=>['type'=>'string'],
            ],
        ...
        parent::registerApi("Leamaterial.search.get",
        		"getLeamaterialsearch",
        		[
        				"info"=>['type'=>'string'],
        		],
        		false
        ...
        parent::registerApi("Leamaterial.morelist.get",
        		"getLeamaterialmorelist",
        		[
        				"info"=>['type'=>'string'],
        		],
        		false
        ...
        parent::registerApi("Leamaterial.data.get",
        		"getLeamaterialdata",
        		[
        				"info"=>['type'=>'string'],
        		],
...
//     	$condition="select * from djdongtai where top=0 and eid='".$eid[1]."'order by time desc limit 15";
    	...
    	$return['d']=array('list'=>$list,'listtop'=>$listtop,'count'=>$count,'counttop'=>$counttop);
