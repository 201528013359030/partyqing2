...
<div class="outwrap">	
	...
	<div class="innerwrap bg_form">
		...
		<div class="innerCotent">
			...
			<form id="commentForm" method="post" action="<?=Url::to(['product/update-sup'])?>">
			<input type="hidden" value = "<?php echo $detail['Id']?>" name="Form[Id]">
				<table class="mytb midTb" cellpadding="0" cellspacing="0">
					<tr>
						<td class="col-sm-3 text-center bg_lable"><div>产品标题</div></td>
						<td class="col-sm-9">
							<input type="text" name="Form[title]" class="form-control" required placeholder="产品标题" value="<?php echo $detail['title']?>">
						</td>						
					</tr>
					<tr>
					<td class="col-sm-3 text-center bg_lable">产品类型</td>
						<td class="col-sm-9">
							...
							<br>
							<select class="form-control"  id="second" onchange="setSelect(this,'third')" required >
								  <option value =''>请选择产品类型</option> 
							<?php $menus = ProductMenu::find()->where(['parent'=>$select2['parent']])->asArray()->all();?>
							...
							<br>
						<select class="form-control" name = "Form[type]"  id="third" required >

							  <option value =''>请选择产品类型</option> 
							  
							 <?php $menus = ProductMenu::find()->where(['parent'=>$select1['parent']])->asArray()->all();?>
					...
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[provider]" class="form-control" required value="<?php echo $detail['provider']?>"  placeholder="产品供应商" disabled>
							<input type="text" name="Form[provider]" class="form-control" value="<?php echo $detail['provider']?>"  placeholder="产品供应商" style="display:none">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
					...
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[quote]" class="form-control" required value="<?php echo $detail['quote']?>" placeholder="产品报价">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[brand]" class="form-control" required value="<?php echo $detail['brand']?>" placeholder="产品品牌">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[model]" class="form-control" required value="<?php echo $detail['model']?>" placeholder="产品型号">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[standard]" class="form-control" required value="<?php echo $detail['standard']?>" placeholder="产品规格">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[location]" class="form-control" required value="<?php echo $detail['location']?>" placeholder="产品所在地">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[contact_name]" class="form-control" required value="<?php echo $detail['contact_name']?>" placeholder="联系人">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[contact_tel]" class="form-control" required value="<?php echo $detail['contact_tel']?>" placeholder="联系电话">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[keyword]" class="form-control" required value="<?php echo $detail['keyword']?>" placeholder="关键词">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[number]" class="form-control" required value="<?php echo $detail['number']?>" placeholder="产品编号">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					...
					<tr>
						...
						<td class="col-sm-9">
							...
							<a href="#" class="tooltip-content"  title="请填写内容" data-placement="right">
								<script id="editor" type="text/plain" style="width:100%;height:300px;" name="Form[detail]"><?php echo $detail['detail']?></script>
							</a>
					...
					<tr>
						...
						<td class="col-sm-9">
							...
							<div id="file_list" class="inpBox inpBox_atta" style="display: block;">	
								<div id='attach1' href='#' class='attaIteam' style='display: block;'>
	    	 						<div class='icon_del fr' style='cursor:pointer;' onclick='file_del(1)'></div>
	    	 								<i class='icon_file'></i>
	    	 								<span  id='attachName1'><?php echo $image[0]['name']?></span>
	    	 								<input id='file_1' type='hidden'  name='file_list[]' value='<?php echo json_encode($image[0])?>' ></div>				
							</div>
...
// 	}
	...
	window.onload = function(){
		$('#third').val(<?php echo $detail['type']?>);
		$('#second').val(<?php echo $select2['Id']?>);
		$('#first').val(<?php echo $select3['Id']?>);
	}
</script>
