...
<div class="outwrap">	
	...
	<div class="innerwrap bg_form">
		...
		<div class="innerCotent">
			...
			<form id="commentForm" method="post" action="<?=Url::to(['product/update-req'])?>">
				...
				<table class="mytb midTb" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[title]" class="form-control" required placeholder="标题" value="<?php echo $detail['title']?>">
						</td>						
					</tr>
					<tr>
					<td class="col-sm-3 text-center bg_lable">类型</td>
						<td class="col-sm-9">
							<select class="form-control" name = "Form[type]" id="publicinfoform-type" required >
							  ...
							  <option value='<?=Html::encode($menu['Id'])?>' <?php echo ($detail['type']==$menu['Id'])?'selected':''?>><?=Html::encode($menu['name'])?></option>
...
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
					...
					<tr>
						<td class="col-sm-3 text-center bg_lable"><div>收货地址</div></td>
						<td class="col-sm-9">
							<input type="text" name="Form[address]" class="form-control" required value="<?php echo $detail['address']?>" placeholder="收货地址">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[remark]" class="form-control" value="<?php echo $detail['remark']?>" placeholder="备注">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
