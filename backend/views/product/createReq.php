...
<div class="outwrap">	
	...
	<div class="innerwrap bg_form">
		...
		<div class="innerCotent">
			...
			<form id="commentForm" method="post" action="<?=Url::to(['product/create-req'])?>">
				<table class="mytb midTb" cellpadding="0" cellspacing="0">
					<tr>
						<td class="col-sm-3 text-center bg_lable"><div>标题</div></td>
						<td class="col-sm-9">
							<input type="text" name="Form[title]" class="form-control" required placeholder="标题" value="">
						</td>						
					</tr>
					<tr>
...
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
					...
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[address]" class="form-control" required value="" placeholder="收货地址">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						...
						<td class="col-sm-9">
							<input type="text" name="Form[remark]" class="form-control" value="" placeholder="备注">
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
