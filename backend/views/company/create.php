...
<div class="innerwrap bg_form">
	...
	<div class="innerCotent">
		...
		<form id="commentForm" method="post" action="index.php?r=company/create&action=save" onSubmit="return form_Validator(this);">
			...
			<table class="mytb mytbEqu" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>
					    ...
					    <input type="text" class="form-control" name="employees"  placeholder=""  value="<?php echo $model->employees?$model->employees:0?>">
				...
				<tr>
					...
					<td colspan="5">
					   <table style="width:100%" id="tab_investor">
					       <tr>
					           <td style="width:25%">
					               <input type="text" class="form-control"  placeholder="投资者姓名"  value=""  >
					           </td>
					           <td style="width:40%">

            						<input type="text" class="form-control"  placeholder="投资金额"  value=""  >
            
            					</td>
            					<td style="width:25%">
            
            						<input type="text" class="form-control"  placeholder="所占比例" value=""  >
