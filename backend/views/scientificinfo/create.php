...
$this->title = ($flag==1)?'供应信息发布':'需求信息发布';
...
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
					...
					<tr>
						...
						<td class="col-sm-9">
							<textarea name="Form[abstract]"  id='abstract' class="form-control" rows="2" required maxlength="100" placeholder=""></textarea>
<!-- 							<input type="text" name="Form[abstract]" class="form-control" required  placeholder=""> -->
<!-- 							<p class="help-block">例如：关于异地就医直接结算政策的问题</p> -->
						</td>						
					</tr>
					<tr>
						<td class="col-sm-3 text-center bg_lable"><div>信息内容</div></td>
