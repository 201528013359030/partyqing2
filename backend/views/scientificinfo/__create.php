...
<div class="outwrap">	
	...
	<div class="innerwrap bg_form">
		...
		<div class="innerCotent">
			<div class="formTitle">发布需求信息</div>
			<form name='commentForm' id="commentForm" method="post" enctype="multipart/form-data" action="index.php?r=scientificinfo/save">
				<table class="mytb midTb" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="col-sm-9">						<a href="#" class="tooltip-type"  title="请选择信息类型" data-placement="right">
							<select class="form-control" name = "scientificinfo[type]" id="publicinfoform-type">
					...
					<tr>
						...
						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写标题" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="必填"  required name="scientificinfo[title]"><!-- 							</a> -->						</td>						
					</tr>
					<tr>
						<td class="col-sm-3 text-center bg_lable"><div>内容</div></td>
						<td class="col-sm-9">
							<textarea  class="form-control" id='publicinfoform-content' rows="10" name="scientificinfo[content]" required style="display:none"></textarea>							<!-- 							<a href="#" class="tooltip-content"  title="请填写内容" data-placement="right"> -->								<script id="editor" type="text/plain" style="width:100%;height:300px;"></script><!-- 							</a> -->							
						</td>			
					</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">有效日期至</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写联系人" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control form_datetime"  placeholder="必填"  required name="scientificinfo[validTime]"><!-- 							</a> -->						</td>											</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">联系人</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写联系人" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="必填"  required name="scientificinfo[contact_name]" value="<?php echo  Yii::$app->session['userName']?>"><!-- 							</a> -->						</td>											</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">联系电话</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写联系电话" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="必填"  required name="scientificinfo[contact_phone]" value="<?php Yii::$app->session['user.mobile']?>"><!-- 							</a> -->						</td>											</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">联系邮箱</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写联系邮箱" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="非必填"  name="scientificinfo[contact_email]"><!-- 							</a> -->						</td>											</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">联系单位</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写联系邮箱" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="必填"  required name="scientificinfo[contact_unit]" value="<?php \Yii::$app->session['user.company']?>"><!-- 							</a> -->						</td>											</tr>										<tr>						<td class="col-sm-3 text-center bg_lable">备注</td>						<td class="col-sm-9"><!-- 							<a href="#" class="tooltip-title"  title="请填写备注" data-placement="right"> -->								<input type="text" id="publicinfoform-title" class="form-control"  placeholder="非必填" name="scientificinfo[remarks]"><!-- 							</a> -->						</td>											</tr>
					<tr>
			...
			<div style="#display: none;">				<input id="publicinfoform-attach1" type="hidden" name="scientificinfo[attach1]" value="">				<input id="publicinfoform-attach2" type="hidden" name="scientificinfo[attach2]" value="">				<input id="publicinfoform-attach3" type="hidden" name="scientificinfo[attach3]" value="">				<input id="publicinfoform-attachCount" type="hidden" name="scientificinfo[attachCount]" value=0>			</div>
