...
(function (e) {
	...
	(function (e) {
		...
		t = n = s = function (t, n, r, a, f) {
			return typeof t == "string" ? u[t] ? u[t](n) : b(o(t, n).f) : (t.splice || (l = t, n.splice ? (t = n, n = r, r = null) : t = e), n = n || function () {}, typeof r == "function" && (r = a, a = f), a ? i(e, t, n, r) : setTimeout(function () {
					i(e, t, n, r)
				}, 4), s)
		},
		s.config = function (e) {
	...
	r("zrender/lib/excanvas", ["require"], function (e) {
		return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function () {
			...
			function d(e) {
				p(e, "g_vml_", "urn:schemas-microsoft-com:vml"),
				p(e, "g_o_", "urn:schemas-microsoft-com:office:office");
			...
			function A(e, t, n) {
				return n < 0 && n++,
				n > 1 && n--,
				6 * n < 1 ? e + (t - e) * 6 * n : 2 * n < 1 ? t : 3 * n < 2 ? e + (t - e) * (2 / 3 - n) * 6 : e
			}
			function M(e) {
				if (e in O)
					return O[e];
			...
			function H(e, t) {
				...
				s = parseFloat(e.size);
				return typeof e.size == "number" ? n.size = e.size : e.size.indexOf("px") != -1 ? n.size = s : e.size.indexOf("em") != -1 ? n.size = i * s : e.size.indexOf("%") != -1 ? n.size = i / 100 * s : e.size.indexOf("pt") != -1 ? n.size = s / .75 : n.size = i,
				n
			}
			function B(e) {
			...
			function U(e, t) {
				...
				s < 1 && (i *= s),
				t.push("<g_vml_:stroke", ' opacity="', i, '"', ' joinstyle="', e.lineJoin, '"', ' miterlimit="', e.miterLimit, '"', ' endcap="', F(e.lineCap), '"', ' weight="', s, 'px"', ' color="', r, '" />')
			}
			function z(t, n, r, i) {
				var s = t.fillStyle,
				u = t.arcScaleX_,
			...
			function Q(e) {
				(!e || e.nodeType != 1 || e.tagName != "IMG") && K("TYPE_MISMATCH_ERR"),
				e.readyState != "complete" && K("INVALID_STATE_ERR")
			}
			function G(e) {
				this.code = this[e],
			...
			var v = {
				init : function (e) {
					...
					t.attachEvent("onreadystatechange", c(this.init_, this, t))
				},
				init_ : function (e) {
			...
			q.drawImage = function (n, r) {
				...
				if (this.m_[0][0] != 1 || this.m_[0][1] || this.m_[1][1] != 1 || this.m_[1][0]) {
					var T = [];
					x = Math.sqrt(this.m_[0][0] * this.m_[0][0] + this.m_[0][1] * this.m_[0][1]),
					scaleY = Math.sqrt(this.m_[1][0] * this.m_[1][0] + this.m_[1][1] * this.m_[1][1]),
					T.push("M11=", this.m_[0][0] / x, ",", "M12=", this.m_[1][0] / scaleY, ",", "M21=", this.m_[0][1] / x, ",", "M22=", this.m_[1][1] / scaleY, ",", "Dx=", t(g.x / o), ",", "Dy=", t(g.y / o), "");
					var N = g,
					C = W(this, i + u, s),
					k = W(this, i, s + a),
					L = W(this, i + u, s + a);
					N.x = e.max(N.x, C.x, k.x, L.x),
					N.y = e.max(N.y, C.y, k.y, L.y),
					w.push("padding:0 ", t(N.x / o), "px ", t(N.y / o), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", T.join(""), ", sizingmethod='clip');")
				} else
					w.push("top:", t(g.y / o), "px;left:", t(g.x / o), "px;");
				w.push(' ">'),
				(f || l) && w.push('<div style="overflow: hidden; width:', Math.ceil((u + f * u / c) * x), "px;", " height:", Math.ceil((a + l * a / h) * scaleY), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -f * u / c * x, ",Dy=", -l * a / h * scaleY, ');">'),
				w.push('<div style="width:', Math.round(x * v * u / c), "px;", " height:", Math.round(scaleY * m * a / h), "px;", " filter:"),
				this.globalAlpha < 1 && w.push(" progid:DXImageTransform.Microsoft.Alpha(opacity=" + this.globalAlpha * 100 + ")"),
				w.push(" progid:DXImageTransform.Microsoft.AlphaImageLoader(src=", n.src, ',sizingMethod=scale)">'),
				(f || l) && w.push("</div>"),
				w.push("</div></div>"),
			...
			q.drawText_ = function (e, n, r, i, s) {
				...
				p.push('<g_vml_:line from="', -f, ' 0" to="', l, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !s, '" stroked="', !!s, '" style="position:absolute;width:1px;height:1px;">'),
				s ? U(this, p) : z(this, p, {
					x : -f,
					y : 0
				}, {
				...
				w = t(y.x / o) + "," + t(y.y / o);
				p.push('<g_vml_:skew on="t" matrix="', b, '" ', ' offset="', w, '" origin="', f, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', h(e), '" style="v-text-align:', g, ";font:", h(v), '" /></g_vml_:line>'),
	...
	r("zrender/tool/util", ["require", "../lib/excanvas"], function (e) {
		...
		function r(e, n, r, s) {
			if (n.hasOwnProperty(r))
				if (typeof e[r] == "object" && !t[Object.prototype.toString.call(e[r])])
					i(e[r], n[r], s);
				else if (s || !(r in e))
					e[r] = n[r]
		}
		...
		function o() {
			if (!s) {
				...
				if (G_vmlCanvasManager) {
					...
					s = G_vmlCanvasManager.initElement(t).getContext("2d")
				} else
		...
		function p() {
			return a || (u = document.createElement("canvas"), f = u.width, l = u.height, a = u.getContext("2d")),
			a
		}
		function d(e, t) {
			var n = 100,
			r;
			e + c > f && (f = e + c + n, u.width = f, r = !0),
			t + h > l && (l = t + h + n, u.height = l, r = !0),
			e < -c && (c = Math.ceil(-e / n) * n, f += c, u.width = f, r = !0),
			t < -h && (h = Math.ceil(-t / n) * n, l += h, u.height = l, r = !0),
			r && a.translate(c, h)
		}
		function v() {
			return {
	...
	r("zrender/tool/event", [], function () {
		...
		i.prototype.unbind = function (e, t) {
			...
			if (t) {
				if (n[e]) {
					var r = [];
					for (var i = 0, s = n[e].length; i < s; i++)
	...
	r("zrender/tool/env", [], function () {
		function e(e) {
			...
			if (n.webkit = !!r)
				n.version = r[1];
			return i && (t.android = !0, t.version = i[2]),
			u && !o && (t.ios = t.iphone = !0, t.version = u[2].replace(/_/g, ".")),
			s && (t.ios = t.ipad = !0, t.version = s[2].replace(/_/g, ".")),
			o && (t.ios = t.ipod = !0, t.version = o[3] ? o[3].replace(/_/g, ".") : null),
			a && (t.webos = !0, t.version = a[2]),
			f && (t.touchpad = !0),
			h && (t.blackberry = !0, t.version = h[2]),
			p && (t.bb10 = !0, t.version = p[2]),
			d && (t.rimtabletos = !0, t.version = d[2]),
			v && (n.playbook = !0),
			l && (t.kindle = !0, t.version = l[1]),
			c && (n.silk = !0, n.version = c[1]),
			!c && t.android && e.match(/Kindle Fire/) && (n.silk = !0),
			m && (n.chrome = !0, n.version = m[1]),
			g && (n.firefox = !0, n.version = g[1]),
			y && (n.ie = !0, n.version = y[1]),
			b && (e.match(/Safari/) || !!t.ios) && (n.safari = !0),
			w && (n.webview = !0),
			y && (n.ie = !0, n.version = y[1]),
			t.tablet = !!(s || v || i && !e.match(/Mobile/) || g && e.match(/Tablet/) || y && !e.match(/Phone/) && e.match(/Touch/)),
			t.phone = !!(!t.tablet && !t.ipod && (i || u || a || h || p || m && e.match(/Android/) || m && e.match(/CriOS\/([\d.]+)/) || g && e.match(/Mobile/) || y && e.match(/Touch/))), {
				browser : n,
				os : t,
	...
	r("zrender/Handler", ["require", "./config", "./tool/env", "./tool/event", "./tool/util"], function (e) {
		...
		function l(e, t, i) {
			...
			this._findHover = a(h, this),
			this._domHover = i.getDomHover(),
			f(this),
			window.addEventListener ? (window.addEventListener("resize", this._resizeHandler), n.os.tablet || n.os.phone ? (e.addEventListener("touchstart", this._touchstartHandler), e.addEventListener("touchmove", this._touchmoveHandler), e.addEventListener("touchend", this._touchendHandler)) : (e.addEventListener("click", this._clickHandler), e.addEventListener("mousewheel", this._mousewheelHandler), e.addEventListener("mousemove", this._mousemoveHandler), e.addEventListener("mousedown", this._mousedownHandler), e.addEventListener("mouseup", this._mouseupHandler)), e.addEventListener("DOMMouseScroll", this._mousewheelHandler), e.addEventListener("mouseout", this._mouseoutHandler)) : (window.attachEvent("onresize", this._resizeHandler), e.attachEvent("onclick", this._clickHandler), e.attachEvent("onmousewheel", this._mousewheelHandler), e.attachEvent("onmousemove", this._mousemoveHandler), e.attachEvent("onmouseout", this._mouseoutHandler), e.attachEvent("onmousedown", this._mousedownHandler), e.attachEvent("onmouseup", this._mouseupHandler))
		}
		function h(e) {
			...
			if (e.isCover(this._mouseX, this._mouseY)) {
				...
				var n = e.parent;
				while (n) {
					if (n.clipShape && !n.clipShape.isCover(this._mouseX, this._mouseY))
						return !1;
					n = n.parent
				}
				return this._lastHover != e && (this._processOutShape(t), this._processDragLeave(t), this._lastHover = e, this._processDragEnter(t)),
				this._processOverShape(t),
				this._processDragOver(t),
				this._hasfound = 1,
				!0
			}
			return !1
		...
		u = {
			resize : function (e) {
				...
				this._isMouseDown = 0,
				this.dispatch(s.RESIZE, e)
			},
			click : function (e) {
				e = this._zrenderEventFixed(e);
				var t = this._lastHover;
				(t && t.clickable || !t) && this._dispatchAgency(t, s.CLICK, e),
				this._mousemoveHandler(e)
			},
			mousewheel : function (e) {
				e = this._zrenderEventFixed(e),
				this._dispatchAgency(this._lastHover, s.MOUSEWHEEL, e),
				this._mousemoveHandler(e)
			},
			mousemove : function (e) {
				...
				var t = "default";
				this._draggingTarget || this._hasfound && this._lastHover.draggable ? t = "move" : this._hasfound && this._lastHover.clickable && (t = "pointer"),
				this.root.style.cursor = t,
				this._dispatchAgency(this._lastHover, s.MOUSEMOVE, e),
			...
			mousedown : function (e) {
				...
				this._dispatchAgency(this._lastHover, s.MOUSEDOWN, e),
				this._lastDownButton = e.button
			},
			mouseup : function (e) {
				e = this._zrenderEventFixed(e),
				...
				this._isMouseDown = 0,
				this._mouseDownTarget = null,
				this._dispatchAgency(this._lastHover, s.MOUSEUP, e),
				this._processDrop(e),
				this._processDragEnd(e)
			},
			...
			touchend : function (e) {
				...
				new Date - this._lastTouchMoment < s.touchClickDelay && (this._mobildFindFixed(e), this._clickHandler(e)),
				this.painter.clearHover()
			}
		};
		...
		l.prototype._processDragStart = function (e) {
			...
			if (this._isMouseDown && t && t.draggable && !this._draggingTarget && this._mouseDownTarget == t) {
				...
				this._dispatchAgency(n, s.DRAGSTART, e),
		...
		l.prototype._processDragEnd = function (e) {
			this._draggingTarget && (this._dispatchAgency(this._draggingTarget, s.DRAGEND, e), this._lastHover = null),
			this._isDragging = 0,
		...
		l.prototype._zrenderEventFixed = function (e, t) {
			...
			if (!t) {
				...
				if (r) {
					...
					e.zrenderX = r.clientX - i.left,
					e.zrenderY = r.clientY - i.top
				}
			}
			return e.zrenderFixed = 1,
			e
		},
		i.merge(l.prototype, r.Dispatcher.prototype, !0),
		l
	}),
	...
	r("zrender/shape/mixin/Transformable", ["require", "../../tool/matrix"], function (e) {
		...
		r = function () {
			...
			typeof this.rotation == "undefined" && (this.rotation = [0, 0, 0]),
		...
		return r.prototype = {
			...
			updateTransform : function () {
				...
				this.parent ? this.needTransform = this.needLocalTransform || this.parent.needTransform : this.needTransform = this.needLocalTransform;
				...
				if (this.needLocalTransform) {
					if (this.scale && (this.scale[0] !== 1 || this.scale[1] !== 1)) {
						n[0] = -this.scale[2] || 0,
						n[1] = -this.scale[3] || 0,
						(n[0] || n[1]) && t.translate(e, e, n),
						t.scale(e, e, this.scale);
						if (n[0] || n[1])
							n[0] = -n[0], n[1] = -n[1], t.translate(e, e, n)
					}
					if (this.rotation)
						if (this.rotation instanceof Array) {
							if (this.rotation[0] !== 0) {
								n[0] = -this.rotation[1] || 0,
								n[1] = -this.rotation[2] || 0,
								(n[0] || n[1]) && t.translate(e, e, n),
								t.rotate(e, e, this.rotation[0]);
								if (n[0] || n[1])
									n[0] = -n[0], n[1] = -n[1], t.translate(e, e, n)
							}
						} else
							this.rotation !== 0 && t.rotate(e, e, this.rotation);
					this.position && (this.position[0] !== 0 || this.position[1] !== 0) && t.translate(e, e, this.position)
				}
				this.transform = e,
				this.parent && this.parent.needTransform && (this.needLocalTransform ? t.mul(this.transform, this.parent.transform, this.transform) : t.copy(this.transform, this.parent.transform))
			},
	...
	r("zrender/tool/color", ["require", "../tool/util"], function (e) {
		...
		function E(e, t) {
			var n = F(e),
			r = n[3];
			return typeof r == "undefined" && (r = 1),
			e.indexOf("hsb") > -1 ? n = U(n) : e.indexOf("hsl") > -1 && (n = z(n)),
			t.indexOf("hsb") > -1 || t.indexOf("hsv") > -1 ? n = X(n) : t.indexOf("hsl") > -1 && (n = V(n)),
			n[3] = r,
			b(n, t)
		}
		function S(e) {
		...
		function P(e, t) {
			...
			var r = F(e);
			for (var i = 0; i < 3; i++)
				n === 1 ? r[i] = r[i] * (1 - t) | 0 : r[i] = (255 - r[i]) * t + r[i] | 0;
			return "rgb(" + r.join(",") + ")"
		}
		function H(e) {
			var t = F(S(e));
		...
		function B(e, t, n) {
			...
			i[3] === 1 && s[3] === 1 ? b(f, "rgb") : (f[3] = c, b(f, "rgba"))
		}
		function j() {
		...
		function F(e) {
			...
			if (t[2])
				...
				s = o.slice(0, 3),
				i = q(s, function (e) {
						return e = Math.floor(e.indexOf("%") > 0 ? parseInt(e, 0) * 2.55 : e),
						R(e, [0, 255])
					}),
		...
		function I(e, t) {
			t === null && (t = 1);
			var n = F(S(e));
			return n[3] = R(Number(t).toFixed(4), [0, 1]),
			b(n, "rgba")
		}
		function q(e, t) {
		...
		function U(e) {
			...
			if (n === 0)
				...
				p = 0,
				d = 0;
				a === 0 ? (h = r, p = c, d = f) : a === 1 ? (h = l, p = r, d = f) : a === 2 ? (h = f, p = r, d = c) : a === 3 ? (h = f, p = l, d = r) : a === 4 ? (h = c, p = f, d = r) : (h = r, p = f, d = l),
				i = h * 255,
				s = p * 255,
				o = d * 255
			}
		...
		function X(e) {
			...
			if (o === 0)
				...
				c = ((s - n) / 6 + o / 2) / o,
				h = ((s - r) / 6 + o / 2) / o;
				t === s ? a = h - c : n === s ? a = 1 / 3 + l - h : r === s && (a = 2 / 3 + c - l),
				a < 0 && (a += 1),
				a > 1 && (a -= 1)
			}
			return a *= 360,
	...
	r("zrender/shape/Base", ["require", "../tool/matrix", "../tool/guid", "../tool/util", "./mixin/Transformable", "../tool/event", "../tool/area", "../tool/area", "../tool/color", "../tool/area"], function (e) {
		...
		a.prototype.invisible = !1,
		a.prototype.ignore = !1,
		a.prototype.zlevel = 0,
		a.prototype.draggable = !1,
		a.prototype.clickable = !1,
		a.prototype.hoverable = !0,
		a.prototype.z = 0,
		a.prototype.brush = function (e, t) {
			var n = this.style;
			this.brushTypeOnly && (n.brushType = this.brushTypeOnly),
			t && (n = this.getHighlightStyle(n, this.highlightStyle || {}, this.brushTypeOnly)),
			this.brushTypeOnly == "stroke" && (n.strokeColor = n.strokeColor || n.color),
			e.save(),
			this.setContext(e, n),
			this.setTransform(e),
			e.beginPath(),
			this.buildPath(e, n),
			this.brushTypeOnly != "stroke" && e.closePath();
			switch (n.brushType) {
			case "both":
				e.fill();
			case "stroke":
		...
		a.prototype.getTansform = function () {
			...
			return function (n, r) {
				var i = [n, r];
				return this.needTransform && this.transform && (t.invert(e, this.transform), t.mulVector(i, e, [n, r, 1]), n == i[0] && r == i[1] && this.updateNeedTransform()),
				i
			}
		}
		(),
		a.prototype.isCover = function (t, n) {
			...
			t >= i.x && t <= i.x + i.width && n >= i.y && n <= i.y + i.height ? e("../tool/area").isInside(this, this.style, t, n) : !1
		},
		a.prototype.drawText = function (e, t, n) {
			if (typeof t.text == "undefined" || t.text === !1)
				return;
			...
			a,
			f,
			l = t.textPosition || this.textPosition || "top";
			switch (l) {
			case "inside":
			case "top":
			case "bottom":
			...
			case "right":
				if (this.getRect) {
					...
					case "inside":
						...
						s = "center",
						u = "middle",
						t.brushType != "stroke" && r == t.color && (e.fillStyle = "#fff");
						break;
					case "left":
						a = c.x - i,
						f = c.y + c.height / 2,
			...
			case "end":
				...
				if (typeof t.pointList != "undefined") {
					...
					h = t.xStart || 0, p = t.xEnd || 0, d = t.yStart || 0, v = t.yEnd || 0;
				switch (l) {
				case "start":
					s = h < p ? "end" : "start",
					u = d < v ? "bottom" : "top",
				...
				i -= 4,
				h != p ? a -= s == "end" ? i : -i : s = "center",
				d != v ? f -= u == "bottom" ? i : -i : u = "middle";
				break;
			case "specific":
				a = t.textX || 0,
				f = t.textY || 0,
		...
		r.merge(a.prototype, i.prototype, !0),
		r.merge(a.prototype, s.prototype, !0),
		a
	}),
		...
		return n.prototype = {
				...
				for (r = 1; r < i.length; r++) {
					...
					while (l.length > 0) {
						...
						case "V":
							...
							break;
						case "C":
							p.push(l.shift(), l.shift(), l.shift(), l.shift()),
							o = l.shift(),
							u = l.shift(),
							p.push(o, u);
							break;
						case "c":
							p.push(o + l.shift(), u + l.shift(), o + l.shift(), u + l.shift()),
							o += l.shift(),
							u += l.shift(),
							h = "C",
							p.push(o, u);
						...
						case "S":
							...
							v = u,
							m = s[s.length - 1],
							m.command === "C" && (d = o + (o - m.points[2]), v = u + (u - m.points[3])),
							p.push(d, v, l.shift(), l.shift()),
							o = l.shift(),
							u = l.shift(),
							h = "C",
							p.push(o, u);
						...
						case "s":
							...
							m = s[s.length - 1],
							m.command === "C" && (d = o + (o - m.points[2]), v = u + (u - m.points[3])),
							p.push(d, v, o + l.shift(), u + l.shift()),
							o += l.shift(),
							u += l.shift(),
							h = "C",
							p.push(o, u);
							break;
						case "Q":
							p.push(l.shift(), l.shift()),
							o = l.shift(),
							u = l.shift(),
							p.push(o, u);
							break;
						case "q":
							p.push(o + l.shift(), u + l.shift()),
							o += l.shift(),
							u += l.shift(),
							h = "Q",
							p.push(o, u);
						...
						case "T":
							...
							v = u,
							m = s[s.length - 1],
							m.command === "Q" && (d = o + (o - m.points[0]), v = u + (u - m.points[1])),
							o = l.shift(),
							u = l.shift(),
							h = "Q",
							p.push(d, v, o, u);
						...
						case "A":
							...
							u = l.shift(),
							h = "A",
							p = this._convertPoint(S, x, o, u, w, E, g, y, b);
							break;
						case "a":
							g = l.shift(),
							y = l.shift(),
			...
			buildPath : function (e, t) {
				...
				for (var f = 0, l = r.length; f < l; f++) {
					r[f].command.toUpperCase() == "M" && (a.length > 0 && u.push(a), a = []),
					o = r[f].points;
	...
	r("zrender/tool/area", ["require", "../tool/util", "../shape/Path"], function (e) {
		function a(e, r, i, s) {
			...
			var o = e.type;
			n = n || t.getContext();
			if (!g(r.__rect || e.getRect(r), i, s))
				return !1;
			var u = f(o, r, i, s);
			if (typeof u != "undefined")
				return u;
			if (o != "bezier-curve" && e.buildPath && n.isPointInPath)
				return l(e, n, r, i, s);
			if (n.getImageData)
				return c(e, r, i, s);
			switch (o) {
		...
		function v(e, t, n) {
			...
			for (var s = 0, o = r.length - 1; s < o; s++) {
				...
				i.xEnd = r[s + 1][0],
				i.yEnd = r[s + 1][1],
				i.lineWidth = Math.max(e.lineWidth, 10);
				if (d(i, t, n))
					return !0
			}
			return !1
		...
		function S(e, i) {
			...
			for (var f = 0, l = e.length; f < l; f++)
				a = Math.max(n.measureText(e[f]).width, a);
			return n.restore(),
			r[o] = a,
			++s > u && (s = 0, r = {}),
			a
	...
	r("zrender/shape/Text", ["require", "../tool/area", "./Base", "../tool/util"], function (e) {
		...
		return r.prototype = {
			...
			brush : function (e, n) {
				...
				if (typeof r.text == "undefined" || r.text === !1)
					return;
				e.save(),
				this.setContext(e, r),
				this.setTransform(e),
				r.textFont && (e.font = r.textFont),
				e.textAlign = r.textAlign || "start",
				e.textBaseline = r.textBaseline || "middle";
				var i = (r.text + "").split("\n"),
	...
	r("zrender/shape/Rectangle", ["require", "./Base", "../tool/util"], function (e) {
		...
		return n.prototype = {
			...
			_buildRadiusPath : function (e, t) {
				...
				e.moveTo(n + u, r),
				e.lineTo(n + i - a, r),
				a !== 0 && e.quadraticCurveTo(n + i, r, n + i, r + a),
				e.lineTo(n + i, r + s - f),
				f !== 0 && e.quadraticCurveTo(n + i, r + s, n + i - f, r + s),
				e.lineTo(n + l, r + s),
				l !== 0 && e.quadraticCurveTo(n, r + s, n, r + s - l),
				e.lineTo(n, r + u),
				u !== 0 && e.quadraticCurveTo(n, r, n + u, r)
			},
			buildPath : function (e, t) {
			...
			brush : function (e, i, s) {
				...
				if (u) {
					...
					if (o.sWidth && o.sHeight) {
						...
						e.drawImage(u, h, p, l, c);
					o.width = l,
					o.height = c,
					this.style.width = l,
					this.style.height = c,
					this.drawText(e, o, this.style),
					e.restore()
				}
			},
			buildPath : function (e, t) {
	...
	r("zrender/Painter", ["require", "./config", "./tool/util", "./tool/log", "./tool/matrix", "./loadingEffect/Base", "./shape/Image"], function (e) {
		...
		function c(e, t, n) {
			...
			r.style.width = i + "px",
			r.style.height = s + "px",
			r.setAttribute("width", i * o),
			r.setAttribute("height", s * o),
			r.setAttribute("data-zr-dom-id", e),
			r
		}
		function h(e, t) {
			this.dom = c(e, "canvas", t),
			u && u.initElement(this.dom),
			this.domBack = null,
			this.ctxBack = null,
			this.painter = t,
			this.unusedCount = 0,
		...
		l.prototype._paintList = function (e, n) {
			...
			for (var f in this._layers)
				f !== "hover" && this._layers[f].unusedCount++;
			var l = [];
			...
			for (var f in this._layers)
				if (f !== "hover") {
					...
					g.dirty = !1,
					g.unusedCount >= 500 ? (delete this._layers[f], g.dom.parentNode.removeChild(g.dom)) : g.unusedCount == 1 && g.clear()
				}
		},
		l.prototype.getLayer = function (e, t) {
			...
			if (!n) {
				...
				r.nextSibling ? r.parentNode.insertBefore(n.dom, r.nextSibling) : r.parentNode.appendChild(n.dom),
				n.initContext(),
				this._layers[e] = n,
				n.config = this._layerConfig[e]
			}
			return n
		},
		l.prototype._updateLayerStatus = function (e) {
			...
			n = {};
			for (var r in t)
				r !== "hover" && (n[r] = t[r].elCount, t[r].elCount = 0);
			for (var i = 0, s = e.length; i < s; i++) {
				var o = e[i],
				u = o.zlevel,
				a = t[u];
			...
			for (var r in t)
				r !== "hover" && n[r] !== t[r].elCount && (t[r].dirty = !0)
		},
		...
		l.prototype.toDataURL = function (e, n, i) {
			...
			o != 1 && a.scale(o, o),
			a.fillStyle = n || "#fff",
			a.rect(0, 0, this._width * o, this._height * o),
			a.fill(),
		...
		l.prototype._shapeToImage = function (t, n, r, i, s) {
			...
			o.style.width = r + "px",
			o.style.height = i + "px",
			o.setAttribute("width", r * s),
			o.setAttribute("height", i * s),
			u.clearRect(0, 0, r * s, i * s);
			var a = {
				position : n.position,
				rotation : n.rotation,
				scale : n.scale
			...
			return a.position != null && (l.position = n.position = a.position),
			a.rotation != null && (l.rotation = n.rotation = a.rotation),
			a.scale != null && (l.scale = n.scale = a.scale),
			l
		},
		...
		h.prototype.initContext = function () {
			...
			o != 1 && this.ctx.scale(o, o)
		},
		h.prototype.createBackBuffer = function () {
			if (u)
				return;
			this.domBack = c("back-" + this.id, "canvas", this.painter),
			this.ctxBack = this.domBack.getContext("2d"),
			o != 1 && this.ctxBack.scale(o, o)
		},
		h.prototype.resize = function (e, t) {
			this.dom.style.width = e + "px",
			this.dom.style.height = t + "px",
			this.dom.setAttribute("width", e * o),
			this.dom.setAttribute("height", t * o),
			o != 1 && this.ctx.scale(o, o),
			this.domBack && (this.domBack.setAttribute("width", e * o), this.domBack.setAttribute("height", t * o), o != 1 && this.ctxBack.scale(o, o))
		},
		h.prototype.clear = function () {
			...
			if (e) {
				...
				a = e.motionBlur && !u,
				f = e.lastFrameAlpha;
				typeof f == "undefined" && (f = .7),
				a && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(t, 0, 0, r / o, i / o)),
				s ? (n.save(), n.fillStyle = this.config.clearColor, n.fillRect(0, 0, r / o, i / o), n.restore()) : n.clearRect(0, 0, r / o, i / o);
				if (a) {
					var l = this.domBack;
					n.save(),
					n.globalAlpha = f,
					n.drawImage(l, 0, 0, r / o, i / o),
					n.restore()
				}
			} else
				n.clearRect(0, 0, r / o, i / o)
		},
		l
	}),
	r("zrender/shape/Group", ["require", "../tool/guid", "../tool/util", "../tool/event", "./mixin/Transformable"], function (e) {
		...
		s.prototype.addChild = function (e) {
			...
			e.parent = this,
			this._storage && this._storage !== e._storage && (this._storage.addToMap(e), e instanceof s && e.addChildrenToStorage(this._storage))
		},
		s.prototype.removeChild = function (e) {
			var t = n.indexOf(this._children, e);
			this._children.splice(t, 1),
			e.parent = null,
			e._storage && (this._storage.delFromMap(e.id), e instanceof s && e.delChildrenFromStorage(e._storage))
		},
		...
		s.prototype.addChildrenToStorage = function (e) {
			for (var t = 0; t < this._children.length; t++) {
				...
				e.addToMap(n),
				n.type === "group" && n.addChildrenToStorage(e)
			}
		},
		s.prototype.delChildrenFromStorage = function (e) {
			for (var t = 0; t < this._children.length; t++) {
				var n = this._children[t];
				e.delFromMap(n),
				n.type === "group" && n.delChildrenFromStorage(e)
			}
		},
		n.merge(s.prototype, i.prototype, !0),
		n.merge(s.prototype, r.prototype, !0),
		s
	}),
	r("zrender/Storage", ["require", "./tool/util", "./shape/Group"], function (e) {
		...
		s.prototype.getHoverShapes = function (e) {
			if (e)
				for (var t = 0, n = this._hoverElements.length; t < n; t++)
					this._hoverElements[t].updateTransform();
		...
		s.prototype.updateShapeList = function () {
			...
			for (var e = 0, t = this._shapeList.length; e < t; e++)
		...
		s.prototype.mod = function (e, r) {
			...
			if (i) {
				i instanceof n || (i.style.__rect = null),
				i.__dirty = !0;
				if (r)
					if (r.parent || r._storage || r.__startClip) {
						var s = {};
						for (var o in r) {
							if (o == "parent" || o == "_storage" || o == "__startClip")
								continue;
		...
		s.prototype.drift = function (e, t, n) {
			...
			return r && (r.needTransform = !0, (!r.ondrift || r.ondrift && !r.ondrift(t, n)) && r.drift(t, n)),
			this
		},
		...
		s.prototype.addToMap = function (e) {
			return e instanceof n ? e._storage = this : e.style.__rect = null,
	...
	r("zrender/animation/Clip", ["require", "./easing"], function (e) {
		function n(e) {
			...
			this.loop = typeof e.loop == "undefined" ? !1 : e.loop,
			this.gap = e.gap || 0,
		...
		return n.prototype = {
			step : function (e) {
				...
				return this.fire("frame", i),
				n == 1 ? this.loop ? (this.restart(), "restart") : (this._needsRemove = !0, "destroy") : null
			},
			restart : function () {
	...
	r("zrender/animation/Animation", ["require", "./Clip", "../tool/color", "../tool/util", "../tool/event"], function (e) {
		...
		function p(e, t, n, r, i, s, o, u, a) {
			...
			if (a == 1)
				for (var l = 0; l < f; l++)
					u[l] = d(e[l], t[l], n[l], r[l], i, s, o);
			else {
				var c = e[0].length;
				for (var l = 0; l < f; l++)
					for (var h = 0; h < c; h++)
						u[l][h] = d(e[l][h], t[l][h], n[l][h], r[l][h], i, s, o)
			}
		}
		...
		return u.prototype = {
			...
			update : function () {
				...
				for (var o = 0; o < r; )
					n[o]._needsRemove ? (n[o] = n[r - 1], n.pop(), r--) : o++;
				r = i.length;
				for (var o = 0; o < r; o++)
					s[o].fire(i[o]);
				this._time = e,
		...
		g.prototype = {
			when : function (e, t) {
				for (var n in t)
					this._tracks[n] || (this._tracks[n] = [], e !== 0 && this._tracks[n].push({
							time : 0,
			...
			start : function (e) {
				...
				f = function (f, v) {
					...
					for (var N = 0; N < g; N++) {
						x.push(f[N].time / S);
						var C = f[N].value;
						typeof C == "string" && (C = n.toArray(C), C.length === 0 && (C[0] = C[1] = C[2] = 0, C[3] = 1), w = !0),
						T.push(C)
					}
					var k = 0,
					L = 0,
					...
					var B = function (e, t) {
						...
						if (u) {
							...
							P = T[N > g - 3 ? g - 1 : N + 2];
							if (b)
								p(M, _, D, P, O, O * O, O * O * O, s(e, v), E);
							else {
								var a;
								w ? (a = p(M, _, D, P, O, O * O, O * O * O, H, 1), a = m(H)) : a = d(M, _, D, P, O, O * O, O * O * O),
								i(e, v, a)
							}
						} else if (b)
							c(T[N], T[N + 1], O, s(e, v), E);
						else {
							var a;
							w ? (c(T[N], T[N + 1], O, H, 1), a = m(H)) : a = l(T[N], T[N + 1], O),
							i(e, v, a)
						}
						for (N = 0; N < o; N++)
							r._onframeList[N](e, t)
					},
					j = new t({
							target : r._target,
							life : S,
	...
	r("zrender/zrender", ["require", "./lib/excanvas", "./tool/util", "./tool/log", "./tool/guid", "./Handler", "./Painter", "./Storage", "./animation/Animation", "./tool/env"], function (e) {
		...
		function c(t, n) {
			...
			this.handler = new i(n, this.storage, this.painter),
		...
		c.prototype.update = function (e, t) {
			return this.painter.update(e, t),
			this
		},
		...
		c.prototype.animate = function (e, r, i) {
			...
			if (s) {
				...
				return typeof s.__aniCount == "undefined" && (s.__aniCount = 0),
				s.__aniCount === 0 && c.push(s),
				s.__aniCount++,
				this.animation.animate(o, {
					loop : i
				}).done(function () {
					s.__aniCount--;
					if (s.__aniCount === 0) {
		...
		c.prototype.dispose = function () {
			...
			this.animation = this.animatingShapes = this.storage = this.painter = this.handler = null,
			f.delInstance(this.id)
		},
		f
	}),
	...
	r("echarts/component/base", ["require", "../config", "../util/ecQuery", "../util/number", "zrender/tool/util", "zrender/tool/env"], function (e) {
				...
				if (t) {
					...
					if (t instanceof Array)
						for (var i = 0, o = t.length; i < o; i++)
							r = s.getShapeById(t[i]), s.zr.addHoverShape(r), n = Math.min(n, r.zlevel);
					else
						r = s.getShapeById(t), r && (s.zr.addHoverShape(r), n = Math.min(n, r.zlevel));
		...
		return s.prototype = {
			...
			subPixelOptimize : function (e, t) {
				return t % 2 == 1 ? e = Math.floor(e) + .5 : e = Math.round(e),
				e
			},
			resize : function () {
	...
	r("zrender/shape/Heart", ["require", "./Base", "../tool/util"], function (e) {
		...
		return n.prototype = {
			...
			buildPath : function (e, t) {
				e.moveTo(t.x, t.y),
				e.bezierCurveTo(t.x + t.a / 2, t.y - t.b * 2 / 3, t.x + t.a * 2, t.y + t.b / 3, t.x, t.y + t.b),
				e.bezierCurveTo(t.x - t.a * 2, t.y + t.b / 3, t.x - t.a / 2, t.y - t.b * 2 / 3, t.x, t.y);
				return
			},
			getRect : function (e) {
				if (e.__rect)
	...
	r("zrender/shape/Droplet", ["require", "./Base", "../tool/util"], function (e) {
		...
		return n.prototype = {
			type : "droplet",
			buildPath : function (e, t) {
				e.moveTo(t.x, t.y + t.a),
				e.bezierCurveTo(t.x + t.a, t.y + t.a, t.x + t.a * 3 / 2, t.y - t.a / 3, t.x, t.y - t.b),
				e.bezierCurveTo(t.x - t.a * 3 / 2, t.y - t.a / 3, t.x - t.a, t.y + t.a, t.x, t.y + t.a)
			},
			getRect : function (e) {
				if (e.__rect)
					return e.__rect;
	...
	r("echarts/util/shape/Icon", ["require", "zrender/tool/util", "zrender/shape/Star", "zrender/shape/Heart", "zrender/shape/Droplet", "zrender/shape/Image", "zrender/shape/Base"], function (e) {
		function n(e, t) {
			var n = t.width / 16,
			r = t.height / 16;
			e.moveTo(t.x, t.y + t.height),
			e.lineTo(t.x + 5 * n, t.y + 14 * r),
			e.lineTo(t.x + t.width, t.y + 3 * r),
			e.lineTo(t.x + 13 * n, t.y),
			e.lineTo(t.x + 2 * n, t.y + 11 * r),
			e.lineTo(t.x, t.y + t.height),
			e.moveTo(t.x + 6 * n, t.y + 10 * r),
			e.lineTo(t.x + 14 * n, t.y + 2 * r),
			e.moveTo(t.x + 10 * n, t.y + 13 * r),
			e.lineTo(t.x + t.width, t.y + 13 * r),
			e.moveTo(t.x + 13 * n, t.y + 10 * r),
			e.lineTo(t.x + 13 * n, t.y + t.height),
			e.moveTo(t.x, t.y)
		}
		function r(e, t) {
			var n = t.width / 16,
		...
		function i(e, t) {
			var n = t.width / 16,
			r = t.height / 16;
			e.moveTo(t.x + 4 * n, t.y + 15 * r),
			e.lineTo(t.x + 9 * n, t.y + 13 * r),
			e.lineTo(t.x + 14 * n, t.y + 8 * r),
			e.lineTo(t.x + 11 * n, t.y + 5 * r),
			e.lineTo(t.x + 6 * n, t.y + 10 * r),
			e.lineTo(t.x + 4 * n, t.y + 15 * r),
			e.moveTo(t.x + 5 * n, t.y),
			e.lineTo(t.x + 11 * n, t.y),
			e.moveTo(t.x + 5 * n, t.y + r),
			e.lineTo(t.x + 11 * n, t.y + r),
			e.moveTo(t.x, t.y + 2 * r),
			e.lineTo(t.x + t.width, t.y + 2 * r),
			e.moveTo(t.x, t.y + 5 * r),
			e.lineTo(t.x + 3 * n, t.y + t.height),
			e.lineTo(t.x + 13 * n, t.y + t.height),
			e.lineTo(t.x + t.width, t.y + 5 * r),
			e.moveTo(t.x, t.y)
		}
		function s(e, t) {
			var n = t.width / 16,
			r = t.height / 16;
			e.moveTo(t.x, t.y + 3 * r),
			e.lineTo(t.x + 6 * n, t.y + 3 * r),
			e.moveTo(t.x + 3 * n, t.y),
			e.lineTo(t.x + 3 * n, t.y + 6 * r),
			e.moveTo(t.x + 3 * n, t.y + 8 * r),
			e.lineTo(t.x + 3 * n, t.y + t.height),
			e.lineTo(t.x + t.width, t.y + t.height),
			e.lineTo(t.x + t.width, t.y + 3 * r),
			e.lineTo(t.x + 8 * n, t.y + 3 * r),
			e.moveTo(t.x, t.y)
		}
		function o(e, t) {
			var n = t.width / 16,
			r = t.height / 16;
			e.moveTo(t.x + 6 * n, t.y),
			e.lineTo(t.x + 2 * n, t.y + 3 * r),
			e.lineTo(t.x + 6 * n, t.y + 6 * r),
			e.moveTo(t.x + 2 * n, t.y + 3 * r),
			e.lineTo(t.x + 14 * n, t.y + 3 * r),
			e.lineTo(t.x + 14 * n, t.y + 11 * r),
			e.moveTo(t.x + 2 * n, t.y + 5 * r),
			e.lineTo(t.x + 2 * n, t.y + 13 * r),
			e.lineTo(t.x + 14 * n, t.y + 13 * r),
			e.moveTo(t.x + 10 * n, t.y + 10 * r),
			e.lineTo(t.x + 14 * n, t.y + 13 * r),
			e.lineTo(t.x + 10 * n, t.y + t.height),
			e.moveTo(t.x, t.y)
		}
		function u(e, t) {
			var n = t.width / 16,
			...
			i = t.width / 2;
			e.lineWidth = 1.5,
			e.arc(t.x + i, t.y + i, i - n, 0, Math.PI * 2 / 3),
			e.moveTo(t.x + 3 * n, t.y + t.height),
			e.lineTo(t.x + 0 * n, t.y + 12 * r),
			e.lineTo(t.x + 5 * n, t.y + 11 * r),
			e.moveTo(t.x, t.y + 8 * r),
			e.arc(t.x + i, t.y + i, i - n, Math.PI, Math.PI * 5 / 3),
			e.moveTo(t.x + 13 * n, t.y),
			e.lineTo(t.x + t.width, t.y + 4 * r),
			e.lineTo(t.x + 11 * n, t.y + 5 * r),
			e.moveTo(t.x, t.y)
		}
		function a(e, t) {
			...
			e.lineTo(t.x, t.y + t.height),
			e.lineTo(t.x + t.width, t.y + t.height),
			e.moveTo(t.x + 2 * n, t.y + 14 * r),
			e.lineTo(t.x + 7 * n, t.y + 6 * r),
			e.lineTo(t.x + 11 * n, t.y + 11 * r),
			e.lineTo(t.x + 15 * n, t.y + 2 * r),
			e.moveTo(t.x, t.y)
		}
		function f(e, t) {
			var n = t.width / 16,
			...
			e.lineTo(t.x, t.y + t.height),
			e.lineTo(t.x + t.width, t.y + t.height),
			e.moveTo(t.x + 3 * n, t.y + 14 * r),
			e.lineTo(t.x + 3 * n, t.y + 6 * r),
			e.lineTo(t.x + 4 * n, t.y + 6 * r),
			e.lineTo(t.x + 4 * n, t.y + 14 * r),
			e.moveTo(t.x + 7 * n, t.y + 14 * r),
			e.lineTo(t.x + 7 * n, t.y + 2 * r),
			e.lineTo(t.x + 8 * n, t.y + 2 * r),
			e.lineTo(t.x + 8 * n, t.y + 14 * r),
			e.moveTo(t.x + 11 * n, t.y + 14 * r),
			e.lineTo(t.x + 11 * n, t.y + 9 * r),
			e.lineTo(t.x + 12 * n, t.y + 9 * r),
			e.lineTo(t.x + 12 * n, t.y + 14 * r),
			e.moveTo(t.x, t.y)
		}
		function l(e, t) {
			var n = t.x,
		...
		function h(e, t) {
			var n = t.width / 16;
			e.moveTo(t.x + n, t.y),
			e.lineTo(t.x + n, t.y + t.height),
			e.lineTo(t.x + 15 * n, t.y + t.height),
			e.lineTo(t.x + 15 * n, t.y),
			e.lineTo(t.x + n, t.y),
			e.moveTo(t.x + 3 * n, t.y + 3 * n),
			e.lineTo(t.x + 13 * n, t.y + 3 * n),
			e.moveTo(t.x + 3 * n, t.y + 6 * n),
			e.lineTo(t.x + 13 * n, t.y + 6 * n),
			e.moveTo(t.x + 3 * n, t.y + 9 * n),
			e.lineTo(t.x + 13 * n, t.y + 9 * n),
			e.moveTo(t.x + 3 * n, t.y + 12 * n),
			e.lineTo(t.x + 9 * n, t.y + 12 * n),
			e.moveTo(t.x, t.y)
		}
		function p(e, t) {
			var n = t.width / 16,
			...
			e.lineTo(t.x, t.y),
			e.moveTo(t.x + 4 * n, t.y),
			e.lineTo(t.x + 4 * n, t.y + 8 * r),
			e.lineTo(t.x + 12 * n, t.y + 8 * r),
			e.lineTo(t.x + 12 * n, t.y),
			e.moveTo(t.x + 6 * n, t.y + 11 * r),
			e.lineTo(t.x + 6 * n, t.y + 13 * r),
			e.lineTo(t.x + 10 * n, t.y + 13 * r),
			e.lineTo(t.x + 10 * n, t.y + 11 * r),
			e.lineTo(t.x + 6 * n, t.y + 11 * r),
			e.moveTo(t.x, t.y)
		}
		function d(e, t) {
			var n = t.x,
		...
		function v(e, t) {
			...
			r = t.height / 2,
			i = Math.min(n, r);
			e.moveTo(t.x + n + i, t.y + r),
			e.arc(t.x + n, t.y + r, i, 0, Math.PI * 2)
		}
		function m(e, t) {
			e.rect(t.x, t.y, t.width, t.height)
		}
		...
		function b(e, t) {
			...
			i = t.width / 16;
			e.moveTo(n + 8 * i, r),
			e.lineTo(n + i, r + t.height),
			e.lineTo(n + 8 * i, r + t.height / 4 * 3),
			e.lineTo(n + 15 * i, r + t.height),
			e.lineTo(n + 8 * i, r)
		}
		function w(t, n) {
		...
		function x(e, t) {
			...
			s = t.height / 2,
			o = Math.min(i, s);
			e.arc(n + i, r + s, o, Math.PI / 5 * 4, Math.PI / 5),
			e.lineTo(n + i, r + s + o * 1.5)
		}
		function T(t, n) {
			setTimeout(function () {
	...
	r("zrender/shape/util/dashedLineTo", [], function () {
		...
		return function (t, n, r, i, s, o) {
			...
			var l = !0;
			for (var c = 0; c < f; ++c)
				l ? t.moveTo(n, r) : t.lineTo(n, r), l = !l, n += u, r += a;
			t.lineTo(i, s)
		}
	}),
	...
	r("zrender/tool/vector", [], function () {
		...
		t = {
			...
			normalize : function (e, n) {
				var r = t.length(n);
				return r === 0 ? (e[0] = 0, e[1] = 0) : (e[0] = n[0] / r, e[1] = n[1] / r),
				e
			},
	...
	r("zrender/shape/Polygon", ["require", "./Base", "./util/smoothSpline", "./util/smoothBezier", "./util/dashedLineTo", "../tool/util"], function (e) {
		...
		return s.prototype = {
			...
			brush : function (e, t) {
				...
				this.setTransform(e);
				var r = !1;
				if (n.brushType == "fill" || n.brushType == "both" || typeof n.brushType == "undefined")
					e.beginPath(), n.lineType == "dashed" || n.lineType == "dotted" ? (this.buildPath(e, {
							lineType : "solid",
							lineWidth : n.lineWidth,
							pointList : n.pointList
						}), r = !1) : (this.buildPath(e, n), r = !0), e.closePath(), e.fill();
				n.lineWidth > 0 && (n.brushType == "stroke" || n.brushType == "both") && (r || (e.beginPath(), this.buildPath(e, n), e.closePath()), e.stroke()),
				this.drawText(e, n, this.style),
				e.restore();
				return
			},
			buildPath : function (e, t) {
				...
				if (t.smooth && t.smooth !== "spline") {
					...
					l = s.length;
					for (var c = 0; c < l; c++)
						u = o[c * 2], a = o[c * 2 + 1], f = s[(c + 1) % l], e.bezierCurveTo(u[0], u[1], a[0], a[1], f[0], f[1])
				} else {
					t.smooth === "spline" && (s = n(s, !0));
					if (!t.lineType || t.lineType == "solid") {
						e.moveTo(s[0][0], s[0][1]);
						for (var c = 1, h = s.length; c < h; c++)
							e.lineTo(s[c][0], s[c][1]);
						...
						e.moveTo(s[0][0], s[0][1]);
						for (var c = 1, h = s.length; c < h; c++)
							i(e, s[c - 1][0], s[c - 1][1], s[c][0], s[c][1], p);
		...
		return s.prototype = {
			...
			buildPath : function (e, t) {
				...
				if (t.smooth && t.smooth !== "spline") {
					...
					l;
					for (var c = 0; c < o - 1; c++)
						a = u[c * 2], f = u[c * 2 + 1], l = s[c + 1], e.bezierCurveTo(a[0], a[1], f[0], f[1], l[0], l[1])
				} else {
					...
					if (!t.lineType || t.lineType == "solid") {
						...
						e.moveTo(s[0][0], s[0][1]);
						for (var c = 1; c < o; c++)
							i(e, s[c - 1][0], s[c - 1][1], s[c][0], s[c][1], h)
					}
				}
				return
			},
	...
	r("echarts/util/shape/MarkLine", ["require", "zrender/shape/Base", "./Icon", "zrender/shape/Line", "zrender/shape/BrokenLine", "zrender/tool/matrix", "zrender/tool/area", "zrender/shape/util/dashedLineTo", "zrender/shape/util/smoothSpline", "zrender/tool/util"], function (e) {
		...
		return h.prototype = {
			...
			buildLinePath : function (e, t) {
				...
				if (!t.lineType || t.lineType == "solid") {
					...
					if (t.smooth !== "spline") {
						...
						e.moveTo(n[0][0], n[0][1]);
						for (var i = 1; i < r; i++)
							f(e, n[i - 1][0], n[i - 1][1], n[i][0], n[i][1], s)
					} else
						for (var i = 1; i < r; i += 2)
							e.moveTo(n[i - 1][0], n[i - 1][1]), e.lineTo(n[i][0], n[i][1])
			},
			brushSymbol : function (e, t, r) {
				...
				t.iconType = t.symbol[r].replace("empty", "").toLowerCase(),
				t.symbol[r].match("empty") && (e.fillStyle = "#fff");
				...
				if (t.iconType == "arrow" && a === 0)
					this.buildArrawPath(e, t, r);
				else {
			...
			getPointList : function (e) {
				...
				if (e.smooth === "spline") {
					...
					r = t[1][1];
					t[3] = [n, r],
					t[1] = this.getOffetPoint(t[0], t[3]),
					t[2] = this.getOffetPoint(t[3], t[0]),
					t = l(t, !1),
					t[t.length - 1] = [n, r]
				}
				return t
			...
			getOffetPoint : function (e, t) {
				...
				var u,
				a;
				return e[0] <= t[0] ? (i -= s, u = Math.round(Math.cos(i) * n), a = Math.round(Math.sin(i) * n), r[0] += u, r[1] += a) : (i += s, u = Math.round(Math.cos(i) * n), a = Math.round(Math.sin(i) * n), r[0] -= u, r[1] -= a),
				r
			},
			getRect : function (e) {
				if (e.__rect)
			...
			isCover : function (e, t) {
				...
				t = n[1];
				var r = this.style.__rect;
				return r || (r = this.style.__rect = this.getRect(this.style)),
				e >= r.x && e <= r.x + r.width && t >= r.y && t <= r.y + r.height ? this.style.smooth !== "spline" ? a.isInside(i, this.style, e, t) : a.isInside(o, this.style, e, t) : !1
			}
		},
		c.inherits(h, t),
		h
	...
	r("echarts/util/shape/normalIsCover", [], function () {
		return function (e, t) {
			...
			var r = this.style.__rect;
			return r || (r = this.style.__rect = this.getRect(this.style)),
			e >= r.x && e <= r.x + r.width && t >= r.y && t <= r.y + r.height
		}
	}),
		...
		return s.prototype = {
			...
			buildPath : function (e, t) {
				...
				for (var m = 0; m < s; m++) {
					...
					u = u > r ? r : u;
					for (var g = o; g < u; g++) {
						t.random && (p = t["randomMap" + g % 20] / 100, l = f * p * p, c = l / 2),
						a ? (d = n[g][0], v = n[g][1]) : (d = n[g].x, v = n[g].y);
						if (l < 3)
							e.rect(d - c, v - c, l, l);
						else
							switch (t.iconType) {
	...
	r("echarts/util/ecData", [], function () {
		function e(e, t, n, r, i, s, o, u) {
			var a;
			return typeof r != "undefined" && (a = r.value == null ? r : r.value),
			e._echartsData = {
				_series : t,
				_seriesIndex : n,
				_data : r,
	...
	r("echarts/util/ecAnimation", ["require", "zrender/tool/util", "zrender/shape/Polygon"], function (e) {
		function n(e, n, r, i, s) {
			...
			if (!n) {
				...
				r.type == "half-smooth-polygon" && (a[u - 1] = t.clone(o[u - 1]), a[u - 2] = t.clone(o[u - 2])),
				n = {
					style : {
						pointList : a
					}
			...
			a = n.style.pointList;
			var h = a.length;
			h == u ? r.style.pointList = a : h < u ? r.style.pointList = a.concat(o.slice(h)) : r.style.pointList = a.slice(0, u),
			e.addShape(r),
			e.animate(r.id, "style").when(i, {
				pointList : o
			}).start(s)
		}
		function r(e, t) {
		...
		function i(e, t, n, i, s) {
			...
			f = o.width,
			l = o.height;
			r(n, t, "x", "y", "width", "height"),
			e.addShape(n),
			e.animate(n.id, "style").when(i, {
				x : u,
				y : a,
				width : f,
				height : l
		...
		function l(e, t, n, i, s) {
			...
			a = n.style.target0,
			f = n.style.target1;
			t.style && r(n, t, "source0", "source1", "target0", "target1"),
			e.addShape(n),
			e.animate(n.id, "style").when(i, {
				source0 : o,
				source1 : u,
		...
		function d(e, t, n, r, i) {
			n.style.smooth ? (n.style.pointListLength = 1, e.addShape(n), n.style.pointList = n.style.pointList || n.getPointList(n.style), e.animate(n.id, "style").when(r, {
				...
				}).start(i || "QuinticOut")) : (n.style.pointList = t ? t.style.pointList : [[n.style.xStart, n.style.yStart], [n.style.xStart, n.style.yStart]], e.addShape(n), e.animate(n.id, "style").when(r, {
					pointList : [[n.style.xStart, n.style.yStart], [n._x || 0, n._y || 0]]
				}).start(i || "QuinticOut"))
		}
		var t = e("zrender/tool/util");
		return {
	...
	r("echarts/util/ecEffect", ["require", "../util/ecData", "zrender/shape/Circle", "zrender/shape/Image", "../util/shape/Icon", "../util/shape/Symbol", "zrender/tool/env"], function (e) {
		function u(e, n, s, u) {
			...
			p.style.x = s.style._x - v,
			p.style.y = s.style._y - v;
		...
		function a(e, t, n, r) {
			...
			d = {};
			for (var v = 0; v < 20; v++)
				c.style["randomMap" + v] = 0, p = {},
			p["randomMap" + v] = 100,
			d = {},
			d["randomMap" + v] = 0,
			c.style["randomMap" + v] = Math.random() * 100,
			e.animate(c.id, "style", !0).when(h, p).when(h * 2, d).when(h * 3, p).when(h * 4, p).delay(Math.random() * h * v).start()
		}
		function f(e, i, s, u) {
			var a = s.effect,
			f = a.color || s.style.strokeColor || s.style.color,
			...
			i.push(p),
			e.addShape(p),
			p.style.x = s.style.xStart - d,
			p.style.y = s.style.yStart - d;
			...
			if (!s.style.smooth)
				e.animate(p.id, "style", a.loop).when(m, {
					x : s._x - d,
					y : s._y - d
				}).done(function () {
					s.effect.show = !1,
	...
	r("echarts/util/accMath", [], function () {
		function e(e, t) {
			...
			i = 0;
			try {
				i = r.split(".")[1].length - n.split(".")[1].length
			} catch (s) {}
	...
	r("echarts/chart/base", ["require", "zrender/shape/Image", "../util/shape/Icon", "../util/shape/MarkLine", "../util/shape/Symbol", "../config", "../util/ecData", "../util/ecAnimation", "../util/ecEffect", "../util/accMath", "zrender/tool/util", "zrender/tool/area"], function (e) {
		function h() {
			...
			this.shapeHandler = {
				...
				ondragover : function (t) {
					...
					o = r.lineWidth;
					r.brushType = "stroke",
					r.strokeColor = e.ecTheme.calculableColor,
					r.lineWidth = n.type == "icon" ? 30 : 10,
					e.zr.addHoverShape(n),
					setTimeout(function () {
		...
		return h.prototype = {
			setCalculable : function (e) {
				return e.dragEnableTime = this.ecTheme.DRAG_ENABLE_TIME,
			...
			ondrop : function (e, t) {
				...
				if (u == -1) {
					...
					for (var d = 0, v = p.length; d < v; d++)
						p[d].name == l.name && p[d].value == "-" && (a[i].data[d].value = l.value, h = !0);
					!h && a[i].data.push(l),
					c && c.add(l.name, r.style.color || r.style.strokeColor)
				} else {
					...
					if (typeof l.value != "undefined") {
						...
						if (this.type == s.CHART_TYPE_FUNNEL || this.type == s.CHART_TYPE_PIE)
							c && c.getRelatedAmount(l.name) == 1 && this.component.legend.del(l.name), l.name += this.option.nameConnector + o.get(r, "name"), c && c.add(l.name, r.style.color || r.style.strokeColor)
					} else
						l != "-" ? this.option.series[i].data[u] = f.accAdd(this.option.series[i].data[u], o.get(r, "value")) : this.option.series[i].data[u] = o.get(r, "value")
				}
				t.dragIn = t.dragIn || !0,
				this.isDrop = !1;
				var m = this;
			...
			onlegendSelected : function (e, t) {
				var n = e.selected;
				for (var r in this.selectedMap)
					this.selectedMap[r] != n[r] && (t.needRefresh = !0), this.selectedMap[r] = n[r];
				return
			},
			addLabel : function (e, t, n, r, i) {
				...
				a = o.textStyle || {},
				f = u.textStyle || {};
				return o.show && (e.style.text = this._getLabelText(t, n, r, "normal"), e.style.textPosition = typeof o.position == "undefined" ? i == "horizontal" ? "right" : "top" : o.position, e.style.textColor = a.color, e.style.textFont = this.getFont(a)),
				u.show && (e.highlightStyle.text = this._getLabelText(t, n, r, "emphasis"), e.highlightStyle.textPosition = o.show ? e.style.textPosition : typeof u.position == "undefined" ? i == "horizontal" ? "right" : "top" : u.position, e.highlightStyle.textColor = f.color, e.highlightStyle.textFont = this.getFont(f)),
				e
			},
			_getLabelText : function (e, t, n, r) {
				...
				if (typeof i == "function")
					return i.call(this.myChart, e.name, n, s);
				if (typeof i == "string")
			...
			_buildMarkPoint : function (e) {
				...
				for (var a = 0, f = u.data.length; a < f; a++)
					i = u.data[a], o = this.getMarkCoord(e, i), u.data[a].x = typeof i.x != "undefined" ? i.x : o[0], u.data[a].y = typeof i.y != "undefined" ? i.y : o[1], i.type && (i.type == "max" || i.type == "min") && (u.data[a].value = o[3], u.data[a].name = i.name || i.type, u.data[a].symbolSize = u.data[a].symbolSize || c.getTextWidth(o[3], this.getFont()) / 2 + 5);
			...
			_buildMarkLine : function (e) {
				...
				for (var a = 0, f = u.data.length; a < f; a++)
					i = u.data[a], !i.type || i.type != "max" && i.type != "min" && i.type != "average" ? o = [this.getMarkCoord(e, i[0]), this.getMarkCoord(e, i[1])] : (o = this.getMarkCoord(e, i), u.data[a] = [l.clone(i), {}
						], u.data[a][0].name = i.name || i.type, u.data[a][0].value = o[3], o = o[2], i = [{}, {}
				...
				if (this.type == s.CHART_TYPE_FORCE || this.type == s.CHART_TYPE_CHORD)
					for (var a = 0, f = c.length; a < f; a++)
						this.zr.addShape(c[a])
			},
			_markPoint : function (e, t) {
				var n = this.series[e],
				r = this.component;
				l.merge(t, this.ecTheme.markPoint),
				t.name = n.name;
				var i = [],
				u = t.data,
				a,
				...
				if (!t.large)
					for (var w = 0, E = u.length; w < E; w++) {
						p = typeof u[w] != "undefined" && typeof u[w].value != "undefined" ? u[w].value : "",
						c && (h = c.getColor(n.name));
						if (f) {
							h = isNaN(p) ? h : f.getColor(p),
							d = [u[w], t],
							v = this.deepQuery(d, "itemStyle.normal.color") || h,
							m = this.deepQuery(d, "itemStyle.emphasis.color") || v;
							if (v == null && m == null)
								continue
						}
						...
						u[w].name = typeof u[w].name != "undefined" ? u[w].name : "",
						u[w].value = p,
						a = this.getSymbolShape(t, e, u[w], w, u[w].name, this.parsePercent(u[w].x, y), this.parsePercent(u[w].y, b), "pin", h, "rgba(0,0,0,0)", "horizontal"),
						a._mark = "point",
						g = this.deepMerge([u[w], t], "effect"),
						g.show && (a.effect = g),
						n.type == s.CHART_TYPE_MAP && (a._geo = this.getMarkGeo(u[w])),
						o.pack(a, n, e, u[w], w, u[w].name, p),
						i.push(a)
					}
				else
					a = this.getLargeMarkPoingShape(e, t), a._mark = "largePoint", a && i.push(a);
				return i
			},
			_markLine : function (e, t) {
				var n = this.series[e],
				r = this.component;
				l.merge(t, this.ecTheme.markLine),
				t.symbol = t.symbol instanceof Array ? t.symbol.length > 1 ? t.symbol : [t.symbol[0], t.symbol[0]] : [t.symbol, t.symbol],
				t.symbolSize = t.symbolSize instanceof Array ? t.symbolSize.length > 1 ? t.symbolSize : [t.symbolSize[0], t.symbolSize[0]] : [t.symbolSize, t.symbolSize],
				t.symbolRotate = t.symbolRotate instanceof Array ? t.symbolRotate.length > 1 ? t.symbolRotate : [t.symbolRotate[0], t.symbolRotate[0]] : [t.symbolRotate, t.symbolRotate],
				t.name = n.name;
				var i = [],
				u = t.data,
				a,
				...
				for (var E = 0, S = u.length; E < S; E++) {
					c && (h = c.getColor(n.name)),
					w = this.deepMerge(u[E]),
					p = typeof w != "undefined" && typeof w.value != "undefined" ? w.value : "";
					if (f) {
						h = isNaN(p) ? h : f.getColor(p),
						d = [w, t],
						v = this.deepQuery(d, "itemStyle.normal.color") || h,
					...
					u[E][0].name = typeof u[E][0].name != "undefined" ? u[E][0].name : "",
					u[E][1].name = typeof u[E][1].name != "undefined" ? u[E][1].name : "",
					u[E][0].value = typeof u[E][0].value != "undefined" ? u[E][0].value : "",
					a = this.getLineMarkShape(t, e, u[E], E, this.parsePercent(u[E][0].x, y), this.parsePercent(u[E][0].y, b), this.parsePercent(u[E][1].x, y), this.parsePercent(u[E][1].y, b), h),
					a._mark = "line",
					g = this.deepMerge([w, t], "effect"),
					g.show && (a.effect = g),
					n.type == s.CHART_TYPE_MAP && (a._geo = [this.getMarkGeo(u[E][0]), this.getMarkGeo(u[E][1])]),
					o.pack(a, n, e, u[E][0], E, u[E][0].name + (u[E][1].name !== "" ? " > " + u[E][1].name : ""), p),
					i.push(a)
				}
				return i
			},
			...
			getSymbolShape : function (e, r, i, s, u, a, f, l, c, h, p) {
				...
				typeof g != "undefined" && (S.rotation = [g * Math.PI / 180, a, f]),
				l.match("star") && (S.style.iconType = "star", S.style.n = l.replace("empty", "").replace("star", "") - 0 || 5),
				l == "none" && (S.invisible = !0, S.hoverable = !1),
				S = this.addLabel(S, e, i, u, p),
				l.match("empty") && (typeof S.style.textColor == "undefined" && (S.style.textColor = S.style.strokeColor), typeof S.highlightStyle.textColor == "undefined" && (S.highlightStyle.textColor = S.highlightStyle.strokeColor)),
				o.pack(S, e, r, i, s, u),
				S._x = a,
				S._y = f,
				S._dataIndex = s,
			...
			getLineMarkShape : function (e, t, n, i, s, o, u, a, f) {
				...
				p[0] = typeof p[0] == "function" ? p[0](l) : p[0],
				p[1] = typeof p[1] == "function" ? p[1](c) : p[1];
				...
				return S = this.addLabel(S, e, n[0], n[0].name + " : " + n[1].name),
				S._x = u,
				S._y = a,
				S
			},
			getLargeMarkPoingShape : function (e, t) {
				...
				if (u) {
					l = typeof s[0] != "undefined" ? typeof s[0].value != "undefined" ? s[0].value : s[0] : "-",
					f = isNaN(l) ? f : u.getColor(l),
					h = this.deepQuery(c, "itemStyle.normal.color") || f,
					p = this.deepQuery(c, "itemStyle.emphasis.color") || h;
					if (h == null && p == null)
						return
				}
			...
			addShapeList : function () {
				...
				if (this.option.animation && !this.option.renderAsImage && n.length < e && !this.motionlessOnce) {
					for (var a = 0, f = t.length; a < f; a++)
						s = this._getAnimationKey(t[a]), s.match("undefined") ? this.zr.delShape(t[a].id) : (s += t[a].type, o[s] = t[a]);
					for (var a = 0, f = n.length; a < f; a++)
						s = this._getAnimationKey(n[a]), s.match("undefined") ? this.zr.addShape(n[a]) : (s += n[a].type, u[s] = n[a]);
					for (s in o)
						u[s] || this.zr.delShape(o[s].id);
					for (s in u)
						o[s] ? (this.zr.delShape(o[s].id), this._animateMod(o[s], u[s], r, i)) : this._animateMod(!1, u[s], r, i);
					this.zr.refresh(),
			...
			animationEffect : function (e) {
				...
				for (var i = 0, o = t.length; i < o; i++) {
					r = t[i];
					if (!(r._mark && r.effect && r.effect.show && a[r._mark]))
						continue;
					a[r._mark](this.zr, this.effectList, r, n),
			...
			addMark : function (e, t, n) {
				...
				if (this.selectedMap[r.name]) {
					...
					for (var a = u, f = this.shapeList.length; a < f; a++)
						this.zr.addShape(this.shapeList[a]);
					this.zr.refresh(),
					this.option.animation && !this.option.renderAsImage && this.animationMark(i, s, this.shapeList.slice(u)),
					r[n].data = o
				}
			},
	...
	r("echarts/chart/island", ["require", "../component/base", "./base", "zrender/shape/Circle", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/event", "zrender/tool/color", "../util/accMath", "../chart"], function (e) {
		...
		return a.prototype = {
			...
			_combine : function (t, n) {
				...
				t.style.text = u + this._valueConnector + o,
				s.set(t, "value", o),
				s.set(t, "name", u),
				t.style.r = this.option.island.r,
				t.style.color = r.mix(t.style.color, n.style.color)
			},
			refresh : function (e) {
			...
			resize : function () {
				...
				this._zrWidth = e,
				this._zrHeight = t;
				for (var i = 0, s = this.shapeList.length; i < s; i++)
			...
			add : function (e) {
				...
				u.style.color == "#fff" && (u.style.color = e.style.strokeColor),
				this.setCalculable(u),
				u.dragEnableTime = 0,
				s.pack(u, {
					name : i
				}, -1, n, -1, t),
			...
			ondragend : function (e, t) {
				var n = e.target;
				this.isDragend ? t.dragIn && (this.del(n), t.needRefresh = !0) : t.dragIn || (n.style.x = u.getX(e.event), n.style.y = u.getY(e.event), this.add(n), t.needRefresh = !0),
				this.isDragend = !1;
				return
			}
		},
	...
	r("echarts/component/dataView", ["require", "./base", "../config", "zrender/tool/util", "../component"], function (e) {
		...
		return i.prototype = {
			...
			show : function (e) {
				...
				typeof n != "function" ? this._textArea.value = this._optionToContent() : this._textArea.value = n(this.option),
				...
				this.query(this.option, "toolbox.feature.dataView.readOnly") === !1 ? (this._buttonRefresh.style.cssText = "float:right;margin-right:10px;padding:1px 6px;", this._buttonRefresh.innerHTML = t[2] || this._lang[2], this._buttonRefresh.onclick = function () {
					r._save()
				}, this._tDom.appendChild(this._buttonRefresh), this._textArea.readOnly = !1, this._textArea.style.cursor = "default") : (this._textArea.readOnly = !0, this._textArea.style.cursor = "text"),
			...
			_optionToContent : function () {
				...
				if (this.option.xAxis) {
					...
					for (e = 0, i = u.length; e < i; e++)
						if ((u[e].type || "category") == "category") {
							o = [];
							for (t = 0, r = u[e].data.length; t < r; t++)
								s = u[e].data[t], o.push(typeof s.value != "undefined" ? s.value : s);
							a += o.join(", ") + "\n\n"
						}
				}
				...
				for (e = 0, i = f.length; e < i; e++) {
					o = [];
					for (t = 0, r = f[e].data.length; t < r; t++)
						s = f[e].data[t], f[e].type == n.CHART_TYPE_PIE || f[e].type == n.CHART_TYPE_MAP ? l = (s.name || "-") + ":" : l = "", f[e].type == n.CHART_TYPE_SCATTER && (s = typeof s.value != "undefined" ? s.value : s, s = s.join(", ")), o.push(l + (typeof s.value != "undefined" ? s.value : s));
					a += (f[e].name || "-") + " : \n",
			...
			_save : function () {
				...
				if (typeof t != "function") {
					...
					var r = [];
					for (var i = 0, s = e.length; i < s; i++)
						e[i] = this._trim(e[i]), e[i] !== "" && r.push(e[i]);
			...
			_contentToOption : function (e) {
				...
				if (this.option.xAxis) {
					...
					for (t = 0, s = u.length; t < s; t++)
						if ((u[t].type || "category") == "category") {
							f = e[a].split(",");
							for (r = 0, i = u[t].data.length; r < i; r++)
								l = this._trim(f[r] || ""), o = u[t].data[r], typeof u[t].data[r].value != "undefined" ? u[t].data[r].value = l : u[t].data[r] = l;
							a++
						}
				}
				if (this.option.yAxis) {
				...
				for (t = 0, s = c.length; t < s; t++) {
					...
					if (c[t].type == n.CHART_TYPE_SCATTER)
						for (var r = 0, i = c[t].data.length; r < i; r++)
							f = e[a], l = f.replace(" ", "").split(","), typeof c[t].data[r].value != "undefined" ? c[t].data[r].value = l : c[t].data[r] = l, a++;
					else {
						f = e[a].split(",");
						for (var r = 0, i = c[t].data.length; r < i; r++)
							l = (f[r] || "").replace(/.*:/, ""), l = this._trim(l), l = l != "-" && l !== "" ? l - 0 : "-", typeof c[t].data[r].value != "undefined" ? c[t].data[r].value = l : c[t].data[r] = l;
						a++
					}
				}
			},
	...
	r("echarts/component/toolbox", ["require", "./base", "zrender/shape/Line", "zrender/shape/Image", "zrender/shape/Rectangle", "../util/shape/Icon", "../config", "zrender/tool/util", "zrender/config", "zrender/tool/event", "./dataView", "../component"], function (e) {
		...
		return h.prototype = {
			...
			_buildShape : function () {
				...
				for (var r in t)
					if (t[r].show)
						...
						case "mark":
							...
							break;
						case "magicType":
							for (var i = 0, s = t[r].type.length; i < s; i++)
								t[r].title[t[r].type[i] + "Chart"] = t[r].title[t[r].type[i]], n.push({
									key : r,
				...
				if (n.length > 0) {
					...
					for (var i = 0, s = n.length; i < s; i++)
						o = n[i].name, r = n[i].key, this._iconList.push(o), this._featureTitle[o] = t[r].title[o] || t[r].title, t[r].icon && (this._featureIcon[o] = t[r].icon[o] || t[r].icon), t[r].color && (this._featureColor[o] = t[r].color[o] || t[r].color);
					...
					this._iconShapeMap.dataZoomReset && this._zoomQueue.length === 0 && this._iconDisable(this._iconShapeMap.dataZoomReset)
				}
			},
			_buildItem : function () {
				...
				a = t.itemGap,
				f,
				l = t.color instanceof Array ? t.color : [t.color],
				c = this.getFont(t.textStyle),
				h,
				p,
				d;
				t.orient == "horizontal" ? (h = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "bottom" : "top", p = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "left" : "right", d = this._itemGroupLocation.y / this.zr.getHeight() < .5 ? "top" : "bottom") : h = this._itemGroupLocation.x / this.zr.getWidth() < .5 ? "right" : "left",
				this._iconShapeMap = {};
				var v = this;
				for (var m = 0; m < n; m++) {
					f = {
					...
					this._featureIcon[this._iconList[m]] && (f.style.image = this._featureIcon[this._iconList[m]].replace(new RegExp("^image:\\/\\/"), ""), f.style.opacity = .8, f.highlightStyle.opacity = 1, f.type = "image"),
					t.orient == "horizontal" && (m === 0 && p == "left" && (f.highlightStyle.textPosition = "specific", f.highlightStyle.textAlign = p, f.highlightStyle.textBaseline = d, f.highlightStyle.textX = i, f.highlightStyle.textY = d == "top" ? o + u + 10 : o - 10), m == n - 1 && p == "right" && (f.highlightStyle.textPosition = "specific", f.highlightStyle.textAlign = p, f.highlightStyle.textBaseline = d, f.highlightStyle.textX = i + u, f.highlightStyle.textY = d == "top" ? o + u + 10 : o - 10));
					...
					f.type == "icon" ? f = new s(f) : f.type == "image" && (f = new r(f)),
					this.shapeList.push(f),
					this._iconShapeMap[this._iconList[m]] = f,
					t.orient == "horizontal" ? i += u + a : o += u + a
				}
			},
			...
			__onmousemove : function (e) {
				this._marking && (this._markShape.style.xEnd = f.getX(e.event), this._markShape.style.yEnd = f.getY(e.event), this.zr.addHoverShape(this._markShape)),
				this._zooming && (this._zoomShape.style.width = f.getX(e.event) - this._zoomShape.style.x, this._zoomShape.style.height = f.getY(e.event) - this._zoomShape.style.y, this.zr.addHoverShape(this._zoomShape), this.dom.style.cursor = "crosshair"),
				this._zoomStart && this.dom.style.cursor != "pointer" && this.dom.style.cursor != "move" && (this.dom.style.cursor = "crosshair")
			},
			...
			__onclick : function (e) {
				if (e.target)
					return;
				if (this._marking)
					this._marking = !1, this._markShapeList.push(this._markShape), this._iconEnable(this._iconShapeMap.markUndo), this._iconEnable(this._iconShapeMap.markClear), this.zr.addShape(this._markShape), this.zr.refresh();
			...
			__onMark : function (e) {
				...
				if (this._marking || this._markStart)
					this._resetMark(), this.zr.refresh();
				else {
					this._resetZoom(),
			...
			__onMarkUndo : function () {
				if (this._marking)
					...
					if (e >= 1) {
						...
						e == 1 && (this._iconDisable(this._iconShapeMap.markUndo), this._iconDisable(this._iconShapeMap.markClear))
					}
				}
				return !0
			},
			...
			__onDataZoom : function (e) {
				...
				if (this._zooming || this._zoomStart)
					this._resetZoom(), this.zr.refresh(), this.dom.style.cursor = "default";
				else {
					this._resetMark(),
					this.zr.modShape(t.id, {
						style : {
			...
			__onDataZoomReset : function () {
				...
				this._zoomQueue.pop(),
				this._zoomQueue.length > 0 ? this.component.dataZoom.absoluteZoom(this._zoomQueue[this._zoomQueue.length - 1]) : (this.component.dataZoom.rectZoom(), this._iconDisable(this._iconShapeMap.dataZoomReset), this.zr.refresh()),
				!0
			},
			_resetMark : function () {
				this._marking = !1,
			...
			__onRestore : function () {
				...
				this._resetZoom(),
				this.messageCenter.dispatch(o.EVENT.RESTORE, null, null, this.myChart),
				!0
			},
			__onSaveAsImage : function () {
				...
				r.id = "__echarts_download_wrap__",
				r.style.cssText = "position:fixed;z-index:99999;display:block;top:0;left:0;background-color:rgba(33,33,33,0.5);text-align:center;width:100%;height:100%;line-height:" + document.documentElement.clientHeight + "px;";
				var i = document.createElement("a");
				i.href = n,
				i.setAttribute("download", (e.name ? e.name : this.option.title && (this.option.title.text || this.option.title.subtext) ? this.option.title.text || this.option.title.subtext : "ECharts") + "." + t),
				i.innerHTML = '<img style="vertical-align:middle" src="' + n + '" title="' + (!window.attachEvent || navigator.userAgent.indexOf("Opera") !== -1 ? e.lang ? e.lang[0] : "点击保存" : "右键->图片另存为") + '"/>',
				r.appendChild(i),
			...
			setMagicType : function (e) {
				this._resetMark(),
				this._magicType = e,
				!this._isSilence && this.messageCenter.dispatch(o.EVENT.MAGIC_TYPE_CHANGED, null, {
					magicType : this._magicType
				}, this.myChart)
			},
			...
			reset : function (e, t) {
				...
				if (this.query(e, "toolbox.show") && this.query(e, "toolbox.feature.magicType.show")) {
					...
					while (r--) {
						...
						if (this._magicMap[l] || this._magicMap[c])
							e.series[r].__stack = e.series[r].stack
					}
				}
				this._magicType = t ? {}
				 : this._magicType || {};
	...
	r("echarts/component/title", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "zrender/tool/area", "zrender/tool/color", "../component"], function (e) {
		...
		return a.prototype = {
			...
			_buildShape : function () {
				...
				this._buildBackground(),
				this._buildItem();
				for (var e = 0, t = this.shapeList.length; e < t; e++)
			...
			_buildItem : function () {
				...
				case "center":
					d.style.x = v.style.x = l + h / 2,
					d.style.textAlign = v.style.textAlign = "center";
					break;
				case "left":
					d.style.x = v.style.x = l,
					d.style.textAlign = v.style.textAlign = "left";
					break;
				case "right":
					d.style.x = v.style.x = l + h,
					d.style.textAlign = v.style.textAlign = "right";
					break;
				default:
					l = this.titleOption.x - 0,
					l = isNaN(l) ? 0 : l,
					d.style.x = v.style.x = l
				}
				this.titleOption.textAlign && (d.style.textAlign = v.style.textAlign = this.titleOption.textAlign),
				this.shapeList.push(new n(d)),
				i !== "" && this.shapeList.push(new n(v))
			},
			_buildBackground : function () {
			...
			refresh : function (e) {
				e && (this.option = e, this.option.title = this.reformOption(this.option.title), this.option.title.padding = this.reformCssArray(this.option.title.padding), this.titleOption = this.option.title, this.titleOption.textStyle = s.merge(this.titleOption.textStyle, this.ecTheme.textStyle), this.titleOption.subtextStyle = s.merge(this.titleOption.subtextStyle, this.ecTheme.textStyle)),
				this.clear(),
				this._buildShape()
			}
		},
		s.inherits(a, t),
		e("../component").define("title", a),
		a
	}),
	...
	r("echarts/component/tooltip", ["require", "./base", "../util/shape/Cross", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "zrender/tool/util", "zrender/shape/Base", "../component"], function (e) {
		function d(e, i, s, o, u) {
			...
			this.zr.on(a.EVENT.MOUSEMOVE, f._onmousemove),
			this.zr.on(a.EVENT.GLOBALOUT, f._onglobalout),
			f._hide = function (e) {
				return f.__hide(e)
			},
		...
		return d.prototype = {
			...
			_style : function (e) {
				...
				typeof e.borderWidth != "undefined" && t.push("border-width:" + e.borderWidth + "px"),
				typeof e.borderColor != "undefined" && t.push("border-color:" + e.borderColor),
				typeof e.borderRadius != "undefined" && (t.push("border-radius:" + e.borderRadius + "px"), t.push("-moz-border-radius:" + e.borderRadius + "px"), t.push("-webkit-border-radius:" + e.borderRadius + "px"), t.push("-o-border-radius:" + e.borderRadius + "px"));
				var r = e.textStyle;
				...
				var i = e.padding;
				return typeof i != "undefined" && (i = this.reformCssArray(i), t.push("padding:" + i[0] + "px " + i[1] + "px " + i[2] + "px " + i[3] + "px")),
				t = t.join(";") + ";",
				t
			},
			__hide : function () {
			...
			_show : function (e, t, n, r) {
				...
				e && (typeof e == "function" && (e = e([t, n])), e instanceof Array && (t = e[0], n = e[1])),
				t + s > this._zrWidth && (t -= s + 40),
				n + i > this._zrHeight && (n -= i - 20),
				n < 20 && (n = 0),
				this._tDom.style.cssText = this._gCssText + this._defaultCssText + (r ? r : "") + "left:" + t + "px;top:" + n + "px;",
				(i < 10 || s < 10) && setTimeout(this._refixed, 20),
				this.showing = !0
			},
			__refixed : function () {
				if (this._tDom) {
					...
					this._tDom.offsetLeft + n > this._zrWidth && (e += "left:" + (this._zrWidth - n - 20) + "px;"),
			...
			__tryShow : function () {
				...
				if (!this._curTarget)
					...
					e = this.deepQuery([r, n, this.option], "tooltip.show"),
			...
			_findPolarTrigger : function () {
				...
				r;
				return n ? (r = n.valueIndex, n = n.polarIndex) : n = -1,
				n != -1 ? this._showPolarTrigger(n, r) : !1
			},
			_getNearestDataIndex : function (e, t) {
				...
				if (e == "x") {
					...
					return r - s < o - r ? n -= n !== 0 ? 1 : 0 : typeof t.getNameByIndex(n) == "undefined" && (n -= 1),
					n
				}
				var l,
				c,
				...
				return i - l > c - i ? n -= n !== 0 ? 1 : 0 : typeof t.getNameByIndex(n) == "undefined" && (n -= 1),
				n
			},
			_showAxisTrigger : function (e, t, n) {
				...
				if (this.option.tooltip.trigger == "axis") {
					if (this.option.tooltip.show === !1)
						return;
					c = this.option.tooltip.formatter,
					h = this.option.tooltip.position
				}
				if (e != -1 && this.component.xAxis.getAxis(e).type == o.COMPONENT_TYPE_AXIS_CATEGORY) {
					...
					l = f.getY(this._event),
					a = this.subPixelOptimize(u.getCoordByIndex(n), this._axisLineWidth),
					this._styleAxisPointer(i, a, this.component.grid.getY(), a, this.component.grid.getYend(), u.getGap(), a, l)
					...
					a = f.getX(this._event),
					l = this.subPixelOptimize(u.getCoordByIndex(n), this._axisLineWidth),
					this._styleAxisPointer(i, this.component.grid.getX(), l, this.component.grid.getXend(), l, u.getGap(), a, l)
				} else
					a = f.getX(this._event), l = f.getY(this._event), this._styleAxisPointer(r, this.component.grid.getX(), l, this.component.grid.getXend(), l, 0, a, l), n >= 0 ? this._showItemTrigger() : (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._tDom.style.display = "none");
				if (i.length > 0) {
					var g;
					if (typeof c == "function") {
						var y = [];
						for (var v = 0, m = i.length; v < m; v++)
							g = i[v].data[n], g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value : g : "-", y.push([i[v].name || "", u.getNameByIndex(n), g]);
						this._curTicket = "axis:" + n,
						this._tDom.innerHTML = c.call(this.myChart, y, this._curTicket, this._setContent)
					} else if (typeof c == "string") {
						this._curTicket = NaN,
						c = c.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}");
						for (var v = 0, m = i.length; v < m; v++)
							c = c.replace("{a" + v + "}", this._encodeHTML(i[v].name || "")), c = c.replace("{b" + v + "}", this._encodeHTML(u.getNameByIndex(n))), g = i[v].data[n], g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value : g : "-", c = c.replace("{c" + v + "}", g instanceof Array ? g : this.numAddCommas(g));
						this._tDom.innerHTML = c
					} else {
						this._curTicket = NaN,
						c = this._encodeHTML(u.getNameByIndex(n));
						for (var v = 0, m = i.length; v < m; v++)
							c += "<br/>" + this._encodeHTML(i[v].name || "") + " : ", g = i[v].data[n], g = typeof g != "undefined" ? typeof g.value != "undefined" ? g.value : g : "-", c += g instanceof Array ? g : this.numAddCommas(g);
						this._tDom.innerHTML = c
					}
					if (p === !1 || !this.option.tooltip.showContent)
						return;
					...
					this._show(h, a + 10, l + 10, d)
				}
			},
			_showPolarTrigger : function (e, t) {
				if (typeof this.component.polar == "undefined" || typeof e == "undefined" || typeof t == "undefined" || t < 0)
					return !1;
				...
				if (r.length > 0) {
					...
					if (d.length <= 0)
						return;
					if (typeof i == "function")
						this._curTicket = "axis:" + t, this._tDom.innerHTML = i.call(this.myChart, d, this._curTicket, this._setContent);
					else if (typeof i == "string") {
						i = i.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}");
						for (var l = 0, c = d.length; l < c; l++)
							i = i.replace("{a" + l + "}", this._encodeHTML(d[l][0])), i = i.replace("{b" + l + "}", this._encodeHTML(d[l][1])), i = i.replace("{c" + l + "}", this.numAddCommas(d[l][2])), i = i.replace("{d" + l + "}", this._encodeHTML(d[l][3]));
						this._tDom.innerHTML = i
					} else {
						i = this._encodeHTML(d[0][1]) + "<br/>" + this._encodeHTML(d[0][3]) + " : " + this.numAddCommas(d[0][2]);
						for (var l = 1, c = d.length; l < c; l++)
							i += "<br/>" + this._encodeHTML(d[l][1]) + "<br/>", i += this._encodeHTML(d[l][3]) + " : " + this.numAddCommas(d[l][2]);
						this._tDom.innerHTML = i
					}
					if (o === !1 || !this.option.tooltip.showContent)
						return;
					...
					this._show(s, f.getX(this._event), f.getY(this._event), u),
					!0
				}
			},
			_showItemTrigger : function () {
				...
				if (typeof a == "function")
					this._curTicket = (e.name || "") + ":" + u.get(this._curTarget, "dataIndex"), this._tDom.innerHTML = a.call(this.myChart, [e.name || "", n, r, i, s, t], this._curTicket, this._setContent);
				else if (typeof a == "string")
					this._curTicket = NaN, a = a.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), a = a.replace("{a0}", this._encodeHTML(e.name || "")).replace("{b0}", this._encodeHTML(n)).replace("{c0}", r instanceof Array ? r : this.numAddCommas(r)), a = a.replace("{d}", "{d0}").replace("{d0}", i || ""), a = a.replace("{e}", "{e0}").replace("{e0}", u.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = a;
				else {
					this._curTicket = NaN;
					if (e.type == o.CHART_TYPE_SCATTER)
						this._tDom.innerHTML = (typeof e.name != "undefined" ? this._encodeHTML(e.name) + "<br/>" : "") + (n === "" ? "" : this._encodeHTML(n) + " : ") + r + (typeof i == "undefined" ? "" : " (" + i + ")");
					else if (e.type == o.CHART_TYPE_RADAR && i) {
						p = i,
						d += this._encodeHTML(n === "" ? e.name || "" : n),
						d += d === "" ? "" : "<br />";
						for (var v = 0; v < p.length; v++)
							d += this._encodeHTML(p[v].text) + " : " + this.numAddCommas(r[v]) + "<br />";
						this._tDom.innerHTML = d
					} else if (e.type == o.CHART_TYPE_CHORD)
						if (typeof s == "undefined")
							this._tDom.innerHTML = this._encodeHTML(n) + " (" + this.numAddCommas(r) + ")";
						else {
						...
						this._tDom.innerHTML = (typeof e.name != "undefined" ? this._encodeHTML(e.name) + "<br/>" : "") + this._encodeHTML(n) + " : " + this.numAddCommas(r) + (typeof i == "undefined" ? "" : " (" + this.numAddCommas(i) + ")")
				}
				if (!this._axisLineShape.invisible || !this._axisShadowShape.invisible)
					this._axisLineShape.invisible = !0, this.zr.modShape(this._axisLineShape.id), this._axisShadowShape.invisible = !0, this.zr.modShape(this._axisShadowShape.id), this.zr.refresh();
				if (c === !1 || !this.option.tooltip.showContent)
					return;
				this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0),
				this._show(l, f.getX(this._event) + 20, f.getY(this._event) - 20, h)
			},
			_styleAxisPointer : function (e, t, n, r, i, s, o, u) {
				if (e.length > 0) {
					var a,
					f,
					l = this.option.tooltip.axisPointer,
					c = l.type,
					h = {
						line : {},
						cross : {},
					...
					this.component.grid.getXend() - o > 100 ? (this._axisCrossShape.style.textAlign = "left", this._axisCrossShape.style.textX = o + 10) : (this._axisCrossShape.style.textAlign = "right", this._axisCrossShape.style.textX = o - 10),
					u - this.component.grid.getY() > 50 ? (this._axisCrossShape.style.textBaseline = "bottom", this._axisCrossShape.style.textY = u - 10) : (this._axisCrossShape.style.textBaseline = "top", this._axisCrossShape.style.textY = u + 10),
					this._axisCrossShape.invisible = !1,
					this.zr.modShape(this._axisCrossShape.id);
					else if (c == "shadow") {
						if (typeof h.shadow.width == "undefined" || h.shadow.width == "auto" || isNaN(h.shadow.width))
							h.shadow.width = s;
						t == r ? Math.abs(this.component.grid.getX() - t) < 2 ? (h.shadow.width /= 2, t = r += h.shadow.width / 2) : Math.abs(this.component.grid.getXend() - t) < 2 && (h.shadow.width /= 2, t = r -= h.shadow.width / 2) : n == i && (Math.abs(this.component.grid.getY() - n) < 2 ? (h.shadow.width /= 2, n = i += h.shadow.width / 2) : Math.abs(this.component.grid.getYend() - n) < 2 && (h.shadow.width /= 2, n = i -= h.shadow.width / 2)),
			...
			ontooltipHover : function (e, t) {
				if (!this._lastTipShape || this._lastTipShape && this._lastTipShape.dataIndex != e.dataIndex) {
					...
					for (var n = 0, r = t.length; n < r; n++)
						t[n].zlevel = this._zlevelBase, t[n].style = p.prototype.getHighlightStyle(t[n].style, t[n].highlightStyle), t[n].draggable = !1, t[n].hoverable = !1, t[n].clickable = !1, t[n].ondragend = null, t[n].ondragover = null, t[n].ondrop = null, this.shapeList.push(t[n]), this.zr.addShape(t[n]);
					this._lastTipShape = {
			...
			showTip : function (e) {
				...
				if (c) {
					...
					case o.CHART_TYPE_K:
						if (typeof this.component.xAxis == "undefined" || typeof this.component.yAxis == "undefined" || f.data.length <= h)
							return;
					...
					case o.CHART_TYPE_RADAR:
						if (typeof this.component.polar == "undefined" || f.data[0].value.length <= h)
							return;
					...
					case o.CHART_TYPE_SCATTER:
						...
						for (var i = 0, s = g.length; i < s; i++)
							if (u.get(g[i], "seriesIndex") == t && u.get(g[i], "dataIndex") == h) {
								this._curTarget = g[i],
								y = g[i].style.x,
								b = l.type != o.CHART_TYPE_K ? g[i].style.y : g[i].style.y[0];
								break
							}
						break;
					case o.CHART_TYPE_RADAR:
					...
					case o.CHART_TYPE_PIE:
						...
						for (var i = 0, s = g.length; i < s; i++)
							if (g[i].type == "sector" && u.get(g[i], "seriesIndex") == t && u.get(g[i], "name") == w) {
								...
								y = this._curTarget.style.x + Math.cos(S) * E.r / 1.5,
								b = this._curTarget.style.y - Math.sin(S) * E.r / 1.5;
								break
							}
						break;
					case o.CHART_TYPE_MAP:
						...
						for (var i = 0, s = g.length; i < s; i++)
							if (g[i].type == "text" && g[i]._mapType == x && g[i].style._name == w) {
								this._curTarget = g[i],
								y = this._curTarget.style.x + this._curTarget.position[0],
								b = this._curTarget.style.y + this._curTarget.position[1];
								break
							}
						break;
					case o.CHART_TYPE_CHORD:
						...
						for (var i = 0, s = g.length; i < s; i++)
							if (g[i].type == "sector" && u.get(g[i], "name") == w) {
								...
								var E = this._curTarget.style,
								S = (E.startAngle + E.endAngle) / 2 * Math.PI / 180;
								y = this._curTarget.style.x + Math.cos(S) * (E.r - 2),
								b = this._curTarget.style.y - Math.sin(S) * (E.r - 2),
								this.zr.trigger(a.EVENT.MOUSEMOVE, {
									zrenderX : y,
									zrenderY : b
								});
								return
			...
			refresh : function (e) {
				...
				if (e) {
					...
					this.option.tooltip.textStyle = h.merge(this.option.tooltip.textStyle, this.ecTheme.textStyle),
					this.option.tooltip.padding = this.reformCssArray(this.option.tooltip.padding),
					this._needAxisTrigger = !1,
					this.option.tooltip.trigger == "axis" && (this._needAxisTrigger = !0);
			...
			dispose : function () {
				...
				this.zr.un(a.EVENT.GLOBALOUT, this._onglobalout),
				this.hasAppend && this.dom.firstChild.removeChild(this._tDom),
				this._tDom = null
			},
	...
	r("zrender/shape/Ring", ["require", "./Base", "../tool/util"], function (e) {
		...
		return n.prototype = {
			type : "ring",
			buildPath : function (e, t) {
				e.arc(t.x, t.y, t.r, 0, Math.PI * 2, !1),
				e.moveTo(t.x + t.r0, t.y),
				e.arc(t.x, t.y, t.r0, 0, Math.PI * 2, !0);
				return
			},
			getRect : function (e) {
				if (e.__rect)
	...
	r("zrender/shape/Sector", ["require", "../tool/math", "./Base", "./Ring", "./Polygon", "../tool/util"], function (e) {
		...
		return r.prototype = {
			...
			buildPath : function (e, n) {
				...
				a = n.endAngle;
				if (Math.abs(a - u) >= 360) {
					e.arc(r, i, o, 0, Math.PI * 2, !1),
					s !== 0 && (e.moveTo(r + s, i), e.arc(r, i, s, 0, Math.PI * 2, !0));
					return
				}
				u = t.degreeToRadian(u),
				a = t.degreeToRadian(a);
				var f = Math.PI * 2,
				l = t.cos(u),
				c = t.sin(u);
				e.moveTo(l * s + r, i - c * s),
				e.lineTo(l * o + r, i - c * o),
				e.arc(r, i, o, f - u, f - a, !0),
				e.lineTo(t.cos(a) * s + r, i - t.sin(a) * s),
				s !== 0 && e.arc(r, i, s, f - a, f - u, !1);
				return
			},
			getRect : function (n) {
				if (n.__rect)
				...
				a = n.endAngle;
				if (Math.abs(a - u) >= 360)
					return n.__rect = e("./Ring").prototype.getRect(n), n.__rect;
				u = (720 + u) % 360,
				a = (720 + a) % 360,
				a <= u && (a += 360);
				var f = [];
				return u <= 90 && a >= 90 && f.push([r, i - o]),
				u <= 180 && a >= 180 && f.push([r - o, i]),
				u <= 270 && a >= 270 && f.push([r, i + o]),
				u <= 360 && a >= 360 && f.push([r + o, i]),
				u = t.degreeToRadian(u),
				a = t.degreeToRadian(a),
				f.push([t.cos(u) * s + r, i - t.sin(u) * s]),
				f.push([t.cos(u) * o + r, i - t.sin(u) * o]),
				f.push([t.cos(a) * o + r, i - t.sin(a) * o]),
				f.push([t.cos(a) * s + r, i - t.sin(a) * s]),
				n.__rect = e("./Polygon").prototype.getRect({
	...
	r("echarts/util/shape/Candle", ["require", "zrender/shape/Base", "zrender/tool/util", "./normalIsCover"], function (e) {
		...
		return r.prototype = {
			...
			buildPath : function (e, t) {
				...
				e.moveTo(t.x, r[3]),
				e.lineTo(t.x, r[2]),
				e.moveTo(t.x - t.width / 2, r[2]),
				e.rect(t.x - t.width / 2, r[2], t.width, r[1] - r[2]),
				e.moveTo(t.x, r[1]),
				e.lineTo(t.x, r[0])
			},
			getRect : function (e) {
				if (!e.__rect) {
					var t = 0;
					if (e.brushType == "stroke" || e.brushType == "fill")
						t = e.lineWidth || 1;
	...
	r("echarts/component/legend", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "zrender/shape/Sector", "../util/shape/Icon", "../util/shape/Candle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function (e) {
		...
		l.prototype = {
			...
			_buildItem : function () {
				...
				for (var S = 0; S < t; S++) {
					c = a.merge(e[S].textStyle || {}, l),
					h = this.getFont(c),
					r = this._getName(e[S]),
					p = this._getFormatterName(r);
					if (r === "") {
					...
					E = this.getColor(r),
					this.legendOption.orient == "horizontal" ? d - m < 200 && y + 5 + f.getTextWidth(p, h) + (S == t - 1 || e[S + 1] === "" ? 0 : w) >= d - m && (m = this._itemGroupLocation.x, g += b + w) : v - g < 200 && b + (S == t - 1 || e[S + 1] === "" ? 0 : w) >= v - g && (this.legendOption.x == "right" ? m -= this._itemGroupLocation.maxWidth + w : m += this._itemGroupLocation.maxWidth + w, g = this._itemGroupLocation.y),
					o = this._getItemShapeByType(m, g, y, b, this._selectedMap[r] ? E : "#ccc", i, E),
					o._name = r,
					o = new s(o),
					u = {
						zlevel : this._zlevelBase,
					...
					this.legendOption.orient == "vertical" && this.legendOption.x == "right" && (u.style.x -= y + 10, u.style.textAlign = "right"),
					u._name = r,
					u = new n(u),
					this.legendOption.selectedMode && (o.onclick = u.onclick = this._legendSelected, o.onmouseover = u.onmouseover = this.hoverConnect, o.hoverConnect = u.id, u.hoverConnect = o.id),
					this.shapeList.push(o),
					this.shapeList.push(u),
					this.legendOption.orient == "horizontal" ? m += y + 5 + f.getTextWidth(p, h) + w : g += b + w
				}
			...
			_getFormatterName : function (e) {
				...
				n;
				return typeof t == "function" ? n = t.call(this.myChart, e) : typeof t == "string" ? n = t.replace("{name}", e) : n = e,
				n
			},
			...
			_mLineOptimize : function () {
				...
				for (var n = 2, r = this.shapeList.length; n < r; n++)
			...
			_getItemGroupLocation : function () {
				...
				if (this.legendOption.orient == "horizontal") {
					...
					for (var m = 0; m < t; m++)
						v = Math.max(v, f.getTextWidth(this._getFormatterNameFromData(e[m]), e[m].textStyle ? this.getFont(a.merge(e[m].textStyle || {}, s)) : o));
					v += r,
					u = v;
					for (var m = 0; m < t; m++) {
						if (this._getName(e[m]) === "") {
							d -= n,
							d > p ? (l = p, u += v + n) : l = Math.max(l, d),
							u += v + n,
							d = 0;
							continue
						}
			...
			_getItemShapeByType : function (e, t, n, r, i, s, o) {
				...
				case "scatter":
					...
					break;
				case "k":
					a.style.brushType = "both",
					a.highlightStyle.lineWidth = 3,
					a.highlightStyle.color = a.style.color = this.query(this.ecTheme, "k.itemStyle.normal.color") || "#fff",
					a.style.strokeColor = i != "#ccc" ? this.query(this.ecTheme, "k.itemStyle.normal.lineStyle.color") || "#ff3200" : i;
					break;
				case "image":
					a.style.iconType = "image",
					a.style.image = f,
					i === "#ccc" && (a.style.opacity = .5)
				}
				return a
			},
			__legendSelected : function (e) {
				...
				if (this.legendOption.selectedMode === "single")
					for (var n in this._selectedMap)
						this._selectedMap[n] = !1;
				this._selectedMap[t] = !this._selectedMap[t],
				this.messageCenter.dispatch(u.EVENT.LEGEND_SELECTED, e.event, {
			...
			refresh : function (e) {
				if (e) {
					...
					if (this.legendOption.selected)
						for (var o in this.legendOption.selected)
							this._selectedMap[o] = typeof this._selectedMap[o] != "undefined" ? this._selectedMap[o] : this.legendOption.selected[o];
					for (var a = 0, f = t.length; a < f; a++) {
						n = this._getName(t[a]);
						if (n === "")
							continue;
						r = this._getSomethingByName(n),
			...
			setItemShape : function (e, t) {
				...
				for (var r = 0, i = this.shapeList.length; r < i; r++)
					n = this.shapeList[r], n._name == e && n.type != "text" && (this._selectedMap[e] || (t.style.color = "#ccc", t.style.strokeColor = "#ccc"), this.zr.modShape(n.id, t))
			},
			...
			setSelected : function (e, t) {
				...
				this.messageCenter.dispatch(u.EVENT.LEGEND_SELECTED, null, {
					selected : this._selectedMap,
					target : e
				}, this.myChart)
			},
			onlegendSelected : function (e, t) {
				var n = e.selected;
				for (var r in n)
					this._selectedMap[r] != n[r] && (t.needRefresh = !0), this._selectedMap[r] = n[r];
				return
			}
		};
		var c = {
			...
			bar : function (e, t) {
				...
				e.moveTo(n + o, r),
				e.lineTo(n + i - o, r),
				e.quadraticCurveTo(n + i, r, n + i, r + o),
				e.lineTo(n + i, r + s - o),
				e.quadraticCurveTo(n + i, r + s, n + i - o, r + s),
				e.lineTo(n + o, r + s),
				e.quadraticCurveTo(n, r + s, n, r + s - o),
				e.lineTo(n, r + o),
		...
		c.map = c.bar;
		for (var h in c)
			s.prototype.iconLibrary["legendicon" + h] = c[h];
		return a.inherits(l, t),
		e("../component").define("legend", l),
		l
	}),
			...
			brushSymbol : function (e, t) {
				...
				for (var o = 0, u = i.length; o < u; o++) {
					...
					if (s.symbol != "none") {
						...
						e.fillStyle = s.isEmpty ? "#fff" : t.strokeColor,
						e.closePath(),
						e.fill(),
						e.stroke()
					}
	...
	r("echarts/component/timeline", ["require", "./base", "zrender/shape/Rectangle", "../util/shape/Icon", "../util/shape/Chain", "../config", "zrender/tool/util", "zrender/tool/area", "zrender/tool/event", "../component"], function (e) {
		function f(e, n, r, i, u) {
			...
			a._setCurrentOption = function () {
				...
				a.myChart.setOption(t, e.notMerge),
				a.messageCenter.dispatch(s.EVENT.TIMELINE_CHANGED, null, {
			...
			a._onFrame = function () {
				a._setCurrentOption(),
				a._syncHandleShape(),
				a.timelineOption.autoPlay && (a.playTicket = setTimeout(function () {
							a.currentIndex += 1;
							if (!a.timelineOption.loop && a.currentIndex >= a.timelineOption.data.length) {
								a.currentIndex = a.timelineOption.data.length - 1,
								a.stop();
								return
							}
							a._onFrame()
			...
			!this.timelineOption.notMerge && this.currentIndex !== 0 && (this.options[this.currentIndex] = o.merge(this.options[this.currentIndex], this.options[0])),
			this.timelineOption.show && (this._buildShape(), this._syncHandleShape()),
		...
		function l(e, t) {
			...
			a = t.symbol;
			if (a == "last")
				e.moveTo(i + o - 2, s + u / 3), e.lineTo(i + o - 2, s), e.lineTo(i + 2, s + u / 2), e.lineTo(i + o - 2, s + u), e.lineTo(i + o - 2, s + u / 3 * 2), e.moveTo(i, s), e.lineTo(i, s);
			else if (a == "next")
				e.moveTo(i + 2, s + u / 3), e.lineTo(i + 2, s), e.lineTo(i + o - 2, s + u / 2), e.lineTo(i + 2, s + u), e.lineTo(i + 2, s + u / 3 * 2), e.moveTo(i, s), e.lineTo(i, s);
			else if (a == "play")
				if (t.status == "stop")
					e.moveTo(i + 2, s), e.lineTo(i + o - 2, s + u / 2), e.lineTo(i + 2, s + u), e.lineTo(i + 2, s);
				else {
					var f = t.brushType == "both" ? 2 : 3;
					e.rect(i + 2, s, f, u),
					e.rect(i + o - f - 2, s, f, u)
				}
			else if (a.match("image")) {
				var l = "";
				l = a.replace(new RegExp("^image:\\/\\/"), ""),
				a = r.prototype.iconLibrary.image,
				a(e, {
					x : i,
					y : s,
					width : o,
		...
		return f.prototype = {
			...
			_buildShape : function () {
				...
				if (this.timelineOption.label.show) {
					...
					for (var t = 0, n = this._chainPoint.length; t < n; t += e)
						this._chainPoint[t].showLabel = !0
				}
				this._buildChain(),
				this._buildHandle();
				for (var t = 0, r = this.shapeList.length; t < r; t++)
			...
			_getReformedLabel : function (e) {
				...
				return r && (typeof r == "function" ? n = r.call(this.myChart, n) : typeof r == "string" && (n = r.replace("{value}", n))),
				n
			},
					...
					if (s > 3) {
						...
						while (!o && n < s) {
							...
							for (var l = n; l < s; l += n) {
								...
								if (t.label.rotate !== 0)
									f = r;
								else if (i[l].textStyle)
									f = u.getTextWidth(e[l].name, e[l].textFont);
								else {
									var c = e[l].name + "",
			...
			_getChainPoint : function () {
				...
				if (h > 1) {
					...
					if (e.type == "number")
						...
						d[0] = new Date(p(0).replace(/-/g, "/")),
						d[h - 1] = new Date(p(h - 1).replace(/-/g, "/")) - d[0];
						for (var m = 1; m < h; m++)
							d[m] = f + v + c * (new Date(p(m).replace(/-/g, "/")) - d[0]) / d[h - 1];
						d[0] = f + v
					}
				} else
					d.push(f + c / 2);
				...
				S;
				for (var m = 0; m < h; m++)
					f = d[m], y = a[m].symbol && a[m].symbol.toLowerCase() || t, y.match("empty") ? (y = y.replace("empty", ""), w = !0) : w = !1, y.match("star") && (b = y.replace("star", "") - 0 || 5, y = "star"), u = a[m].textStyle ? o.merge(a[m].textStyle || {}, i) : i, E = u.align || "center", r ? (E = r > 0 ? "right" : "left", S = [r * Math.PI / 180, f, l - 5]) : S = !1, g.push({
						x : f,
						n : b,
						isEmpty : w,
						symbol : y,
			...
			_buildControl : function () {
				...
				a += s + u,
				this._ctrNextShape = new r(o.clone(l)),
			...
			_buildChain : function () {
				...
				this._timelineShae = new i(this._timelineShae),
			...
			_syncHandleShape : function () {
				...
				t.symbol == "auto" ? this._handleShape.style.iconType = n.symbol != "none" ? n.symbol : "diamond" : (this._handleShape.style.iconType = t.symbol, t.symbol.match("star") && (this._handleShape.style.n = t.symbol.replace("star", "") - 0 || 5, this._handleShape.style.iconType = "star"));
				var r;
				t.symbolSize == "auto" ? (r = n.symbolSize + 2, r = r < 5 ? 5 : r) : r = t.symbolSize - 0,
				this._handleShape.style.color = t.color == "auto" ? n.color ? n.color : e.controlStyle.emphasis.color : t.color,
				this._handleShape.style.textColor = t.label.textStyle.color == "auto" ? this._handleShape.style.color : t.label.textStyle.color,
				this._handleShape.highlightStyle.strokeColor = this._handleShape.style.strokeColor = t.borderColor == "auto" ? n.borderColor ? n.borderColor : "#fff" : t.borderColor,
				this._handleShape.style.lineWidth = t.borderWidth == "auto" ? n.borderWidth ? n.borderWidth : 0 : t.borderWidth - 0,
			...
			_findChainIndex : function (e) {
				...
				if (e >= t[n - 1].x)
					return n - 1;
				for (var r = 0; r < n - 1; r++)
					if (e >= t[r].x && e <= t[r + 1].x)
						return Math.abs(e - t[r].x) < Math.abs(e - t[r + 1].x) ? r : r + 1
			},
			__onclick : function (e) {
			...
			__ondrift : function (e, t) {
				...
				var s = n[i],
				o = s.symbolSize + 2;
				e.style.iconType = s.symbol,
				e.style.n = s.n,
				e.style.textX = e.style.x + o / 2,
				e.style.y = this._location.y + this._location.height / 4 - o,
				e.style.width = o * 2,
				e.style.height = o * 2,
				e.style.text = s.name;
			...
			play : function (e, t) {
				return this._ctrPlayShape && this._ctrPlayShape.style.status != "playing" && (this._ctrPlayShape.style.status = "playing", this.zr.modShape(this._ctrPlayShape.id), this.zr.refresh()),
				this.timelineOption.autoPlay = typeof t != "undefined" ? t : !0,
				this.timelineOption.autoPlay || clearTimeout(this.playTicket),
				this.currentIndex = typeof e != "undefined" ? e : this.currentIndex + 1,
				this.currentIndex >= this.timelineOption.data.length && (this.currentIndex = 0),
				this._onFrame(),
				this.currentIndex
			},
			stop : function () {
				return this._ctrPlayShape && this._ctrPlayShape.style.status != "stop" && (this._ctrPlayShape.style.status = "stop", this.zr.modShape(this._ctrPlayShape.id), this.zr.refresh()),
			...
			setTheme : function (e) {
				this.timelineOption = this.reformOption(o.clone(this.option.timeline)),
				this.timelineOption.padding = this.reformCssArray(this.timelineOption.padding),
				this.timelineOption.label.textStyle = o.merge(this.timelineOption.label.textStyle || {}, this.ecTheme.textStyle),
				this.timelineOption.checkpointStyle.label.textStyle = o.merge(this.timelineOption.checkpointStyle.label.textStyle || {}, this.ecTheme.textStyle),
		...
		r.prototype.iconLibrary.timelineControl = l,
		o.inherits(f, t),
		e("../component").define("timeline", f),
		f
	}),
	r("zrender/loadingEffect/Bar", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Rectangle"], function (e) {
		...
		s.prototype._start = function (e, t) {
			...
			if (s.progress != null) {
				e(u),
				f.highlightStyle.width = this.adjust(s.progress, [0, 1]) * s.effectOption.width,
				e(f),
				e(o),
				t();
				return
			}
			return f.highlightStyle.width = 0,
			setInterval(function () {
				e(u),
				f.highlightStyle.width < a.width ? f.highlightStyle.width += 8 : f.highlightStyle.width = 0,
				e(f),
				e(o),
				t()
			}, a.timeInterval)
		...
		s.prototype._start = function (e, t) {
			...
			return setInterval(function () {
				...
				for (var n = 0; n < f; n++) {
					...
					r.y - h[n].animationY + r.r <= 0 && (h[n].highlightStyle.y = d + r.r, h[n].highlightStyle.x = Math.ceil(Math.random() * p)),
					h[n].highlightStyle.y -= h[n].animationY,
					e(h[n])
				}
				e(o),
				t()
		...
		s.prototype._start = function (e, t) {
			...
			return setInterval(function () {
				...
				for (var n = 0; n < f; n++) {
					...
					r.xStart >= h && (c[n].len = Math.ceil(Math.random() * 400), r.xStart = -400, r.xEnd = -400 + c[n].len, r.yStart = Math.ceil(Math.random() * p), r.yEnd = r.yStart),
					r.xStart += c[n].animationX,
					r.xEnd += c[n].animationX,
					e(c[n])
				}
				e(o),
				t()
	...
	r("zrender/loadingEffect/Ring", ["require", "./Base", "../tool/util", "../tool/color", "../shape/Ring", "../shape/Sector"], function (e) {
		...
		o.prototype._start = function (e, t) {
			...
			if (o.progress != null) {
				e(l),
				x = this.adjust(o.progress, [0, 1]).toFixed(2) * 100 / 5,
				g.highlightStyle.text = x * 5 + "%",
				e(g);
				for (var S = 0; S < 20; S++)
					y[S].highlightStyle.color = S < x ? y[S]._color : m, e(y[S]);
				e(f),
				t();
				return
			}
			return setInterval(function () {
				...
				e(g);
				for (var n = 0; n < 20; n++)
					y[n].highlightStyle.color = n < x ? y[n]._color : m, e(y[n]);
				e(f),
				t()
			}, u.timeInterval)
		},
	...
	r("zrender/loadingEffect/Whirling", ["require", "./Base", "../tool/util", "../shape/Ring", "../shape/Droplet", "../shape/Circle"], function (e) {
		...
		o.prototype._start = function (e, t) {
			...
			p = [0, o.x, o.y];
			return l.highlightStyle.x = c.highlightStyle.x = h.highlightStyle.x = p[1],
			l.highlightStyle.y = c.highlightStyle.y = h.highlightStyle.y = p[2],
			setInterval(function () {
				e(f),
				e(h),
				p[0] -= .3,
	...
	r("echarts/echarts", ["require", "./config", "zrender/tool/util", "zrender/tool/event", "zrender/tool/env", "zrender", "zrender/config", "zrender", "./chart/island", "./component/toolbox", "./component", "./component/title", "./component/tooltip", "./component/legend", "./util/ecData", "./chart", "./component", "zrender/tool/color", "./component/timeline", "zrender", "zrender/shape/Image", "zrender/loadingEffect/Bar", "zrender/loadingEffect/Bubble", "zrender/loadingEffect/DynamicLine", "zrender/loadingEffect/Ring", "zrender/loadingEffect/Spin", "zrender/loadingEffect/Whirling", "./theme/default"], function (e) {
		...
		function l(e) {
			...
			this._messageCenterOutSide = new f,
		...
		i.init = function (t, n) {
			var r = e("zrender");
			(r.version || "1.0.3").replace(".", "") - 0 < i.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + (r.version || "1.0.3-") + " is too old for ECharts " + i.version + ". Current version need ZRender " + i.dependencies.zrender + "+"),
			t = t instanceof Array ? t[0] : t;
			var s = t.getAttribute(a);
			return s || (s = o++, t.setAttribute(a, s)),
			u[s] && u[s].dispose(),
			u[s] = new l(t),
			u[s].id = s,
			u[s].setTheme(n),
		...
		return l.prototype = {
			_init : function () {
				...
				this._zr = r,
				this._messageCenter.dispatch = function (e, t, r, i) {
					r = r || {},
					r.type = e,
					r.event = t,
					n._messageCenter.dispatchWithContext(e, r, i),
					e != "HOVER" ? setTimeout(function () {
				...
				for (var i in t.EVENT)
					i != "CLICK" && i != "HOVER" && i != "MAP_ROAM" && this._messageCenter.bind(t.EVENT[i], this._onevent, this);
				var s = {};
				...
				for (var o = 0, u = h.length; o < u; o++) {
					var a = h[o],
					f = c[a];
					s[f] = "_on" + a.toLowerCase(),
					r.on(f, this._onzrevent)
				}
				this.chart = {},
				this.component = {};
				var l = e("./chart/island");
				this._island = new l(this._themeConfig, this._messageCenter, r, {}, this),
				this.chart.island = this._island;
				var p = e("./component/toolbox");
				this._toolbox = new p(this._themeConfig, this._messageCenter, r, {}, this),
			...
			__onevent : function (e) {
				...
				if (this._connected && n && this._curEventType == e.type) {
					for (var o in this._connected)
						this._connected[o].connectedEventHandler(e);
					this._curEventType = null
				}
				if (!n || !this._connected && n)
					this._curEventType = null
			},
			_onclick : function (e) {
				p(this, "onclick", e);
			...
			_ondrop : function (e) {
				p(this, "ondrop", e, this._status),
				this._island.ondrop(e, this._status)
			},
			_ondragend : function (e) {
				p(this, "ondragend", e, this._status),
				...
				if (this._status.needRefresh) {
					...
					n.dispatch(t.EVENT.DATA_CHANGED, e.event, this._eventPackage(e.target), this),
					n.dispatch(t.EVENT.REFRESH, null, null, this)
				}
			},
			_onlegendSelected : function (e) {
				this._status.needRefresh = !1,
				p(this, "onlegendSelected", e, this._status),
				this._status.needRefresh && this._messageCenter.dispatch(t.EVENT.REFRESH, null, null, this)
			},
			_ondataZoom : function (e) {
				this._status.needRefresh = !1,
				p(this, "ondataZoom", e, this._status),
				this._status.needRefresh && this._messageCenter.dispatch(t.EVENT.REFRESH, null, null, this)
			},
			_ondataRange : function (e) {
				this._clearEffect(),
				this._status.needRefresh = !1,
				p(this, "ondataRange", e, this._status),
				this._status.needRefresh && this._zr.refresh()
			},
			...
			_ondataViewChanged : function (e) {
				...
				this._messageCenter.dispatch(t.EVENT.DATA_CHANGED, null, e, this),
				this._messageCenter.dispatch(t.EVENT.REFRESH, null, null, this)
			},
			...
			_render : function (n) {
				...
				if (r)
					if (!s && r.indexOf("rgba") != -1) {
						var i = r.split(",");
						this.dom.style.filter = "alpha(opacity=" + i[3].substring(0, i[3].lastIndexOf(")")) * 100 + ")",
						i.length = 3,
						i[0] = i[0].replace("a", ""),
						this.dom.style.backgroundColor = i.join(",") + ")"
					} else
						this.dom.style.backgroundColor = r;
				...
				for (var h = 0, p = a.length; h < p; h++)
					l = a[h], c = this.component[l], n[l] ? (c ? c.refresh && c.refresh(n) : (f = u.get(/^[xy]Axis$/.test(l) ? "axis" : l), c = new f(this._themeConfig, this._messageCenter, this._zr, n, this, l), this.component[l] = c), this._chartList.push(c)) : c && (c.dispose(), this.component[l] = null, delete this.component[l]);
				var d,
				v,
				m,
				g = {};
				...
				for (v in this.chart)
					v != t.CHART_TYPE_ISLAND && !g[v] && (this.chart[v].dispose(), this.chart[v] = null, delete this.chart[v]);
				...
				n.renderAsImage && s ? (b ? b.src = this.getDataURL(n.renderAsImage) : (b = this.getImage(n.renderAsImage), b.id = y, b.style.position = "absolute", b.style.left = 0, b.style.top = 0, this.dom.firstChild.appendChild(b)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : b && b.parentNode.removeChild(b),
				b = null,
				this._option = n
			},
			restore : function () {
				this._clearEffect(),
				this._option = n.clone(this._optionRestore),
			...
			refresh : function (e) {
				...
				e = e || {};
				var t = e.option;
				!this._refreshInside && t && (t = this.getOption(), n.merge(t, e.option, !0), n.merge(this._optionRestore, e.option, !0), this._toolbox.reset(t)),
				this._island.refresh(t),
				this._toolbox.refresh(t),
				this._zr.clearAnimation();
				for (var r = 0, i = this._chartList.length; r < i; r++)
					this._chartList[r].refresh && this._chartList[r].refresh(t);
				this.component.grid && this.component.grid.refixAxisShape(this.component),
				this._zr.refresh()
			},
			...
			_setOption : function (e, t) {
				!t && this._option ? this._option = n.merge(this.getOption(), n.clone(e), !0) : this._option = n.clone(e),
				this._optionRestore = n.clone(this._option);
				if (!this._option.series || this._option.series.length === 0) {
					this._zr.clear();
					return
				}
				return this.component.dataZoom && (this._option.dataZoom || this._option.toolbox && this._option.toolbox.feature && this._option.toolbox.feature.dataZoom && this._option.toolbox.feature.dataZoom.show) && this.component.dataZoom.syncOption(this._option),
				...
				function r(r) {
					...
					if (i)
						if (i instanceof Array) {
							var s = i.length;
							while (s--)
								e[r][s].data = n.clone(i[s].data)
						} else
							e[r].data = n.clone(i.data)
				}
			...
			addData : function (e, r, i, s, o) {
					...
					if (h) {
						...
						if (o != null) {
							...
							if (h.type == t.CHART_TYPE_PIE && (g = f.legend) && (y = g.data)) {
								...
								S,
								x = h.xAxisIndex || 0;
								if (typeof f.xAxis[x].type == "undefined" || f.xAxis[x].type == "category")
									E = f.xAxis[x].data, S = a.xAxis[x].data, E[p](o), S[p](o), s || (E[d](), S[d]());
								x = h.yAxisIndex || 0,
								f.yAxis[x].type == "category" && (E = f.yAxis[x].data, S = a.yAxis[x].data, E[p](o), S[p](o), s || (E[d](), S[d]()))
							}
						}
				...
				for (var l = 0, c = T.length; l < c; l++)
					a.addDataAnimation && T[l].addDataAnimation && T[l].addDataAnimation(u);
				this.component.dataZoom && this.component.dataZoom.syncOption(a),
				this._option = a;
				var N = this;
				return setTimeout(function () {
					...
					for (var e = 0, n = T.length; e < n; e++)
						T[e].motionlessOnce = a.addDataAnimation && T[e].addDataAnimation;
					N._messageCenter.dispatch(t.EVENT.REFRESH, null, {
						option : a
					}, N)
				}, a.addDataAnimation ? 500 : 0),
				this
			},
			...
			_addMark : function (e, t, r) {
				...
				if (i && (s = i[e])) {
					...
					for (var l in t)
						l == "data" ? (a.data = a.data.concat(t.data), f.data = f.data.concat(t.data)) : typeof t[l] != "object" || typeof a[l] == "undefined" ? a[l] = f[l] = t[l] : (n.merge(a[l], t[l], !0), n.merge(f[l], t[l], !0));
			...
			_delMark : function (e, t, n) {
				...
				if (u > -1) {
					o.splice(u, 1),
					this._optionRestore.series[e][n].data.splice(u, 1);
			...
			getDataURL : function (e) {
				...
				return i && i.replace(" ", "") == "rgba(0,0,0,0)" && (i = "#fff"),
				this._zr.toDataURL("image/" + e, i)
			},
			getImage : function (e) {
				var t = this._optionRestore.title,
				n = document.createElement("img");
				return n.src = this.getDataURL(e),
			...
			getConnectedDataURL : function (t) {
				...
				for (var a in this._connected)
					n = this._connected[a].getDom(), r[a] = {
				...
				i = Math.min(i, r[a].left),
				s = Math.min(s, r[a].top),
				o = Math.max(o, r[a].right),
				u = Math.max(u, r[a].bottom);
				var f = document.createElement("div");
				f.style.position = "absolute",
				f.style.left = "-4000px",
				f.style.width = o - i + "px",
				f.style.height = u - s + "px",
			...
			getConnectedImage : function (e) {
				var t = this._optionRestore.title,
				n = document.createElement("img");
				return n.src = this.getConnectedDataURL(e),
				n.title = t && t.text || "ECharts",
				n
			},
			on : function (e, t) {
			...
			showLoading : function (t) {
				...
				i.textFont = s.fontStyle + " " + s.fontWeight + " " + s.fontSize + "px " + s.fontFamily,
				i.text = t.text || this._themeConfig.loadingText,
				t.x != null && (i.x = t.x),
				t.y != null && (i.y = t.y),
				...
				if (typeof o == "string" || o == null)
					o = r[t.effect || "spin"];
				return this._zr.showLoading(new o(t.effectOption)),
				this
			},
			...
			setTheme : function (r) {
				if (r) {
					if (typeof r == "string")
						...
						r = r || {};
					for (var i in this._themeConfig)
						delete this._themeConfig[i];
					for (var i in t)
						this._themeConfig[i] = n.clone(t[i]);
					r.color && (this._themeConfig.color = []),
					r.symbolList && (this._themeConfig.symbolList = []),
					n.merge(this._themeConfig, n.clone(r), !0)
				}
				s || (this._themeConfig.textStyle.fontFamily = this._themeConfig.textStyle.fontFamily2),
			...
			resize : function () {
				...
				return function () {
					e._clearEffect(),
					e._zr.resize();
					if (e._option && e._option.renderAsImage && s)
						return e._render(e._option), e;
					e._zr.clearAnimation(),
					e._island.resize(),
					e._toolbox.resize(),
					e._timeline && e._timeline.resize();
					for (var n = 0, r = e._chartList.length; n < r; n++)
						e._chartList[n].resize && e._chartList[n].resize();
					return e.component.grid && e.component.grid.refixAxisShape(e.component),
					e._zr.refresh(),
					e._messageCenter.dispatch(t.EVENT.RESIZE, null, null, e),
					e
				}
			},
	...
	r("echarts/util/shape/GaugePointer", ["require", "zrender/shape/Base", "zrender/tool/util", "./normalIsCover"], function (e) {
		...
		return r.prototype = {
			...
			buildPath : function (e, t) {
				...
				i = t.angle - Math.PI / 2,
				e.moveTo(s, o),
				e.lineTo(t.x + Math.cos(i) * r, t.y - Math.sin(i) * r),
				e.lineTo(t.x + Math.cos(t.angle) * n, t.y - Math.sin(t.angle) * n),
				e.lineTo(t.x - Math.cos(i) * r, t.y + Math.sin(i) * r),
				e.lineTo(s, o);
				return
			},
	...
	r("echarts/chart/gauge", ["require", "../component/base", "./base", "../util/shape/GaugePointer", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "zrender/shape/Circle", "zrender/shape/Sector", "../config", "../util/ecData", "../util/accMath", "zrender/tool/util", "../chart"], function (e) {
		...
		return p.prototype = {
			...
			_buildShape : function () {
				...
				this._paramsMap = {};
				for (var t = 0, n = e.length; t < n; t++)
					e[t].type == f.CHART_TYPE_GAUGE && (e[t] = this.reformOption(e[t]), this._buildSingleGauge(t), this.buildMark(t));
				this.addShapeList()
			},
			_buildSingleGauge : function (e) {
				...
				this._paramsMap[e].totalAngle = this._paramsMap[e].startAngle - this._paramsMap[e].endAngle,
				this._colorMap(e),
			...
			_buildAxisLine : function (e) {
				...
				for (var g = 0, y = a.length; g < y; g++)
					m = o - u * (a[g][0] - n) / r, d = this._getSector(s, p, h, m, v, a[g][1], f), v = m, d._animationAdd = "r", l.set(d, "seriesIndex", e), l.set(d, "dataIndex", g), this.shapeList.push(d)
			},
			_buildSplitLine : function (e) {
				...
				y;
				for (var b = 0; b <= r; b++)
					m = h - p / r * b, g = Math.sin(m), y = Math.cos(m), this.shapeList.push(new s({
							zlevel : this._zlevelBase + 1,
							hoverable : !1,
							style : {
								xStart : c[0] + y * d,
			...
			_buildAxisLabel : function (e) {
				...
				y;
				for (var b = 0; b <= n; b++)
					y = c.accAdd(r, c.accMul(c.accDiv(s, n), b)), v = h - p / n * b, m = Math.sin(v * Math.PI / 180), g = Math.cos(v * Math.PI / 180), v = (v + 360) % 360, this.shapeList.push(new i({
							zlevel : this._zlevelBase + 1,
							hoverable : !1,
							style : {
								x : l[0] + g * d,
			...
			_buildPointer : function (e) {
				...
				l.pack(d, this.series[e], e, this.series[e].data[0], 0, this.series[e].data[0].name, c),
	...
	r("echarts/chart/funnel", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Polygon", "../config", "../util/ecData", "../util/number", "zrender/tool/util", "zrender/tool/color", "zrender/tool/area", "../chart"], function (e) {
		...
		return h.prototype = {
			...
			_buildSingleFunnel : function (e) {
				...
				u = [];
				for (var f = 0, l = r.length; f < l; f++)
					s = r[f].name, t ? this.selectedMap[s] = t.isSelected(s) : this.selectedMap[s] = !0, this.selectedMap[s] && !isNaN(r[f].value) && (u.push(r[f]), o++);
				if (o === 0)
					return;
			...
			_buildFunnelCase : function (e) {
				...
				if (this.deepQuery([t, this.option], "calculable")) {
					...
					return u.pack(i, t, e, undefined, -1),
			...
			_mapData : function (e) {
				...
				for (var r = 0, i = n.length; r < i; r++)
					n[r]._index = r;
				return t.sort != "none" && n.sort(t.sort == "descending" ? s : o),
				n
			},
			_buildItem : function (e, t, n, r, i, s, o, a) {
				...
				u.pack(h, f[e], e, f[e].data[t], t, f[e].data[t].name),
				this.shapeList.push(h);
				var p = this.getLabel(e, t, n, r, i, s, o, a);
				u.pack(p, f[e], e, f[e].data[t], t, f[e].data[t].name),
				this.shapeList.push(p),
				this._needLabel(l, c, !1) || (p.invisible = !0);
				var d = this.getLabelLine(e, t, n, r, i, s, o, a);
				this.shapeList.push(d),
				this._needLabelLine(l, c, !1) || (d.invisible = !0);
				var v = [],
				m = [];
				this._needLabelLine(l, c, !0) && (v.push(d.id), m.push(d.id)),
				this._needLabel(l, c, !0) && (v.push(p.id), m.push(h.id)),
				h.hoverConnect = v,
				p.hoverConnect = m,
				h.onmouseover = p.onmouseover = this.hoverConnect
			},
			...
			getPolygon : function (e, t, n, r, i, o, u, a) {
				...
				return this.deepQuery([c, f, this.option], "calculable") && (this.setCalculable(g), g.draggable = !0),
				new s(g)
			},
			getLabel : function (e, t, n, i, s, o, u, a) {
				...
				x,
				T = n;
				g.position = g.position || v.normal.label.position,
				g.position == "inner" || g.position == "inside" ? (S = "center", x = i + o / 2, Math.max(o, u) / 2 > c.getTextWidth(w, E) ? T = "#fff" : T = l.reverse(n)) : g.position == "left" ? (S = "right", x = b == "auto" ? d.x - 10 : d.centerX - Math.max(o, u) / 2 - b) : (S = "left", x = b == "auto" ? d.x + d.width + 10 : d.centerX + Math.max(o, u) / 2 + b);
				var N = {
					zlevel : this._zlevelBase + 1,
					style : {
						x : x,
			...
			getLabelText : function (e, t, n) {
				...
				if (typeof o == "function")
					return o.call(this.myChart, i.name, s.name, s.value);
				if (typeof o == "string")
					return o = o.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), o = o.replace("{a0}", i.name).replace("{b0}", s.name).replace("{c0}", s.value), o
			},
	...
	r("echarts/component/categoryAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "zrender/tool/area", "../component"], function (e) {
		...
		return a.prototype = {
			...
			_getReformedLabel : function (e) {
				...
				return n && (typeof n == "function" ? t = n.call(this.myChart, t) : typeof n == "string" && (t = n.replace("{value}", t))),
				t
			},
			_getInterval : function () {
							...
							while (!s && e < r) {
								...
								for (var c = Math.floor((r - 1) / e) * e; c >= 0; c -= e) {
									if (this.option.axisLabel.rotate !== 0)
										f = t;
									else if (n[c].textStyle)
										f = u.getTextWidth(this._getReformedLabel(c), this.getFont(o.merge(n[c].textStyle, this.option.axisLabel.textStyle)));
									else {
			...
			_buildAxisTick : function () {
				...
				if (this.isHorizontal()) {
					...
					h;
					for (var p = l; p < t; p += u)
						h = this.subPixelOptimize(this.getCoordByIndex(p) + (p >= 0 ? f : 0), o), e = {
							_axisShape : "axisTick",
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
					...
					v;
					for (var p = l; p < t; p += u)
						v = this.subPixelOptimize(this.getCoordByIndex(p) - (p >= 0 ? f : 0), o), e = {
							_axisShape : "axisTick",
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
			...
			_buildAxisLabel : function () {
				...
				if (this.isHorizontal()) {
					...
					for (var h = 0; h < r; h += this._interval) {
						if (this._getReformedLabel(h) === "")
							continue;
						f = o.merge(t[h].textStyle || {}, a),
						e = {
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
						...
						i && (e.style.textAlign = i > 0 ? this.option.position == "bottom" ? "right" : "left" : this.option.position == "bottom" ? "left" : "right", e.rotation = [i * Math.PI / 180, e.style.x, e.style.y]),
						this.shapeList.push(new n(this._axisLabelClickable(u, e)))
					}
				} else {
					var p,
					d;
					...
					for (var h = 0; h < r; h += this._interval) {
						...
						i && (e.rotation = [i * Math.PI / 180, e.style.x, e.style.y]),
						this.shapeList.push(new n(this._axisLabelClickable(u, e)))
					}
				}
			},
			_buildSplitLine : function () {
				...
				if (this.isHorizontal()) {
					...
					c = this.grid.getYend(),
					h;
					for (var p = 0; p < t; p += this._interval)
						h = this.subPixelOptimize(this.getCoordByIndex(p) + f, s), e = {
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
								xStart : h,
					...
					m;
					for (var p = 0; p < t; p += this._interval)
						m = this.subPixelOptimize(this.getCoordByIndex(p) - f, s), e = {
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
								xStart : d,
			...
			_buildSplitArea : function () {
				...
				if (n instanceof Array) {
					...
					if (this.isHorizontal()) {
						...
						l = this.grid.getX(),
						c;
						for (var h = 0; h <= s; h += this._interval)
							c = h < s ? this.getCoordByIndex(h) + u : this.grid.getXend(), e = {
								zlevel : this._zlevelBase,
								hoverable : !1,
								style : {
									x : l,
						...
						m;
						for (var h = 0; h <= s; h += this._interval)
							m = h < s ? this.getCoordByIndex(h) - u : this.grid.getY(), e = {
								zlevel : this._zlevelBase,
								hoverable : !1,
								style : {
									x : p,
			...
			refresh : function (e) {
				e && (this.option = this.reformOption(e), this.option.axisLabel.textStyle = o.merge(this.option.axisLabel.textStyle || {}, this.ecTheme.textStyle)),
				this.clear(),
				this._buildShape()
			},
			getGap : function () {
			...
			getCoord : function (e) {
				...
				for (var s = 0; s < n; s++) {
					if (t[s] == e || typeof t[s].value != "undefined" && t[s].value == e)
						return this.isHorizontal() ? i = this.grid.getX() + i : i = this.grid.getYend() - i, i;
					i += r
				}
			},
			getCoordByIndex : function (e) {
				...
				return n += e * t,
				this.isHorizontal() ? n = this.grid.getX() + n : n = this.grid.getYend() - n,
				n
			},
		...
		o.inherits(a, t),
		e("../component").define("categoryAxis", a),
		a
	}),
	r("echarts/component/valueAxis", ["require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "../component"], function (e) {
		...
		return u.prototype = {
			...
			_buildAxisTick : function () {
				...
				if (this.isHorizontal()) {
					...
					f;
					for (var l = 0; l < n; l++)
						f = this.subPixelOptimize(this.getCoord(t[l]), u), e = {
							_axisShape : "axisTick",
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
					...
					h;
					for (var l = 0; l < n; l++)
						h = this.subPixelOptimize(this.getCoord(t[l]), u), e = {
							_axisShape : "axisTick",
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
			...
			_buildAxisLabel : function () {
				...
				if (this.isHorizontal()) {
					...
					i && (e.style.textAlign = i > 0 ? this.option.position == "bottom" ? "right" : "left" : this.option.position == "bottom" ? "left" : "right", e.rotation = [i * Math.PI / 180, e.style.x, e.style.y]),
					this.shapeList.push(new n(this._axisLabelClickable(o, e)))
				} else {
					var c,
					h;
			...
			_buildSplitLine : function () {
				...
				if (this.isHorizontal()) {
					...
					c;
					for (var h = 0; h < n; h++)
						c = this.subPixelOptimize(this.getCoord(t[h]), o), e = {
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
								xStart : c,
					...
					v;
					for (var h = 0; h < n; h++)
						v = this.subPixelOptimize(this.getCoord(t[h]), o), e = {
							zlevel : this._zlevelBase,
							hoverable : !1,
							style : {
								xStart : p,
			...
			_buildSplitArea : function () {
				...
				if (t instanceof Array) {
					...
					if (this.isHorizontal()) {
						...
						f;
						for (var l = 0; l <= s; l++)
							f = l < s ? this.getCoord(r[l]) : this.grid.getXend(), e = {
								zlevel : this._zlevelBase,
								hoverable : !1,
								style : {
									x : a,
						...
						d;
						for (var l = 0; l <= s; l++)
							d = l < s ? this.getCoord(r[l]) : this.grid.getY(), e = {
								zlevel : this._zlevelBase,
								hoverable : !1,
								style : {
									x : c,
			...
			_calculateValue : function () {
				if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
					...
					for (var u = 0, a = this.series.length; u < a; u++) {
						if (this.series[u].type != s.CHART_TYPE_LINE && this.series[u].type != s.CHART_TYPE_BAR && this.series[u].type != s.CHART_TYPE_SCATTER && this.series[u].type != s.CHART_TYPE_K)
							continue;
						if (o && !o.isSelected(this.series[u].name))
							continue;
						r = this.series[u].xAxisIndex || 0,
						i = this.series[u].yAxisIndex || 0;
						if (this.option.xAxisIndex != r && this.option.yAxisIndex != i)
							continue;
						var f = this.series[u].name || "kener";
						if (!this.series[u].stack) {
							t[f] = t[f] || [],
							e = this.series[u].data;
							for (var l = 0, c = e.length; l < c; l++)
								n = typeof e[l].value != "undefined" ? e[l].value : e[l], this.series[u].type == s.CHART_TYPE_SCATTER ? (this.option.xAxisIndex != -1 && t[f].push(n[0]), this.option.yAxisIndex != -1 && t[f].push(n[1])) : this.series[u].type == s.CHART_TYPE_K ? (t[f].push(n[0]), t[f].push(n[1]), t[f].push(n[2]), t[f].push(n[3])) : t[f].push(n)
						} else {
							...
							for (var l = 0, c = e.length; l < c; l++) {
								...
								if (n == "-")
									continue;
								n -= 0,
								n >= 0 ? typeof t[h][l] != "undefined" ? t[h][l] += n : t[h][l] = n : typeof t[p][l] != "undefined" ? t[p][l] += n : t[p][l] = n,
								this.option.scale && t[f].push(n)
							}
						}
					}
					for (var u in t) {
					...
					for (var u in t) {
						e = t[u];
						for (var l = 0, c = e.length; l < c; l++)
							isNaN(e[l]) || (this._min = Math.min(this._min, e[l]), this._max = Math.max(this._max, e[l]))
					}
					this._min = isNaN(this.option.min - 0) ? this._min - Math.abs(this._min * this.option.boundaryGap[0]) : this.option.min - 0,
					this._max = isNaN(this.option.max - 0) ? this._max + Math.abs(this._max * this.option.boundaryGap[1]) : this.option.max - 0,
					this._min == this._max && (this._max === 0 ? this._max = this.option.power > 0 ? this.option.power : 1 : this._max > 0 ? this._min = this._max / this.option.splitNumber : this._max = this._max / this.option.splitNumber),
					this._reformValue(this.option.scale)
				} else
					this._hasData = !0, this._min = this.option.min - 0, this._max = this.option.max - 0, this._customerValue()
			},
			_reformValue : function (e) {
				...
				if (this._min >= 0 && this._max >= 0) {
					if (!e) {
						while (this._max / i < t && i != 1)
							i /= 10;
						this._min = 0
					} else {
						while (this._min < i && i != 1)
							i /= 10;
					...
					r = Math.ceil(s / t / i) * i,
					this._max = this._min + r * t
				} else if (this._min <= 0 && this._max <= 0) {
					i = -i;
					if (!e) {
						while (this._min / i < t && i != -1)
							i /= 10;
						this._max = 0
					} else {
						while (this._max > i && i != -1)
							i /= 10;
					...
					o -= o == t ? 1 : 0,
					o += o === 0 ? 1 : 0,
					r = Math.ceil(Math.max(this._max / o, this._min / (o - t)) / i) * i,
					this._max = r * o,
					this._min = r * (o - t)
				}
				this._valueList = [];
				for (var u = 0; u <= t; u++)
					this._valueList.push(this._min + r * u);
				if (n !== 0) {
					i = Math.pow(10, n),
					this._min = (this._min / i).toFixed(n) - 0,
					this._max = (this._max / i).toFixed(n) - 0;
					for (var u = 0; u <= t; u++)
						this._valueList[u] = (this._valueList[u] / i).toFixed(n) - 0
				}
			...
			_customerValue : function () {
				...
				this._valueList = [];
				for (var r = 0; r <= e; r++)
					this._valueList.push((this._min + n * r).toFixed(t) - 0);
				this._reformLabelData()
			},
			_reformLabelData : function () {
				...
				if (e)
					for (var t = 0, n = this._valueList.length; t < n; t++)
						typeof e == "function" ? this._valueLabel.push(e.call(this.myChart, this._valueList[t])) : typeof e == "string" && this._valueLabel.push(e.replace("{value}", this._valueList[t]));
				else
					for (var t = 0, n = this._valueList.length; t < n; t++)
			...
			refresh : function (e, t) {
				e && (this.option = this.reformOption(e), this.option.axisLabel.textStyle = o.merge(this.option.axisLabel.textStyle || {}, this.ecTheme.textStyle), this.series = t),
			...
			getCoord : function (e) {
				...
				var t;
				return this.isHorizontal() ? t = this.grid.getX() + (e - this._min) / (this._max - this._min) * this.grid.getWidth() : t = this.grid.getYend() - (e - this._min) / (this._max - this._min) * this.grid.getHeight(),
				t
			},
		...
		o.inherits(u, t),
		e("../component").define("valueAxis", u),
		u
	}),
		...
		return u.prototype = {
			...
			axisBase : {
				_buildAxisLine : function () {
					...
					this.option.name !== "" && (r.style.text = this.option.name, r.style.textPosition = this.option.nameLocation, r.style.textFont = this.getFont(this.option.nameTextStyle), this.option.nameTextStyle.align && (r.style.textAlign = this.option.nameTextStyle.align), this.option.nameTextStyle.baseline && (r.style.textBaseline = this.option.nameTextStyle.baseline), this.option.nameTextStyle.color && (r.style.textColor = this.option.nameTextStyle.color)),
					r.style.strokeColor = this.option.axisLine.lineStyle.color,
					r.style.lineWidth = e,
					this.isHorizontal() ? r.style.yStart = r.style.yEnd = this.subPixelOptimize(r.style.yEnd, e) : r.style.xStart = r.style.xEnd = this.subPixelOptimize(r.style.xEnd, e),
					r.style.lineType = this.option.axisLine.lineStyle.type,
					r = new n(r),
	...
	r("echarts/component/grid", ["require", "./base", "zrender/shape/Rectangle", "../config", "zrender/tool/util", "../component"], function (e) {
		...
		return s.prototype = {
			...
			refixAxisShape : function (e) {
				var t,
				n,
				i = e.xAxis._axisList.concat(e.yAxis._axisList),
				s = i.length,
				o;
				while (s--)
					o = i[s], o.type == r.COMPONENT_TYPE_AXIS_VALUE && o._min < 0 && o._max >= 0 && (o.isHorizontal() ? t = o.getCoord(0) : n = o.getCoord(0));
				if (typeof t != "undefined" || typeof n != "undefined") {
					s = i.length;
					while (s--)
						i[s].refixAxisShape(t, n)
				}
			},
			refresh : function (e) {
				if (e || this._zrWidth != this.zr.getWidth() || this._zrHeight != this.zr.getHeight()) {
					...
					typeof t.width == "undefined" ? this._width = this._zrWidth - this._x - r : this._width = this.parsePercent(t.width, this._zrWidth),
					typeof t.height == "undefined" ? this._height = this._zrHeight - this._y - i : this._height = this.parsePercent(t.height, this._zrHeight),
	...
	r("echarts/component/dataZoom", ["require", "./base", "zrender/shape/Rectangle", "zrender/shape/Polygon", "../util/shape/Icon", "../config", "zrender/tool/util", "../component", "../component"], function (e) {
		...
		return u.prototype = {
			...
			_getZoom : function () {
				...
				i,
				o,
				u = this.zoomOption.xAxisIndex;
				if (t && typeof u == "undefined") {
					i = [];
					for (var a = 0, f = t.length; a < f; a++)
						(t[a].type == "category" || typeof t[a].type == "undefined") && i.push(a)
				} else
					u instanceof Array ? i = u : typeof u != "undefined" ? i = [u] : i = [];
				u = this.zoomOption.yAxisIndex;
				if (n && typeof u == "undefined") {
					o = [];
					for (var a = 0, f = n.length; a < f; a++)
						n[a].type == "category" && o.push(a)
				} else
					u instanceof Array ? o = u : typeof u != "undefined" ? o = [u] : o = [];
				for (var a = 0, f = e.length; a < f; a++) {
					if (e[a].type != s.CHART_TYPE_LINE && e[a].type != s.CHART_TYPE_BAR && e[a].type != s.CHART_TYPE_SCATTER && e[a].type != s.CHART_TYPE_K)
						continue;
			...
			_backupData : function () {
				...
				for (var n = 0, r = o.length; n < r; n++)
					this._originalData.yAxis[o[n]] = i[o[n]].data;
				var u = this.option.series,
				a = this._zoom.seriesIndex,
				f;
				for (var n = 0, r = a.length; n < r; n++)
					f = u[a[n]], this._originalData.series[a[n]] = f.data, f.type == s.CHART_TYPE_SCATTER && this._calculScatterMap(a[n])
			},
			_calculScatterMap : function (t) {
				...
				this._zoom.scatterMap[t].x = s.getAxis(u).getExtremum(),
				s.dispose(),
				i = o.clone(this.option.yAxis),
				i instanceof Array ? (i[0].type = "value", i[1] && (i[1].type = "value", i[1].boundary = [0, 0])) : (i.type = "value", i.boundary = [0, 0]),
				s = new r(this.ecTheme, null, !1, {
						yAxis : i,
						series : this.option.series
					}, this, "yAxis"),
				u = this.option.series[t].yAxisIndex || 0,
				this._zoom.scatterMap[t].y = s.getAxis(u).getExtremum(),
				s.dispose()
			},
			_buildBackground : function () {
				...
				for (var a = 0, f = p.length; a < f; a++)
					m = typeof p[a] != "undefined" ? typeof p[a].value != "undefined" ? p[a].value : p[a] : 0, this.option.series[h].type == s.CHART_TYPE_K && (m = m[1]), isNaN(m) && (m = 0), d = Math.max(d, m), v = Math.min(v, m);
				var g = d - v,
				y = [],
				b = e / (i - (i > 1 ? 1 : 0)),
				w = t / (i - (i > 1 ? 1 : 0)),
				...
				for (var a = 0, f = i; a < f; a += E)
					m = typeof p[a] != "undefined" ? typeof p[a].value != "undefined" ? p[a].value : p[a] : 0, this.option.series[h].type == s.CHART_TYPE_K && (m = m[1]), isNaN(m) && (m = 0), this.zoomOption.orient == "horizontal" ? y.push([this._location.x + b * a, this._location.y + t - 1 - Math.round((m - v) / g * (t - 10))]) : y.push([this._location.x + 1 + Math.round((m - v) / g * (e - 10)), this._location.y + w * a]);
				this.zoomOption.orient == "horizontal" ? (y.push([this._location.x + e, this._location.y + t]), y.push([this._location.x, this._location.y + t])) : (y.push([this._location.x, this._location.y + t]), y.push([this._location.x, this._location.y])),
				this.shapeList.push(new r({
						zlevel : this._zlevelBase,
						style : {
							pointList : y,
			...
			_buildHandle : function () {
				...
				this._startShape = new i(this._startShape),
				this._endShape = new i(this._endShape),
			...
			_buildFrame : function () {
				...
				this._endFrameShape = o.clone(this._startFrameShape),
			...
			_syncFillerShape : function () {
				var e,
				t;
				this.zoomOption.orient == "horizontal" ? (e = this._startShape.style.x, t = this._endShape.style.x, this._fillerShae.style.x = Math.min(e, t) + this._handleSize, this._fillerShae.style.width = Math.abs(e - t) - this._handleSize, this._zoom.start = Math.floor((Math.min(e, t) - this._location.x) / this._location.width * 100), this._zoom.end = Math.ceil((Math.max(e, t) + this._handleSize - this._location.x) / this._location.width * 100)) : (e = this._startShape.style.y, t = this._endShape.style.y, this._fillerShae.style.y = Math.min(e, t) + this._handleSize, this._fillerShae.style.height = Math.abs(e - t) - this._handleSize, this._zoom.start = Math.floor((Math.min(e, t) - this._location.y) / this._location.height * 100), this._zoom.end = Math.ceil((Math.max(e, t) + this._handleSize - this._location.y) / this._location.height * 100)),
				this.zr.modShape(this._fillerShae.id),
				this._syncFrameShape(),
				this.zr.refresh()
			},
			_syncFrameShape : function () {
				this.zoomOption.orient == "horizontal" ? (this._startFrameShape.style.width = this._fillerShae.style.x - this._location.x, this._endFrameShape.style.x = this._fillerShae.style.x + this._fillerShae.style.width, this._endFrameShape.style.width = this._location.x + this._location.width - this._endFrameShape.style.x) : (this._startFrameShape.style.height = this._fillerShae.style.y - this._location.y, this._endFrameShape.style.y = this._fillerShae.style.y + this._fillerShae.style.height, this._endFrameShape.style.height = this._location.y + this._location.height - this._endFrameShape.style.y),
				...
				for (var u in this._originalData) {
					...
					for (var a in t) {
						...
						if (typeof o == "undefined")
							continue;
						i = o.length,
						n = Math.floor(this._zoom.start / 100 * i),
						r = Math.ceil(this._zoom.end / 100 * i),
						this.option[u][a].type != s.CHART_TYPE_SCATTER ? this.option[u][a].data = o.slice(n, r) : this.option[u][a].data = this._synScatterData(a, o)
					}
				}
			...
			_synScatterData : function (e, t) {
				...
				var f;
				for (var l = 0, c = t.length; l < c; l++)
					f = t[l].value || t[l], f[0] >= s && f[0] <= o && f[1] >= u && f[1] <= a && n.push(t[l]);
				return n
			},
			__ondrift : function (e, t, n) {
				this.zoomOption.zoomLock && (e = this._fillerShae);
				var r = e._type == "filler" ? this._handleSize : 0;
				return this.zoomOption.orient == "horizontal" ? e.style.x + t - r <= this._location.x ? e.style.x = this._location.x + r : e.style.x + t + e.style.width + r >= this._location.x + this._location.width ? e.style.x = this._location.x + this._location.width - e.style.width - r : e.style.x += t : e.style.y + n - r <= this._location.y ? e.style.y = this._location.y + r : e.style.y + n + e.style.height + r >= this._location.y + this._location.height ? e.style.y = this._location.y + this._location.height - e.style.height - r : e.style.y += n,
				e._type == "filler" ? this._syncHandleShape() : this._syncFillerShape(),
			...
			ondragend : function (e, t) {
				...
				t.dragOut = !0,
				t.dragIn = !0,
				!this._isSilence && !this.zoomOption.realtime && this.messageCenter.dispatch(s.EVENT.DATA_ZOOM, null, {
					zoom : this._zoom
				}, this.myChart),
				t.needRefresh = !1,
				this.isDragend = !1;
			...
			rectZoom : function (e) {
				...
				if (n.x > t.x + t.width || n.y > t.y + t.height)
					return !1;
				n.x < t.x && (n.x = t.x),
				n.x + n.width > t.x + t.width && (n.width = t.x + t.width - n.x),
				n.y + n.height > t.y + t.height && (n.height = t.y + t.height - n.y);
				var r,
				i = (n.x - t.x) / t.width,
				s = 1 - (n.x + n.width - t.x) / t.width,
				o = 1 - (n.y + n.height - t.y) / t.height,
				u = (n.y - t.y) / t.height;
				return this.zoomOption.orient == "horizontal" ? (r = this._zoom.end - this._zoom.start, this._zoom.start += r * i, this._zoom.end -= r * s, r = this._zoom.end2 - this._zoom.start2, this._zoom.start2 += r * o, this._zoom.end2 -= r * u) : (r = this._zoom.end - this._zoom.start, this._zoom.start += r * o, this._zoom.end -= r * u, r = this._zoom.end2 - this._zoom.start2, this._zoom.start2 += r * i, this._zoom.end2 -= r * s),
				this._syncShape(),
				this._syncData(!0),
				this._zoom
			},
			syncBackupData : function (e) {
				...
				for (var s = 0, o = r.length; s < o; s++) {
					i = r[s].data,
					n[s] ? t = Math.floor(this._zoom.start / 100 * n[s].length) : t = 0;
	...
	r("echarts/component/dataRange", ["require", "./base", "zrender/shape/Text", "zrender/shape/Rectangle", "../util/shape/HandlePolygon", "../config", "zrender/tool/util", "zrender/tool/area", "zrender/tool/color", "zrender/tool/color", "../component"], function (e) {
		...
		return f.prototype = {
			...
			_buildShape : function () {
				this._itemGroupLocation = this._getItemGroupLocation(),
				this._buildBackground(),
				this.dataRangeOption.splitNumber <= 0 || this.dataRangeOption.calculable ? this._buildGradient() : this._buildItem();
				for (var e = 0, t = this.shapeList.length; e < t; e++)
					this.zr.addShape(this.shapeList[e]);
			...
			_buildItem : function () {
				...
				for (var g = 0; g < t; g++)
					i = e[g], v = this.getColor((t - g) * this._gap + this.dataRangeOption.min), s = this._getItemShape(f, l, c, h, this._selectedMap[g] ? v : "#ccc"), s._idx = g, s.onclick = this._dataRangeSelected, this.shapeList.push(new r(s)), m && (o = {
							zlevel : this._zlevelBase,
							style : {
								x : f + c + 5,
								y : l,
			...
			_buildGradient : function () {
				...
				v = [];
				for (var m = 0, g = this.dataRangeOption.color.length; m < g; m++)
					v.push([m * d, this.dataRangeOption.color[m]]);
				this.dataRangeOption.orient == "horizontal" ? (t = {
						...
						hoverable : !1
					}, a += l * 10 + this._textGap),
				this.shapeList.push(new r(t)),
				this.dataRangeOption.calculable && (this._calculableLocation = t.style, this._buildFiller(), this._bulidMask(), this._bulidHandle()),
				!h && this.dataRangeOption.text[1] && (i = this._getTextShape(o, a, this.dataRangeOption.text[1]), this.shapeList.push(new n(i)))
			},
			_buildFiller : function () {
				this._fillerShae = {
					zlevel : this._zlevelBase + 1,
				...
				this._fillerShae = new r(this._fillerShae),
				this.shapeList.push(this._fillerShae)
			},
			...
			_bulidMask : function () {
				...
				this._startMask = new r(this._startMask),
				this._endMask = new r(this._endMask),
			...
			_getItemGroupLocation : function () {
				...
				case "right":
					...
					break;
				default:
					h = this.parsePercent(this.dataRangeOption.x, p),
					h = isNaN(h) ? 0 : h
				}
				var d,
				v = this.zr.getHeight();
				...
				case "center":
					...
					break;
				default:
					d = this.parsePercent(this.dataRangeOption.y, v),
					d = isNaN(d) ? 0 : d
				}
			...
			__ondrift : function (e, t, n) {
				...
				return this.dataRangeOption.orient == "horizontal" ? e.style.x + t <= r ? e.style.x = r : e.style.x + t + e.style.width >= r + s ? e.style.x = r + s - e.style.width : e.style.x += t : e.style.y + n <= i ? e.style.y = i : e.style.y + n + e.style.height >= i + o ? e.style.y = i + o - e.style.height : e.style.y += n,
				e._type == "filler" ? this._syncHandleShape() : this._syncFillerShape(e),
			...
			ondragend : function (e, t) {
				...
				t.dragOut = !0,
				t.dragIn = !0,
				!this.dataRangeOption.realtime && !1 && this.messageCenter.dispatch(s.EVENT.DATA_RANGE, null, {
					range : {
			...
			_syncShapeFromRange : function () {
				...
				this._range.end = typeof this._range.end != "undefined" ? this._range.end : typeof e.start != "undefined" ? e.start : 0,
				this._range.start = typeof this._range.start != "undefined" ? this._range.start : typeof e.end != "undefined" ? e.end : 100;
				if (this._range.start != 100 || this._range.end !== 0) {
					if (this.dataRangeOption.orient == "horizontal") {
						var t = this._fillerShae.style.width;
						this._fillerShae.style.x += t * (100 - this._range.start) / 100,
						this._fillerShae.style.width = t * (this._range.start - this._range.end) / 100
					} else {
						var n = this._fillerShae.style.height;
						this._fillerShae.style.y += n * (100 - this._range.start) / 100,
						this._fillerShae.style.height = n * (this._range.start - this._range.end) / 100
					}
					this.zr.modShape(this._fillerShae.id),
					this._syncHandleShape()
				}
			...
			__dataRangeSelected : function (e) {
				var t = e.target._idx;
				this._selectedMap[t] = !this._selectedMap[t],
				this.messageCenter.dispatch(s.EVENT.REFRESH, null, null, this.myChart)
			},
			_textFormat : function (e, t) {
				e = e.toFixed(this.dataRangeOption.precision),
				t = typeof t != "undefined" ? t.toFixed(this.dataRangeOption.precision) : "";
				if (this.dataRangeOption.formatter) {
					if (typeof this.dataRangeOption.formatter == "string")
						return this.dataRangeOption.formatter.replace("{value}", e).replace("{value2}", t);
					if (typeof this.dataRangeOption.formatter == "function")
						return this.dataRangeOption.formatter.call(this.myChart, e, t)
				}
				return t !== "" ? e + " - " + t : e
			},
			refresh : function (e) {
				if (e) {
					...
					if (this._colorList.length > t) {
						...
						i = n / (t - 1);
						for (var s = 1; s < t - 1; s++)
							r.push(this._colorList[Math.floor(s * i)]);
						r.push(this._colorList[n - 1]),
						this._colorList = r
					}
					var o = this.dataRangeOption.precision;
					this._gap = (this.dataRangeOption.max - this.dataRangeOption.min) / t;
					while (this._gap.toFixed(o) - 0 != this._gap && o < 5)
						o++;
					this.dataRangeOption.precision = o,
					this._gap = ((this.dataRangeOption.max - this.dataRangeOption.min) / t).toFixed(o) - 0,
					this._valueTextList = [];
					for (var s = 0; s < t; s++)
						this._selectedMap[s] = !0, this._valueTextList.unshift(this._textFormat(s * this._gap + this.dataRangeOption.min, (s + 1) * this._gap + this.dataRangeOption.min))
				}
				this.clear(),
				this._buildShape()
			},
			getColor : function (e) {
				...
				if (this.dataRangeOption.calculable)
					if (e - (this._gap * this._range.start + this.dataRangeOption.min) > 5e-5 || e - (this._gap * this._range.end + this.dataRangeOption.min) < -0.00005)
						return null;
		...
		o.inherits(f, t),
		e("../component").define("dataRange", f),
		f
	}),
		...
		return u.prototype = {
			...
			_buildShape : function () {
				...
				for (var f = 0, l = e.length; f < l; f++) {
					...
					if (r.type == i.CHART_TYPE_SCATTER) {
						e[f] = this.reformOption(e[f]),
						this._sIndex2ShapeMap[f] = this.query(r, "symbol") || this._symbol[f % this._symbol.length];
						if (t) {
							this.selectedMap[s] = t.isSelected(s),
							this._sIndex2ColorMap[f] = o.alpha(t.getColor(s), .5),
							u = t.getItemShape(s);
							if (u) {
								var a = this._sIndex2ShapeMap[f];
								u.style.brushType = a.match("empty") ? "stroke" : "both",
								a = a.replace("empty", "").toLowerCase(),
								a.match("rectangle") && (u.style.x += Math.round((u.style.width - u.style.height) / 2), u.style.width = u.style.height),
								a.match("star") && (u.style.n = a.replace("star", "") - 0 || 5, a = "star"),
								a.match("image") && (u.style.image = a.replace(new RegExp("^image:\\/\\/"), ""), u.style.x += Math.round((u.style.width - u.style.height) / 2), u.style.width = u.style.height, a = "image"),
								u.style.iconType = a,
								t.setItemShape(s, u)
							}
						} else
							this.selectedMap[s] = !0, this._sIndex2ColorMap[f] = this.zr.getColor(f);
			...
			_buildSeries : function (e) {
				...
				for (var c = 0, h = e.length; c < h; c++) {
					...
					if (r.data.length === 0)
						continue;
					o = this.component.xAxis.getAxis(r.xAxisIndex || 0),
					u = this.component.yAxis.getAxis(r.yAxisIndex || 0),
					a[n] = [];
					for (var p = 0, d = r.data.length; p < d; p++) {
						i = r.data[p],
						s = typeof i != "undefined" ? typeof i.value != "undefined" ? i.value : i : "-";
						if (s == "-" || s.length < 2)
							continue;
						f = o.getCoord(s[0]),
						l = u.getCoord(s[1]),
						a[n].push([f, l, p, i.name || ""])
					}
					this.xMarkMap[n] = this._markMap(o, u, r.data, a[n]),
					this.buildMark(n)
				}
			...
			_markMap : function (e, t, n, r) {
				...
				for (var o = 0, u = r.length; o < u; o++)
					s = n[r[o][2]].value || n[r[o][2]], i.min0 > s[0] && (i.min0 = s[0], i.minY0 = r[o][1], i.minX0 = r[o][0]), i.max0 < s[0] && (i.max0 = s[0], i.maxY0 = r[o][1], i.maxX0 = r[o][0]), i.sum0 += s[0], i.counter0++, i.min1 > s[1] && (i.min1 = s[1], i.minY1 = r[o][1], i.minX1 = r[o][0]), i.max1 < s[1] && (i.max1 = s[1], i.maxY1 = r[o][1], i.maxX1 = r[o][0]), i.sum1 += s[1], i.counter1++;
				...
				i.averageLine0 = [[h, c], [h, l]],
				i.minLine0 = [[i.minX0, c], [i.minX0, l]],
				i.maxLine0 = [[i.maxX0, c], [i.maxX0, l]],
				i.average1 = (i.sum1 / i.counter1).toFixed(2) - 0;
				var p = t.getCoord(i.average1);
				return i.averageLine1 = [[a, p], [f, p]],
				i.minLine1 = [[a, i.minY1], [f, i.minY1]],
				i.maxLine1 = [[a, i.maxY1], [f, i.maxY1]],
				i
			},
			_buildPointList : function (e) {
				...
				for (var o in e) {
					...
					for (var u = 0, a = r.length; u < a; u++)
						i = r[u], s = this._getSymbol(o, i[2], i[3], i[0], i[1]), s && this.shapeList.push(s)
				}
			},
			...
			getMarkCoord : function (e, t) {
				...
				if (!t.type || t.type != "max" && t.type != "min" && t.type != "average")
					o = [typeof t.xAxis != "string" && i.getCoordByIndex ? i.getCoordByIndex(t.xAxis || 0) : i.getCoord(t.xAxis || 0), typeof t.yAxis != "string" && s.getCoordByIndex ? s.getCoordByIndex(t.yAxis || 0) : s.getCoord(t.yAxis || 0)];
				else {
	...
	r("echarts/chart/k", ["require", "../component/base", "./base", "../util/shape/Candle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "../chart"], function (e) {
		...
		return u.prototype = {
			...
			_buildShape : function () {
				...
				n;
				for (var r = 0, s = e.length; r < s; r++)
					e[r].type == i.CHART_TYPE_K && (e[r] = this.reformOption(e[r]), n = this.component.xAxis.getAxis(e[r].xAxisIndex), n.type == i.COMPONENT_TYPE_AXIS_CATEGORY && t[n.getPosition()].push(r));
				for (var o in t)
					t[o].length > 0 && this._buildSinglePosition(o, t[o]);
				this.addShapeList()
			},
			...
			_mapData : function (e) {
				...
				for (var u = 0, a = e.length; u < a; u++)
					n = t[e[u]], r = n.name, i ? this.selectedMap[r] = i.isSelected(r) : this.selectedMap[r] = !0, this.selectedMap[r] && s.push(e[u]), o = Math.max(o, n.data.length);
				return {
					locationMap : s,
					maxDataLength : o
				}
			...
			_buildHorizontal : function (e, t, n) {
				...
				for (var v = 0, m = n.length; v < m; v++) {
					...
					c = s.barWidth || Math.floor(u.getGap() / 2),
					d = s.barMaxWidth,
					d && d < c && (c = d),
					a = s.yAxisIndex || 0,
					...
					for (var g = 0, y = t; g < y; g++) {
						if (typeof u.getNameByIndex(g) == "undefined")
							break;
						h = s.data[g],
						p = typeof h != "undefined" ? typeof h.value != "undefined" ? h.value : h : "-";
						if (p == "-" || p.length != 4)
							continue;
			...
			_buildKLine : function (e, t) {
				...
				for (var E = 0, S = e.length; E < S; E++) {
					...
					d = n[w],
					g = t[w],
					this._isLarge(g) && (g = this._getLargePointList(g));
					if (d.type == i.CHART_TYPE_K && typeof g != "undefined") {
						v = d,
						r = this.query(v, "itemStyle.normal.lineStyle.width"),
						s = this.query(v, "itemStyle.normal.lineStyle.color"),
						o = this.query(v, "itemStyle.normal.lineStyle.color0"),
						u = this.query(v, "itemStyle.normal.color"),
						a = this.query(v, "itemStyle.normal.color0"),
						f = this.query(v, "itemStyle.emphasis.lineStyle.width"),
						l = this.query(v, "itemStyle.emphasis.lineStyle.color"),
						c = this.query(v, "itemStyle.emphasis.lineStyle.color0"),
						h = this.query(v, "itemStyle.emphasis.color"),
						p = this.query(v, "itemStyle.emphasis.color0");
						for (var x = 0, T = g.length; x < T; x++)
							y = g[x], m = d.data[y[6]], v = m, b = y[3] < y[2], this.shapeList.push(this._getCandle(w, y[6], y[7], y[0], y[1], y[2], y[3], y[4], y[5], b ? this.query(v, "itemStyle.normal.color") || u : this.query(v, "itemStyle.normal.color0") || a, this.query(v, "itemStyle.normal.lineStyle.width") || r, b ? this.query(v, "itemStyle.normal.lineStyle.color") || s : this.query(v, "itemStyle.normal.lineStyle.color0") || o, b ? this.query(v, "itemStyle.emphasis.color") || h || u : this.query(v, "itemStyle.emphasis.color0") || p || a, this.query(v, "itemStyle.emphasis.lineStyle.width") || f || r, b ? this.query(v, "itemStyle.emphasis.lineStyle.color") || l || s : this.query(v, "itemStyle.emphasis.lineStyle.color0") || c || o))
					}
				}
			},
			_isLarge : function (e) {
			...
			_getCandle : function (e, t, n, i, o, u, a, f, l, c, h, p, d, v, m) {
				...
				return s.pack(y, g[e], e, g[e].data[t], t, n),
				y = new r(y),
				y
			},
			getMarkCoord : function (e, t) {
			...
			addDataAnimation : function (e) {
				...
				for (var r = 0, i = this.shapeList.length; r < i; r++) {
					...
					if (n[l] && !n[l][3] && this.shapeList[r].type == "candle") {
						c = s.get(this.shapeList[r], "dataIndex"),
						f = t[l];
						...
						u = this.component.xAxis.getAxis(f.xAxisIndex || 0).getGap(),
						o = n[l][2] ? u : -u,
						a = 0,
						this.zr.animate(this.shapeList[r].id, "").when(500, {
							position : [o, a]
						}).start()
					}
				}
		...
		return l.prototype = {
			...
			_buildShape : function () {
				for (var e = 0; e < this.polar.length; e++)
					this._index = e, this.reformOption(this.polar[e]), this._queryTarget = [this.polar[e], this.option], this._createVector(e), this._buildSpiderWeb(e), this._buildText(e), this._adjustIndicatorValue(e), this._addAxisLabel(e);
			...
			_createVector : function (e) {
				...
				a;
				for (var l = 0; l < r; l++)
					a = f.polar2cartesian(o, i * Math.PI / 180 + s * l), u.push({
						vector : [a[1], -a[0]]
					})
			},
			_getRadius : function () {
			...
			_buildSpiderWeb : function (e) {
				...
				this._addArea(n, o, s, r, u, a, f),
				l.show && this._addLine(n, s, l)
			},
			_addAxisLabel : function (e) {
				...
				u,
				f,
				l = this.deepQuery(this._queryTarget, "splitNumber"),
				c = this.getCenter(e),
				o,
				h,
				p,
				d,
				v,
				m = this.deepQuery(this._queryTarget, "precision"),
				g;
				for (var y = 0; y < r.length; y++) {
					s = this.deepQuery([r[y], t, this.option], "axisLabel");
					if (s.show) {
						u = {},
						u.textFont = this.getFont(),
						u = a.merge(u, s),
						u.lineWidth = u.width,
						o = i[y].vector,
						h = i[y].value,
						d = y / r.length * 2 * Math.PI,
						v = s.offset || 10,
						g = s.interval || 0;
						for (var b = 1; b <= l; b += g + 1)
							f = a.merge({}, u), p = b * (h.max - h.min) / l + h.min, m && (p = p.toFixed(m)), f.text = this.numAddCommas(p), f.x = b * o[0] / l + Math.cos(d) * v + c[0], f.y = b * o[1] / l + Math.sin(d) * v + c[1], this.shapeList.push(new n({
									zlevel : this._zlevelBase,
									style : f,
									draggable : !1,
									hoverable : !1
			...
			_buildText : function (e) {
				...
				for (var v = 0; v < s.length; v++) {
					...
					if (!f.show)
						continue;
					d = this.deepQuery([f, t, this.option], "textStyle"),
					u = {},
					u.textFont = this.getFont(d),
					u.color = d.color,
					typeof f.formatter == "function" ? u.text = f.formatter.call(this.myChart, s[v].text, v) : typeof f.formatter == "string" ? u.text = f.formatter.replace("{value}", s[v].text) : u.text = s[v].text,
					r[v].text = u.text,
					i = r[v].vector,
					Math.round(i[0]) > 0 ? a = "left" : Math.round(i[0]) < 0 ? a = "right" : a = "center",
					f.margin ? (p = f.margin, c = i[0] > 0 ? p : -p, h = i[1] > 0 ? p : -p, c = i[0] === 0 ? 0 : c, h = i[1] === 0 ? 0 : h, i = this._mapVector(i, o, 1)) : i = this._mapVector(i, o, 1.2),
					u.textAlign = a,
					u.x = i[0] + c,
					u.y = i[1] + h,
					f.rotate ? l = [f.rotate / 180 * Math.PI, i[0], i[1]] : l = [0, 0, 0],
					this.shapeList.push(new n({
							zlevel : this._zlevelBase,
							style : u,
							draggable : !1,
			...
			getDropBox : function (e) {
				...
				if (a == "polygon") {
					for (var f = 0; f < i; f++)
						o = r[f].vector, s.push(this._mapVector(o, n, 1.2));
					u = this._getShape(s, "fill", "rgba(0,0,0,0)", "", 1)
				} else
					a == "circle" && (u = this._getCircle("", 1, 1.2, n, "fill", "rgba(0,0,0,0)"));
				return u
			},
			_addArea : function (e, t, n, r, i, s, o) {
				...
				for (var h = 0; h < t; h++)
					a = (t - h) / t, o && (c == "polygon" ? (l = this._getPointList(e, a, n), u = this._getShape(l, "stroke", "", i, s)) : c == "circle" && (u = this._getCircle(i, s, a, n, "stroke")), this.shapeList.push(u)), r.show && (f = (t - h - 1) / t, this._addSplitArea(e, r, a, f, n, h))
			},
			...
			_getPointList : function (e, t, n) {
				...
				s;
				for (var o = 0; o < i; o++)
					s = e[o].vector, r.push(this._mapVector(s, n, t));
				return r
			},
			...
			_addSplitArea : function (e, t, n, r, i, s) {
				...
				if (d == "polygon")
					for (var v = 0; v < o; v++)
						h = [], l = e[v].vector, c = e[(v + 1) % o].vector, h.push(this._mapVector(l, i, n)), h.push(this._mapVector(l, i, r)), h.push(this._mapVector(c, i, r)), h.push(this._mapVector(c, i, n)), p = this._getShape(h, "fill", u, "", 1), this.shapeList.push(p);
				else
					d == "circle" && (p = this._getRing(u, n, r, i), this.shapeList.push(p))
			},
			...
			_addLine : function (e, t, n) {
				...
				f = o.type;
				for (var l = 0; l < r; l++)
					s = e[l].vector, i = this._getLine(t[0], t[1], s[0] + t[0], s[1] + t[1], u, a, f), this.shapeList.push(i)
			},
			...
			_adjustIndicatorValue : function (e) {
				...
				for (var d = 0; d < r; d++)
					typeof n[d].max == "number" ? (o = n[d].max, u = n[d].min || 0, s = {
							max : o,
							min : u
			...
			_getSeriesData : function (e) {
				...
				for (var o = 0; o < this.series.length; o++) {
					n = this.series[o];
					if (n.type != u.CHART_TYPE_RADAR)
						continue;
					r = n.data || [];
					for (var a = 0; a < r.length; a++)
						s = this.deepQuery([r[a], n, this.option], "polarIndex") || 0, s == e && (!i || i.isSelected(r[a].name)) && t.push(r[a])
				}
				return t
			},
			_findValue : function (e, t, n, r, i, s, o) {
				...
				if (e.length != 1)
					for (var g = 0; g < e.length; g++)
						f = typeof e[g].value[t].value != "undefined" ? e[g].value[t].value : e[g].value[t], m(f);
				else {
					v = e[0];
					for (var g = 0; g < v.value.length; g++)
						m(typeof v.value[g].value != "undefined" ? v.value[g].value : v.value[g])
				}
				if (e.length != 1)
					if (o) {
						...
						if (l >= 1)
							...
							if (l === 0)
								return u > 0 ? (d = 0, p = 2 * u) : u === 0 ? (d = 0, p = 100) : (p = 0, d = 2 * a), {
									max : p,
									min : d
								};
							c = (l + "").split(".")[1],
							h = c.length,
							a = Math.floor(a * Math.pow(10, h)) / Math.pow(10, h) - l
						}
						Math.abs(a) <= l && (a = 0),
						u = a + Math.floor(l * Math.pow(10, h) * (n + 1)) / Math.pow(10, h)
					} else
						a = a > 0 ? 0 : a;
			...
			getVector : function (e, t, n) {
				...
				return u != a ? f = (n - a) / (u - a) : f = .5,
				this._mapVector(o, s, f)
			},
			isInside : function (e) {
			...
			getNearestIndex : function (e) {
				...
				for (var c = 0; c < this.polar.length; c++) {
					...
					u = o.length,
					a = 2 * Math.PI / u,
					i = f.cartesian2polar(e[0] - n[0], n[1] - e[1]),
					e[0] - n[0] < 0 && (i[1] += Math.PI),
					i[1] < 0 && (i[1] += 2 * Math.PI),
					l = i[1] - s / 180 * Math.PI + Math.PI * 2;
					if (Math.abs(Math.cos(l % (a / 2))) * r > i[0])
						return {
							polarIndex : c,
			...
			refresh : function (e) {
				e && (this.option = e, this.polar = this.option.polar, this.series = this.option.series),
				this.clear(),
				this._buildShape()
			}
		},
		a.inherits(l, t),
		e("../component").define("polar", l),
		l
	}),
	r("echarts/chart/radar", ["require", "../component/base", "./base", "zrender/shape/Polygon", "../component/polar", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../util/accMath", "../chart"], function (e) {
		...
		return a.prototype = {
			...
			_buildShape : function () {
				...
				n;
				for (var r = 0, s = e.length; r < s; r++)
					e[r].type == i.CHART_TYPE_RADAR && (this.serie = this.reformOption(e[r]), n = this.serie.name || "", this.selectedMap[n] = t ? t.isSelected(n) : !0, this.selectedMap[n] && (this._queryTarget = [this.serie, this.option], this.deepQuery(this._queryTarget, "calculable") && this._addDropBox(r), this._buildSingleRadar(r), this.buildMark(r)));
				this.addShapeList()
			},
			_buildSingleRadar : function (e) {
				...
				for (var a = 0; a < r.length; a++) {
					...
					if (!this.selectedMap[s])
						continue;
					t ? (i = t.getColor(s), n = t.getItemShape(s), n && (n.style.brushType = this.deepQuery([r[a], this.serie], "itemStyle.normal.areaStyle") ? "both" : "stroke", t.setItemShape(s, n))) : i = this.zr.getColor(a),
					o = this._getPointList(this.serie.polarIndex, r[a]),
					this._addSymbol(o, i, a, e, this.serie.polarIndex),
					this._addDataShape(o, i, r[a], e, a, u),
			...
			_getPointList : function (e, t) {
				var n = [],
				r,
				i = this.component.polar;
				for (var s = 0, o = t.value.length; s < o; s++)
					r = i.getVector(e, s, typeof t.value[s].value != "undefined" ? t.value[s].value : t.value[s]), r && n.push(r);
				return n
			},
			_addSymbol : function (e, t, n, r, i) {
				var o = this.series,
				u,
				a = this.component.polar;
				for (var f = 0, l = e.length; f < l; f++)
					u = this.getSymbolShape(this.deepMerge([o[r].data[n], o[r]]), r, o[r].data[n].value[f], f, a.getIndicatorText(i, f), e[f][0], e[f][1], this._symbol[this._radarDataCounter % this._symbol.length], t, "#fff", "vertical"), u.zlevel = this._zlevelBase + 1, s.set(u, "data", o[r].data[n]), s.set(u, "value", o[r].data[n].value), s.set(u, "dataIndex", n), s.set(u, "special", f), this.shapeList.push(u)
			},
			_addDataShape : function (e, t, n, i, o, a) {
				...
				s.pack(m, f[i], i, n, o, n.name, this.component.polar.getIndicator(f[i].polarIndex)),
				a && (m.draggable = !0, this.setCalculable(m)),
				m = new r(m),
			...
			_addDropBox : function (e) {
				...
				if (!this._dropBoxList[n]) {
					...
					r.zlevel = this._zlevelBase,
					this.setCalculable(r),
					s.pack(r, t, e, undefined, -1),
					this.shapeList.push(r),
			...
			ondragend : function (e, t) {
				...
				o = s.get(r, "dataIndex");
				this.component.legend && this.component.legend.del(n[i].data[o].name),
				n[i].data.splice(o, 1),
				t.dragOut = !0,
				t.needRefresh = !0,
				this.isDragend = !1;
			...
			ondrop : function (t, n) {
				...
				l && l.add(f.name, o.style.color || o.style.strokeColor);
					...
					f = r[u].data[a],
					l && l.del(f.name),
					f.name += this.option.nameConnector + s.get(o, "name"),
					c = s.get(o, "value");
					for (var p = 0; p < c.length; p++)
						f.value[p] = h.accAdd(f.value[p], c[p]);
					l && l.add(f.name, o.style.color || o.style.strokeColor)
				}
				n.dragIn = n.dragIn || !0,
				this.isDrop = !1;
	...
	r("echarts/util/shape/Chord", ["require", "zrender/shape/Base", "zrender/tool/util"], function (e) {
		...
		return i.prototype = {
			...
			buildPath : function (e, t) {
				...
				e.moveTo(l, c),
				e.arc(r, i, t.r, o, u, !1),
				e.bezierCurveTo((r - h) * .7 + h, (i - p) * .7 + p, (r - d) * .7 + d, (i - v) * .7 + v, d, v);
				if (t.source0 === t.target0 && t.source1 === t.target1)
					return;
				e.arc(r, i, t.r, a, f, !1),
				e.bezierCurveTo((r - m) * .7 + m, (i - g) * .7 + g, (r - l) * .7 + l, (i - c) * .7 + c, l, c)
			},
			getRect : function () {
				return {
					x : 0,
			...
			isCover : function (e, t) {
				...
				t = n[1],
				r.beginPath(),
				i.prototype.buildPath.call(null, r, this.style),
				r.closePath(),
				r.isPointInPath(e, t)
			}
		},
	...
	r("echarts/util/ndarray", ["require", "./kwargs"], function (e) {
		...
		function m(e, t) {
			if (e.indexOf(":") >= 0) {
				...
				return r > 0 ? (i = parseInt(n[0] || 0, 10), s = parseInt(n[1] || t, 10)) : (i = parseInt(n[0] || t - 1, 10), s = parseInt(n[1] || -1, 10)),
				i < 0 && (i = t + i),
				s < 0 && n[1] && (s = t + s),
				r > 0 ? (i = Math.max(Math.min(t, i), 0), s = Math.max(Math.min(t, s), 0)) : (i = Math.max(Math.min(t - 1, i), -1), s = Math.max(Math.min(t - 1, s), -1)),
				[i, s, r]
			}
			var i = parseInt(e, 10);
			i < 0 && (i = t + i);
			if (i < 0 || i > t)
				throw new Error(N(e));
			return i = Math.max(Math.min(t - 1, i), 0),
			[i, i + 1, 1]
		}
		function g(e) {
			var t = e[0];
		...
		return v.prototype = {
			initFromArray : function (e) {
				...
				s = b(e),
				o = g(s);
				return this._array = new r[this._dtype](o),
				i(0, this._array, e),
				this._shape = s,
				this._size = o,
				this
			...
			insert : t(function (e, t, n) {
				var i = this._array,
				s = !1;
				typeof e == "number" && (e = [e], s = !0),
				typeof t == "number" ? t = new v([t]) : t instanceof Array && (t = new v(t)),
				typeof n == "undefined" && (this._shape = [this._size], n = 0);
				var o = e[0],
				u = this._shape[n];
			...
			"delete" : t(function (e, t) {
				...
				return this._shape[t] -= e.length,
				this._size = g(this._shape),
				this
			}),
			...
			copy : function () {
				var e = new v;
				return e._array = n.call(this._array),
				e._shape = this._shape.slice(),
				e._dtype = this._dtype,
				e._size = this._size,
				e
			},
			constructor : v
		...
		v.range = t(function (e, t, i, s) {
				...
				o.length === 1 ? (t = o[0], i = 1, e = 0) : o.length == 2 && (i = 1),
				s = s || "number";
	...
	r("echarts/chart/chord", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Sector", "../util/shape/Chord", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"], function (e) {
		...
		return p.prototype = {
			...
			_buildShape : function () {
				...
				this.startAngle < 0 && (this.startAngle = this.startAngle + 360),
				this.clockWise = this.chordSerieSample.clockWise,
				this.innerRadius = this.parsePercent(this.chordSerieSample.radius[0], a / 2),
				this.outerRadius = this.parsePercent(this.chordSerieSample.radius[1], a / 2),
				...
				this.center = [this.parsePercent(this.chordSerieSample.center[0], o), this.parsePercent(this.chordSerieSample.center[1], u)];
				...
				case "descending":
					...
					y.sort(0, this.sortGroups),
					d.sort(0, this.sortGroups);
					break;
				default:
					var w = c.range(p[0])
				}
				...
				this.chordShapes = (new c(m, m, n)).toArray(),
				this.sectorShapes = [],
				this._buildSectors(k, A),
				L = (new c(L)).reshape(m, m, n, 2).toArray(),
				this._buildChords(L, this.dataMat.reshape(p).toArray());
				var l = this.normalizeValue(A);
				this.showScale && this._buildScales(l[0], l[1], k, (new c(l[0])).sum() / (360 - this.padding * m)),
				this.addShapeList()
			},
			_filterData : function (e, t) {
				...
				for (var i = 0; i < t.length; i++) {
					var s = t[i].name;
					this.selectedMap[s] = this.isSelected(s),
					this.selectedMap[s] ? r.push(t[i]) : n.push(i)
				}
				...
				for (var i = 0; i < r.length; i++)
					a[i] === 0 ? n.push(i) : o.push(r[i]);
				return n.length && (e = e["delete"](n, 0), e = e["delete"](n, 1)),
				[e, o]
			},
			_buildSectors : function (e, t) {
				function d(e) {
					return function () {
						...
						o = setTimeout(function () {
								for (var t = 0; t < n; t++) {
									p.sectorShapes[t].style.opacity = t === e ? 1 : .1,
									p.zr.modShape(p.sectorShapes[t].id);
									for (var r = 0; r < n; r++)
										for (var s = 0; s < i; s++) {
				...
				function v() {
					return function () {
						...
						o = setTimeout(function () {
								for (var e = 0; e < n; e++) {
									p.sectorShapes[e].style.opacity = 1,
									p.zr.modShape(p.sectorShapes[e].id);
									for (var t = 0; t < n; t++)
										for (var r = 0; r < i; r++) {
				...
				for (var m = 0; m < n; m++) {
					...
					E.style.lineWidth = this.deepQuery([g, this.chordSerieSample], "itemStyle.normal.lineStyle.width"),
					E.highlightStyle.lineWidth = this.deepQuery([g, this.chordSerieSample], "itemStyle.emphasis.lineStyle.width"),
					E.style.strokeColor = this.deepQuery([g, this.chordSerieSample], "itemStyle.normal.lineStyle.color"),
					E.highlightStyle.strokeColor = this.deepQuery([g, this.chordSerieSample], "itemStyle.emphasis.lineStyle.color"),
					E.style.lineWidth > 0 && (E.style.brushType = "both"),
					E.highlightStyle.lineWidth > 0 && (E.highlightStyle.brushType = "both"),
					a.pack(E, this.chordSeries[0], 0, t[m], m, g.name);
					if (u) {
						var S = [b + w] / 2;
						S %= 360;
						var x = S <= 90 || S >= 270;
						...
						c ? (k.rotation = x ? S : Math.PI + S, x ? k.style.x = this.outerRadius + N : k.style.x = -this.outerRadius - N, k.style.y = 0, k.position = this.center) : (k.style.x = C[0], k.style.y = C[1]),
						k.style.textColor = this.deepQuery([g, this.chordSerieSample], "itemStyle.normal.label.textStyle.color") || "#fff",
						k.style.textFont = this.getFont(this.deepQuery([g, this.chordSerieSample], "itemStyle.normal.label.textStyle")),
						k = new r(k),
				...
				for (var u = 0; u < n; u++)
					for (var f = 0; f < n; f++)
						for (var l = 0; l < r; l++) {
							...
							a.pack(w, this.chordSeries[l], l, t[u][f][l], u + "-" + f, this.groups[u].name, this.groups[f].name, t[f][u][l]),
							w = new o(w),
							this.chordShapes[u][f][l] = w,
			...
			refresh : function (e) {
				...
				this.isSelected = function (e) {
					...
					this.getColor = function (e) {
						...
						return n[e] || (n[e] = this.zr.getColor(t[e])),
						n[e]
					},
			...
			reformOption : function (e) {
				var t = f.merge;
				e = t(e || {}, this.ecTheme.chord),
				e.itemStyle.normal.label.textStyle = t(e.itemStyle.normal.label.textStyle || {}, this.ecTheme.textStyle)
			}
		},
		f.inherits(p, n),
		f.inherits(p, t),
		e("../chart").define("chord", p),
		p
	}),
	r("echarts/chart/forceLayoutWorker", ["require", "zrender/tool/vector"], function u(e) {
		function i() {
			this.subRegions = [],
			this.nSubRegions = 0,
			this.node = null,
		...
		function s() {
			...
			this.force = t.create(),
			this.forcePrev = t.create(),
			this.speed = t.create(),
			this.speedPrev = t.create(),
			this.mass = 1,
			this.inDegree = 0,
			this.outDegree = 0
		}
		...
		function a() {
			...
			this._rootRegion.centerOfMass = t.create(),
			this._massArr = null,
			this._k = 0
		}
		var t,
		n = typeof window == "undefined" && typeof e == "undefined";
		n ? t = {
			create : function (e, t) {
			...
			normalize : function (e, t) {
				...
				r = t[1],
				i = n * n + r * r;
				return i > 0 && (i = 1 / Math.sqrt(i), e[0] = t[0] * i, e[1] = t[1] * i),
				e
			},
			negate : function (e, t) {
				return e[0] = -t[0],
		...
		i.prototype._newSubRegion = function () {
			...
			return e || (e = new i, this.subRegions[this.nSubRegions] = e),
			this.nSubRegions++,
			e
		},
		...
		i.prototype._updateCenterOfMass = function (e) {
			...
			n += e.position[0] * e.mass,
			r += e.position[1] * e.mass,
			this.mass += e.mass,
			this.centerOfMass[0] = n / this.mass,
		...
		a.prototype.update = function () {
			...
			if (this.barnesHutOptimize) {
				...
				for (var n = 0; n < e; n++) {
					var s = this.nodes[n];
					r += s.mass,
					t.scaleAndAdd(i, i, s.position, s.mass)
				}
				t.scale(i, i, 1 / r)
			}
			for (var n = 0; n < e; n++) {
				var s = this.nodes[n];
				t.copy(s.forcePrev, s.force),
				t.copy(s.speedPrev, s.speed),
				t.set(s.force, 0, 0)
			}
			for (var n = 0; n < e; n++) {
				var o = this.nodes[n];
				if (this.barnesHutOptimize)
					this.applyRegionToNodeRepulsion(this._rootRegion, o);
				else
					for (var u = n + 1; u < e; u++) {
						var a = this.nodes[u];
			...
			for (var n = 0; n < this.edges.length; n++)
				this.applyEdgeAttraction(this.edges[n]);
			var f = t.create();
			for (var n = 0; n < e; n++) {
				var s = this.nodes[n],
				l = s.speed;
				t.scale(s.force, s.force, 1 / 30);
				var c = t.len(s.force) + .1,
				h = Math.min(c, 500) / c;
				t.scale(s.force, s.force, h),
				t.add(l, l, s.force),
				t.scale(l, l, this.temperature),
				t.sub(f, l, s.speedPrev);
				var p = t.len(f);
				if (p > 0) {
					t.scale(f, f, 1 / p);
		...
		a.prototype.applyRegionToNodeRepulsion = function () {
			...
			return function (r, i) {
				if (r.node)
					this.applyNodeToNodeRepulsion(r.node, i, !0);
				else {
					...
					if (s > this.barnesHutTheta * r.size * r.size) {
						...
						for (var u = 0; u < r.nSubRegions; u++)
							this.applyRegionToNodeRepulsion(r.subRegions[u], i)
				}
			}
		}
		(),
		a.prototype.applyNodeToNodeRepulsion = function () {
			...
			return function (r, i, s) {
				...
				if (this.preventOverlap) {
					var l = Math.sqrt(o);
					l = l - r.size - i.size,
					l > 0 ? u = a * f / (l * l) : l <= 0 && (u = a * 10 * f)
				} else
					u = a * f / o;
				s || t.scaleAndAdd(r.force, r.force, e, u * 2),
				t.scaleAndAdd(i.force, i.force, e, -u * 2)
			}
		}
		(),
		a.prototype.applyEdgeAttraction = function () {
			...
			return function (r) {
				...
				var a = -u * o / this._k;
				t.scaleAndAdd(i.force, i.force, e, a),
				t.scaleAndAdd(s.force, s.force, e, -a)
			}
		}
		(),
		a.prototype.applyNodeGravity = function () {
			...
			return function (n) {
				...
				this.width > this.height ? e[1] *= this.width / this.height : e[0] *= this.height / this.width;
				var r = t.len(e) / 100;
		...
		if (n) {
			...
			self.onmessage = function (e) {
				if (e.data instanceof ArrayBuffer) {
					...
					for (var r = 0; r < n; r++) {
						var i = f.nodes[r];
						i.position[0] = t[r * 2 + 1],
						i.position[1] = t[r * 2 + 2]
					}
					return
				}
				switch (e.data.cmd) {
				case "init":
					f || (f = new a),
					f.initNodes(e.data.nodesPosition, e.data.nodesMass, e.data.nodesSize),
					f.initEdges(e.data.edges, e.data.edgesWeight),
					f._token = e.data.token;
					break;
				case "updateConfig":
					if (f)
						for (var s in e.data.config)
							f[s] = e.data.config[s];
					break;
				case "update":
					var o = e.data.steps;
					if (f) {
						...
						if (e.data.temperature > .01) {
							for (var r = 0; r < o; r++)
								f.update(), f.temperature *= e.data.coolDown;
							for (var r = 0; r < n; r++) {
								var i = f.nodes[r];
								t[r * 2 + 1] = i.position[0],
								t[r * 2 + 2] = i.position[1]
							}
							t[0] = f._token
						}
	...
	r("echarts/chart/force", ["require", "../component/base", "./base", "./forceLayoutWorker", "zrender/shape/Line", "../util/shape/Icon", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/vector", "../util/ndarray", "../chart"], function (e) {
		function g() {
		...
		function b(e) {
			...
			t.fixed = !0,
			this.isDragstart = !1,
			this.zr.on(f.EVENT.MOUSEMOVE, this.onmousemove)
		}
		function w() {
			this._temperature = .8
		}
		function E(e, t) {
			...
			t.needRefresh = !1,
			this.isDragend = !1,
			this.zr.un(f.EVENT.MOUSEMOVE, this.onmousemove)
		}
		function S(e, t, n) {
		...
		return y.prototype = {
			...
			_init : function () {
				...
				if (this._layoutWorker)
					this._layoutWorker.onmessage = function (t) {
			...
			_buildShape : function () {
				...
				for (var i = 0, s = t.length; i < s; i++) {
					...
					if (u.type === o.CHART_TYPE_FORCE) {
						t[i] = this.reformOption(t[i]),
						n = t[i].name || "";
						if (d && u.useWorker)
							try {
								this._layoutWorker || (this._layoutWorker = new Worker(d)),
								this._layout = null
							} catch (a) {
								this._layoutWorker = null,
								this._layout || (this._layout = new r)
							}
						else
							this._layout || (this._layout = new r), this._layoutWorker && (this._layoutWorker.terminate(), this._layoutWorker = null);
						...
						for (var l = 0, c = f.length; l < c; l++)
							f[l].name && (e ? this.selectedMap[l] = e.isSelected(f[l].name) : this.selectedMap[l] = !0);
						this._preProcessData(u),
						this._nodeShapes.length = 0,
						this._linkShapes.length = 0,
						this._buildLinkShapes(u),
						this._buildNodeShapes(u),
						this._initLayout(u),
			...
			_preProcessData : function (e) {
				this._rawNodes = this.query(e, "nodes"),
				this._rawLinks = a.clone(this.query(e, "links"));
				var t = [],
				n = {},
				r = 0,
				i = this;
				this._filteredNodes = x(this._rawNodes, function (e, s) {
						...
						if (e.ignore)
							return;
						var o = -1;
						if (typeof e.category == "undefined" || i.selectedMap[e.category])
							o = r++;
						return e.name && (n[e.name] = o),
						t[s] = o,
						o >= 0
					});
				var s,
			...
			_initLayout : function (e) {
				...
				for (var m = 0; m < i; m++) {
					...
					var N = r[m].style;
					N.width = N.width || v[m] * 2,
					N.height = N.height || v[m] * 2,
					N.x = -N.width / 2,
					N.y = -N.height / 2,
					r[m].position = T,
					x[m * 2] = T[0],
			...
			_buildNodeShapes : function (e) {
				...
				for (var o = 0; o < r; o++) {
					...
					p = [];
					c.push(f),
					f.itemStyle && (h.push(f.itemStyle.normal), p.push(f.itemStyle.emphasis));
					...
					c.push(e),
					h.unshift(e.itemStyle.normal.nodeStyle),
					p.unshift(e.itemStyle.emphasis.nodeStyle),
					l.style.iconType = this.deepQuery(c, "symbol"),
					l.style.width = l.style.height = (this.deepQuery(c, "symbolSize") || 0) * 2;
					for (var v = 0; v < h.length; v++)
						h[v] && a.merge(l.style, h[v], !0);
					for (var v = 0; v < p.length; v++)
						p[v] && a.merge(l.highlightStyle, p[v], !0);
					if (this.deepQuery(c, "itemStyle.normal.label.show")) {
						l.style.text = f.name,
						l.style.textPosition = "inside";
						var m = this.deepQuery(c, "itemStyle.normal.label.textStyle") || {};
						l.style.textColor = m.color || "#fff",
						l.style.textAlign = m.align || "center",
						l.style.textBaseline = m.baseline || "middle",
						l.style.textFont = this.getFont(m)
					}
					if (this.deepQuery(c, "itemStyle.emphasis.label.show")) {
						l.highlightStyle.text = f.name,
						l.highlightStyle.textPosition = "inside";
						var m = this.deepQuery(c, "itemStyle.emphasis.label.textStyle") || {};
						l.highlightStyle.textColor = m.color || "#fff",
						l.highlightStyle.textAlign = m.align || "center",
						l.highlightStyle.textBaseline = m.baseline || "middle",
						l.highlightStyle.textFont = this.getFont(m)
					}
					...
					u.pack(l, {
						name : g
					}, 0, f, a.indexOf(this._rawNodes, f), f.name || "", f.value),
					this._nodeShapes.push(l),
			...
			_buildLinkShapes : function (e) {
				...
				for (var o = 0; o < r; o++) {
					...
					a.merge(h.style, this.query(e, "itemStyle.normal.linkStyle"), !0),
					a.merge(h.highlightStyle, this.query(e, "itemStyle.emphasis.linkStyle"), !0),
					typeof f.itemStyle != "undefined" && (f.itemStyle.normal && a.merge(h.style, f.itemStyle.normal, !0), f.itemStyle.emphasis && a.merge(h.highlightStyle, f.itemStyle.emphasis, !0));
					var f = this._rawLinks[f.rawIndex];
					u.pack(h, e, 0, {
						source : f.source,
						target : f.target,
						weight : f.weight || 0
					}, f.rawIndex, l.name + " - " + c.name, f.weight || 0, !0),
					this._linkShapes.push(h),
					this.shapeList.push(h),
					this.zr.addShape(h);
			...
			_updateLinkShapes : function () {
				...
				for (var n = 0, r = t.length; n < r; n++) {
					...
					s.style.xStart = o.position[0],
					s.style.yStart = o.position[1],
					s.style.xEnd = u.position[0],
					s.style.yEnd = u.position[1],
					this.zr.modShape(s.id);
					if (s._symbolShape) {
						var a = s._symbolShape;
						l.copy(a.position, u.position),
						l.sub(e, o.position, u.position),
						l.normalize(e, e),
						l.scaleAndAdd(a.position, a.position, e, u.style.width / 2 + 2);
						var f;
						e[1] < 0 ? f = 2 * Math.PI - Math.acos(-e[0]) : f = Math.acos(-e[0]),
						a.rotation = f - Math.PI / 2,
			...
			_update : function (e) {
				...
				for (var t = 0; t < this._layout.nodes.length; t++) {
					...
					if (s) {
						...
						o || (o = this.__nodePositionMap[s] = l.create()),
						l.copy(o, n)
					}
				}
				...
				if (r) {
					...
					for (var s = 0; s < i; s++) {
						...
						if (c) {
							...
							h || (h = this.__nodePositionMap[c] = l.create()),
							l.copy(h, o.position)
						}
					}
			...
			_step : function (e) {
				if (this._layoutWorker) {
					...
					if (this._temperature < .01)
						return;
					this._update()
				}
				this._updateLinkShapes();
				for (var n = 0; n < this._nodeShapes.length; n++)
					this.zr.modShape(this._nodeShapes[n].id);
				this.zr.refresh()
			},
			refresh : function (e) {
		...
		return i.prototype = {
			...
			buildPath : function (t, r) {
				...
				if (r.smooth) {
					...
					f = i.length;
					for (var l = 0; l < f - 3; l++)
						o = s[l * 2], u = s[l * 2 + 1], a = i[l + 1], t.bezierCurveTo(o[0], o[1], u[0], u[1], a[0], a[1]);
					t.lineTo(i[f - 2][0], i[f - 2][1]),
					t.lineTo(i[f - 1][0], i[f - 1][1]),
					t.lineTo(i[0][0], i[0][1])
				} else
					e("zrender/shape/Polygon").prototype.buildPath(t, r);
				return
			}
		},
		r.inherits(i, t),
	...
	r("echarts/chart/line", ["require", "../component/base", "./base", "zrender/shape/BrokenLine", "../util/shape/Icon", "../util/shape/HalfSmoothPolygon", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
		...
		function c(e, t) {
			...
			if (a.match("star"))
				u = a.replace("star", "") - 0 || 5, r -= 1, a = "star";
			else if (a == "rectangle" || a == "arrow")
				n += (s - o) / 2, s = o;
			var f = "";
			a.match("image") && (f = a.replace(new RegExp("^image:\\/\\/"), ""), a = "image", n += Math.round((s - o) / 2) - 1, s = o += 2),
			a = i.prototype.iconLibrary[a];
			if (a) {
				var l = t.x,
				c = t.y;
				e.moveTo(l, c + u),
				e.lineTo(l + 5, c + u),
				e.moveTo(l + t.width - 5, c + u),
				e.lineTo(l + t.width, c + u),
				a(e, {
					x : n + 4,
					y : r + 4,
					width : s - 8,
				...
				e.moveTo(n, r + u), e.lineTo(n + s, r + u)
		}
		var t = e("../component/base"),
		n = e("./base"),
		...
		return l.prototype = {
			...
			_buildShape : function () {
				...
				s;
				for (var u = 0, a = e.length; u < a; u++)
					e[u].type == this.type && (e[u] = this.reformOption(e[u]), n = e[u].xAxisIndex, r = e[u].yAxisIndex, i = this.component.xAxis.getAxis(n), s = this.component.yAxis.getAxis(r), i.type == o.COMPONENT_TYPE_AXIS_CATEGORY ? t[i.getPosition()].push(u) : s.type == o.COMPONENT_TYPE_AXIS_CATEGORY && t[s.getPosition()].push(u));
				for (var f in t)
					t[f].length > 0 && this._buildSinglePosition(f, t[f]);
				this.addShapeList()
			},
			_buildSinglePosition : function (e, t) {
				var n = this._mapData(t),
			...
			_buildHorizontal : function (e, t, n, r) {
				...
				for (var w = 0, E = t; w < E; w++) {
					if (typeof a.getNameByIndex(w) == "undefined")
						break;
					c = a.getCoordByIndex(w);
					for (var S = 0, x = n.length; S < x; S++) {
						f = i[n[S][0]].yAxisIndex || 0,
						l = this.component.yAxis.getAxis(f),
						d = p = m = v = l.getCoord(0);
						for (var T = 0, N = n[S].length; T < N; T++) {
							s = n[S][T],
							o = i[s],
							y = o.data[w],
							b = typeof y != "undefined" ? typeof y.value != "undefined" ? y.value : y : "-",
							g[s] = g[s] || [],
							r[s] = r[s] || {
							...
							b >= 0 ? (p -= T > 0 ? l.getCoordSize(b) : d - l.getCoord(b), h = p) : b < 0 && (v += T > 0 ? l.getCoordSize(b) : l.getCoord(b) - m, h = v),
							g[s].push([c, h, w, a.getNameByIndex(w), c, d]),
							r[s].min > b && (r[s].min = b, r[s].minY = h, r[s].minX = c),
							r[s].max < b && (r[s].max = b, r[s].maxY = h, r[s].maxX = c),
							r[s].sum += b,
							r[s].counter++
						}
					}
				...
				for (var k in g)
					g[k].length > 0 && (this.finalPLMap[k] = this.finalPLMap[k] || [], this.finalPLMap[k].push(g[k]), g[k] = []);
				for (var S = 0, x = n.length; S < x; S++)
					for (var T = 0, N = n[S].length; T < N; T++)
			...
			_buildVertical : function (e, t, n, r) {
				...
				for (var w = 0, E = t; w < E; w++) {
					...
					for (var S = 0, x = n.length; S < x; S++) {
						f = i[n[S][0]].xAxisIndex || 0,
						l = this.component.xAxis.getAxis(f),
						d = p = m = v = l.getCoord(0);
						for (var T = 0, N = n[S].length; T < N; T++) {
							s = n[S][T],
							o = i[s],
							...
							b >= 0 ? (p += T > 0 ? l.getCoordSize(b) : l.getCoord(b) - d, c = p) : b < 0 && (v -= T > 0 ? l.getCoordSize(b) : m - l.getCoord(b), c = v),
							g[s].push([c, h, w, a.getNameByIndex(w), d, h]),
							r[s].min > b && (r[s].min = b, r[s].minX = c, r[s].minY = h),
							r[s].max < b && (r[s].max = b, r[s].maxX = c, r[s].maxY = h),
							r[s].sum += b,
							r[s].counter++
						}
					}
			...
			_buildBorkenLine : function (e, t, n, i) {
				...
				for (var N = e.length - 1; N >= 0; N--) {
					...
					if (g.type == this.type && typeof b != "undefined") {
						l = this._sIndex2ColorMap[T],
						c = this.query(g, "itemStyle.normal.lineStyle.width"),
						h = this.query(g, "itemStyle.normal.lineStyle.type"),
						p = this.query(g, "itemStyle.normal.lineStyle.color"),
						d = this.getItemStyleColor(this.query(g, "itemStyle.normal.color"), T, -1),
						v = typeof this.query(g, "itemStyle.normal.areaStyle") != "undefined",
						m = this.query(g, "itemStyle.normal.areaStyle.color");
						for (var C = 0, k = b.length; C < k; C++) {
							w = b[C],
							x = this._isLarge(i, w);
							if (!x)
								for (var L = 0, A = w.length; L < A; L++)
									y = g.data[w[L][2]], (this.deepQuery([y, g], "showAllSymbol") || n.isMainAxis(w[L][2]) && this.deepQuery([y, g], "symbol") != "none" || this.deepQuery([y, g, this.option], "calculable")) && this.shapeList.push(this._getSymbol(T, w[L][2], w[L][3], w[L][0], w[L][1], i));
							else
								w = this._getLargePointList(i, w);
							E = new r({
									zlevel : this._zlevelBase,
									style : {
										miterLimit : c,
							...
							u.pack(E, o[T], T, 0, C, o[T].name),
							this.shapeList.push(E),
							v && (S = new s({
										zlevel : this._zlevelBase,
										style : {
											miterLimit : c,
											pointList : a.clone(w).concat([[w[w.length - 1][4], w[w.length - 1][5]], [w[0][4], w[0][5]]]),
											brushType : "fill",
											smooth : this._getSmooth(g.smooth),
			...
			_getCalculableItem : function (e, t, n, r, i, s) {
				...
				return a.style.color = u,
				a.style.strokeColor = u,
				a.rotation = [0, 0],
				a.hoverable = !1,
				a.draggable = !1,
				a.style.text = undefined,
				a
			},
			_getSymbol : function (e, t, n, r, i, s) {
				...
				return f.zlevel = this._zlevelBase + 1,
				this.deepQuery([a, u, this.option], "calculable") && (this.setCalculable(f), f.draggable = !0),
				f
			},
			getMarkCoord : function (e, t) {
				var n = this.series[e],
					...
					if (i)
						for (var u = 0, a = i.length; u < a; u++) {
							...
							for (var f = 0, l = s.length; f < l; f++)
								r == s[f][2] && t.push(this._getSymbol(n[o], s[f][2], s[f][3], s[f][0], s[f][1], "horizontal"))
						}
				}
			},
			addDataAnimation : function (e) {
				...
				for (var r = this.shapeList.length - 1; r >= 0; r--) {
					...
					if (n[f] && !n[f][3]) {
						if (this.shapeList[r]._main && this.shapeList[r].style.pointList.length > 1) {
							l = this.shapeList[r].style.pointList,
							o = Math.abs(l[0][0] - l[1][0]),
							a = Math.abs(l[0][1] - l[1][1]),
							c = this.shapeList[r]._orient == "horizontal";
							if (n[f][2]) {
								if (this.shapeList[r].type == "polygon") {
									var h = l.length;
									this.shapeList[r].style.pointList[h - 3] = l[h - 2],
									c ? this.shapeList[r].style.pointList[h - 3][0] = l[h - 4][0] : this.shapeList[r].style.pointList[h - 3][1] = l[h - 4][1],
									this.shapeList[r].style.pointList[h - 2] = l[h - 1]
								}
								...
								if (this.shapeList[r].type == "polygon") {
									...
									c ? p[0] = l[0][0] : p[1] = l[0][1],
									this.shapeList[r].style.pointList.push(p)
								}
								c ? (s = -o, u = 0) : (s = 0, u = a)
							}
		...
		i.prototype.iconLibrary.legendLineIcon = c,
		a.inherits(l, n),
		a.inherits(l, t),
		e("../chart").define("line", l),
		l
	}),
	r("echarts/chart/bar", ["require", "../component/base", "./base", "zrender/shape/Rectangle", "../component/axis", "../component/grid", "../component/dataZoom", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart"], function (e) {
		...
		return a.prototype = {
			...
			_buildShape : function () {
				...
				o;
				for (var u = 0, a = e.length; u < a; u++)
					e[u].type == i.CHART_TYPE_BAR && (e[u] = this.reformOption(e[u]), n = e[u].xAxisIndex, r = e[u].yAxisIndex, s = this.component.xAxis.getAxis(n), o = this.component.yAxis.getAxis(r), s.type == i.COMPONENT_TYPE_AXIS_CATEGORY ? t[s.getPosition()].push(u) : o.type == i.COMPONENT_TYPE_AXIS_CATEGORY && t[o.getPosition()].push(u));
				for (var f in t)
					t[f].length > 0 && this._buildSinglePosition(f, t[f], this.xMarkMap);
				this.addShapeList()
			},
			...
			_buildHorizontal : function (e, t, n, i) {
				...
				for (var A = 0, O = e; A < O; A++) {
					if (typeof f.getNameByIndex(A) == "undefined")
						break;
					w = f.getCoordByIndex(A) - p / 2;
					for (var M = 0, _ = t.length; M < _; M++) {
						l = s[t[M][0]].yAxisIndex || 0,
						c = this.component.yAxis.getAxis(l),
						x = S = N = T = c.getCoord(0);
						for (var D = 0, P = t[M].length; D < P; D++) {
							o = t[M][D],
							u = s[o],
							k = u.data[A],
							L = typeof k != "undefined" ? typeof k.value != "undefined" ? k.value : k : "-",
							i[o] = i[o] || {
								min : Number.POSITIVE_INFINITY,
								max : Number.NEGATIVE_INFINITY,
								sum : 0,
							...
							if (L == "-")
								continue;
							L > 0 ? (y = D > 0 ? c.getCoordSize(L) : x - c.getCoord(L), P == 1 && g[o] > y && (y = g[o]), S -= y, E = S) : L < 0 ? (y = D > 0 ? c.getCoordSize(L) : c.getCoord(L) - N, P == 1 && g[o] > y && (y = g[o]), E = T, T += y) : (y = 0, S -= y, E = S),
							i[o][A] = w + (v[o] || m) / 2,
							i[o].min > L && (i[o].min = L, i[o].minY = E, i[o].minX = i[o][A]),
							i[o].max < L && (i[o].max = L, i[o].maxY = E, i[o].maxX = i[o][A]),
							i[o].sum += L,
							i[o].counter++,
							A % b === 0 && (C = this._getBarItem(o, A, f.getNameByIndex(A), w, E, v[o] || m, y, "vertical"), this.shapeList.push(new r(C)))
						}
						for (var D = 0, P = t[M].length; D < P; D++) {
							o = t[M][D],
							u = s[o],
			...
			_buildVertical : function (e, t, n, i) {
				...
				for (var A = 0, O = e; A < O; A++) {
					...
					for (var M = 0, _ = t.length; M < _; M++) {
						l = s[t[M][0]].xAxisIndex || 0,
						c = this.component.xAxis.getAxis(l),
						x = S = N = T = c.getCoord(0);
						for (var D = 0, P = t[M].length; D < P; D++) {
							o = t[M][D],
							u = s[o],
							...
							if (L == "-")
								continue;
							L > 0 ? (y = D > 0 ? c.getCoordSize(L) : c.getCoord(L) - x, P == 1 && g[o] > y && (y = g[o]), w = S, S += y) : L < 0 ? (y = D > 0 ? c.getCoordSize(L) : N - c.getCoord(L), P == 1 && g[o] > y && (y = g[o]), T -= y, w = T) : (y = 0, w = S, S += y),
							i[o][A] = E - (v[o] || m) / 2,
							i[o].min > L && (i[o].min = L, i[o].minX = w + y, i[o].minY = i[o][A]),
							i[o].max < L && (i[o].max = L, i[o].maxX = w + y, i[o].maxY = i[o][A]),
							i[o].sum += L,
							i[o].counter++,
							A % b === 0 && (C = this._getBarItem(o, A, f.getNameByIndex(A), w, E - (v[o] || m), y, v[o] || m, "horizontal"), this.shapeList.push(new r(C)))
						}
						for (var D = 0, P = t[M].length; D < P; D++) {
							o = t[M][D],
							u = s[o],
			...
			_mapSize : function (e, t, n) {
					...
					for (var g = 0, y = t[v].length; g < y; g++) {
						...
						if (!n)
							if (!h) {
								...
								s[i] = u;
						o[i] = this.query(p, "barMinHeight"),
						l = typeof l != "undefined" ? l : this.query(p, "barGap"),
						c = typeof c != "undefined" ? c : this.query(p, "barCategoryGap")
					}
				}
				var S,
				x;
				if (t.length != a)
					if (!n) {
						S = typeof c == "string" && c.match(/%$/) ? Math.floor(e.getGap() * (100 - parseFloat(c)) / 100) : e.getGap() - c,
						typeof l == "string" && l.match(/%$/) ? (l = parseFloat(l) / 100, x = Math.floor((S - f) / ((t.length - 1) * l + t.length - a)), l = Math.floor(x * l)) : (l = parseFloat(l), x = Math.floor((S - f - l * (t.length - 1)) / (t.length - a)));
						if (x <= 0)
							return this._mapSize(e, t, !0)
					} else
						S = e.getGap(), l = 0, x = Math.floor(S / t.length), x <= 0 && (d = Math.floor(t.length / S), x = 1);
				else {
					S = a > 1 ? typeof c == "string" && c.match(/%$/) ? Math.floor(e.getGap() * (100 - parseFloat(c)) / 100) : e.getGap() - c : f,
					x = 0,
					l = a > 1 ? Math.floor((S - f) / (a - 1)) : 0;
					if (l < 0)
						return this._mapSize(e, t, !0)
				}
				return {
			...
			_getBarItem : function (e, t, n, r, i, o, a, f) {
				...
				c.highlightStyle.color = c.highlightStyle.color || (typeof c.style.color == "string" ? u.lift(c.style.color, -0.3) : c.style.color),
				b > 0 && c.style.height > b && c.style.width > b ? (c.style.y += b / 2, c.style.height -= b, c.style.x += b / 2, c.style.width -= b) : c.style.brushType = "fill",
				c.highlightStyle.textColor = c.highlightStyle.color,
				c = this.addLabel(c, h, p, n, f);
				if (c.style.textPosition == "insideLeft" || c.style.textPosition == "insideRight" || c.style.textPosition == "insideTop" || c.style.textPosition == "insideBottom") {
					...
					case "insideLeft":
						c.style.textX = c.style.x + E,
						c.style.textY = c.style.y + c.style.height / 2,
						c.style.textAlign = "left",
						c.style.textBaseline = "middle";
						break;
					case "insideRight":
						c.style.textX = c.style.x + c.style.width - E,
						c.style.textY = c.style.y + c.style.height / 2,
						c.style.textAlign = "right",
						c.style.textBaseline = "middle";
						break;
					case "insideTop":
						c.style.textX = c.style.x + c.style.width / 2,
						c.style.textY = c.style.y + E / 2,
						c.style.textAlign = "center",
						c.style.textBaseline = "top";
						break;
					case "insideBottom":
						c.style.textX = c.style.x + c.style.width / 2,
						c.style.textY = c.style.y + c.style.height - E / 2,
						c.style.textAlign = "center",
						c.style.textBaseline = "bottom"
					}
					c.style.textPosition = "specific",
					c.style.textColor = c.style.textColor || "#fff"
				}
				return this.deepQuery([p, h, this.option], "calculable") && (this.setCalculable(c), c.draggable = !0),
				s.pack(c, l[e], e, l[e].data[t], t, n),
				c
			},
			getMarkCoord : function (e, t) {
				var n = this.series[e],
				...
				if (!t.type || t.type != "max" && t.type != "min" && t.type != "average")
					if (r.isHorizontal) {
						...
						var a = r[o];
						a = typeof a != "undefined" ? a : typeof t.xAxis != "string" && i.getCoordByIndex ? i.getCoordByIndex(t.xAxis || 0) : i.getCoord(t.xAxis || 0),
						u = [a, s.getCoord(t.yAxis || 0)]
					} else {
						o = typeof t.yAxis == "string" && s.getIndexByName ? s.getIndexByName(t.yAxis) : t.yAxis || 0;
						var f = r[o];
						f = typeof f != "undefined" ? f : typeof t.yAxis != "string" && s.getCoordByIndex ? s.getCoordByIndex(t.yAxis || 0) : s.getCoord(t.yAxis || 0),
						u = [i.getCoord(t.xAxis || 0), f]
					}
				else
					u = [r[t.type + "X"], r[t.type + "Y"], r[t.type + "Line"], r[t.type]];
				return u
			},
			refresh : function (e) {
				e && (this.option = e, this.series = e.series),
			...
			addDataAnimation : function (e) {
				...
				for (var r = this.shapeList.length - 1; r >= 0; r--) {
					...
					if (n[c] && !n[c][3] && this.shapeList[r].type == "rectangle") {
						h = s.get(this.shapeList[r], "dataIndex"),
						l = t[c];
						...
						this.shapeList[r]._orient == "horizontal" ? (f = this.component.yAxis.getAxis(l.yAxisIndex || 0).getGap(), a = n[c][2] ? -f : f, o = 0) : (u = this.component.xAxis.getAxis(l.xAxisIndex || 0).getGap(), o = n[c][2] ? u : -u, a = 0),
						this.shapeList[r].position = [0, 0],
						this.zr.animate(this.shapeList[r].id, "").when(500, {
							position : [o, a]
						}).start()
	...
	r("echarts/chart/pie", ["require", "../component/base", "./base", "zrender/shape/Text", "zrender/shape/Ring", "zrender/shape/Circle", "zrender/shape/Sector", "zrender/shape/BrokenLine", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/math", "zrender/tool/color", "../chart"], function (e) {
		...
		return p.prototype = {
			...
			_buildShape : function () {
				...
				for (var l = 0, c = e.length; l < c; l++)
					if (e[l].type == a.CHART_TYPE_PIE) {
						e[l] = this.reformOption(e[l]),
						u = e[l].name || "",
						this.selectedMap[u] = t ? t.isSelected(u) : !0;
						if (!this.selectedMap[u])
							continue;
						n = this.parseCenter(this.zr, e[l].center),
						r = this.parseRadius(this.zr, e[l].radius),
						this._selectedMode = this._selectedMode || e[l].selectedMode,
						this._selected[l] = [],
						this.deepQuery([e[l], this.option], "calculable") && (o = {
								zlevel : this._zlevelBase,
								hoverable : !1,
								style : {
									x : n[0],
							...
							}, f.pack(o, e[l], l, undefined, -1), this.setCalculable(o), o = r[0] <= 10 ? new s(o) : new i(o), this.shapeList.push(o)),
			...
			_buildSinglePie : function (e) {
				...
				for (var l = 0, c = r.length; l < c; l++)
					s = r[l].name, i ? this.selectedMap[s] = i.isSelected(s) : this.selectedMap[s] = !0, this.selectedMap[s] && !isNaN(r[l].value) && (+r[l].value !== 0 ? o++ : u++, a += +r[l].value, f = Math.max(f, +r[l].value));
				var h = 100,
				p,
				d = 0,
				v = n.clockWise,
				...
				for (var l = 0, c = r.length; l < c; l++) {
					s = r[l].name;
					if (!this.selectedMap[s] || isNaN(r[l].value))
						continue;
					i ? w = i.getColor(s) : w = this.zr.getColor(l),
					p = h,
					h = r[l].value / a,
					E != "area" ? g = v ? m - h * b - (h !== 0 ? y : .01) : h * b + m + (h !== 0 ? y : .01) : g = v ? m - 360 / c : 360 / c + m,
					g = g.toFixed(2) - 0,
					h = (h * 100).toFixed(2),
					S = this.parseRadius(this.zr, n.radius),
					x = +S[0],
					T = +S[1],
					E == "radius" ? T = r[l].value / f * (T - x) * .8 + (T - x) * .2 + x : E == "area" && (T = Math.sqrt(r[l].value / f) * (T - x) + x);
					if (v) {
						var N;
						N = m,
						m = g,
					...
					l > 0 && Math.abs(m - g) < 15 && p < 4 && this._needLabel(n, r[l], !1) && this.deepQuery([r[l], n], "itemStyle.normal.label.position") != "center" ? d += h < 4 ? 20 : -20 : d = 0,
					this._buildItem(e, l, h, d, r[l].selected, x, T, m, g, w),
					v || (m = g)
				}
			},
			_buildItem : function (e, t, n, r, i, s, o, u, a, l) {
				...
				f.pack(h, c[e], e, c[e].data[t], t, c[e].data[t].name, n),
				h._lastAddRadius = r,
				this.shapeList.push(h);
			...
			getSector : function (e, t, n, r, i, s, u, a, f) {
				...
				if (r) {
					...
					E.style._hasSelected = !0,
					E.style._x = E.style.x,
					E.style._y = E.style.y;
					var x = this.query(p, "selectedOffset");
					E.style.x += c.cos(S, !0) * x,
					E.style.y -= c.sin(S, !0) * x,
					this._selected[e][t] = !0
				} else
					this._selected[e][t] = !1;
				this._selectedMode && (E.onclick = this.shapeHandler.onclick),
				this.deepQuery([d, p, this.option], "calculable") && (this.setCalculable(E), E.draggable = !0);
				if (this._needLabel(p, d, !0) || this._needLabelLine(p, d, !0))
					E.onmouseover = this.shapeHandler.onmouseover;
				return E = new o(E),
				E
			},
			getLabel : function (e, t, n, i, s, o, u, a) {
				...
				N,
				C = "middle";
				return m.position = m.position || v.normal.label.position,
				m.position == "center" ? (T = T[1], E = b, S = w, N = "center") : m.position == "inner" ? (T = (T[0] + T[1]) / 2 + i, E = Math.round(b + T * c.cos(x, !0)), S = Math.round(w - T * c.sin(x, !0)), u = "#fff", N = "center") : (T = T[1] - -v[d].labelLine.length + i, E = b + T * c.cos(x, !0), S = w - T * c.sin(x, !0), N = x >= 90 && x <= 270 ? "right" : "left"),
				m.position != "center" && m.position != "inner" && (E += N == "left" ? 20 : -20),
				p.__labelX = E - (N == "left" ? 5 : -5),
				p.__labelY = S,
				new r({
					zlevel : this._zlevelBase + 1,
					hoverable : !1,
			...
			getLabelText : function (e, t, n, r) {
				...
				if (typeof u == "function")
					return u.call(this.myChart, s.name, o.name, o.value, n);
				if (typeof u == "string")
					return u = u.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}").replace("{d}", "{d0}"), u = u.replace("{a0}", s.name).replace("{b0}", o.name).replace("{c0}", o.value).replace("{d0}", n), u
			},
			...
			reformOption : function (e) {
				var t = l.merge;
				return e = t(e || {}, this.ecTheme.pie),
				e.itemStyle.normal.label.textStyle = t(e.itemStyle.normal.label.textStyle || {}, this.ecTheme.textStyle),
				e.itemStyle.emphasis.label.textStyle = t(e.itemStyle.emphasis.label.textStyle || {}, this.ecTheme.textStyle),
				e
			},
			refresh : function (e) {
				e && (this.option = e, this.series = e.series),
			...
			addDataAnimation : function (e) {
				...
				p = {};
				for (var r = 0, i = e.length; r < i; r++)
					l = e[r][0], c = e[r][2], h = e[r][3], t[l] && t[l].type == a.CHART_TYPE_PIE && (c ? (h || (s[l + "_" + t[l].data.length] = "delete"), p[l] = 1) : h ? p[l] = 0 : (s[l + "_-1"] = "delete", p[l] = -1), this._buildSinglePie(l));
				var d,
				v;
				for (var r = 0, i = this.shapeList.length; r < i; r++) {
					l = this.shapeList[r]._seriesIndex,
					d = this.shapeList[r]._dataIndex,
					v = l + "_" + d;
				...
				for (var r = 0, i = f.length; r < i; r++) {
					l = f[r]._seriesIndex;
					if (n[l]) {
						d = f[r]._dataIndex + p[l],
						v = l + "_" + d,
						m = s[v];
						if (!m)
							continue;
						if (f[r].type == "sector")
							m != "delete" ? this.zr.animate(f[r].id, "style").when(400, {
							...
							if (m == "delete")
								this.zr.delShape(f[r].id);
							else
								switch (f[r].type) {
								case "text":
									m = o[v],
									this.zr.animate(f[r].id, "style").when(400, {
										x : m.style.x,
										y : m.style.y
									}).start();
									break;
				...
				for (var u = 0, l = this.shapeList.length; u < l; u++)
					if (this.shapeList[u].id == r.id) {
						...
						if (!i._hasSelected) {
							...
							r.style._hasSelected = !0,
							this._selected[s][o] = !0,
							r.style._x = r.style.x,
							r.style._y = r.style.y,
							n = this.query(t[s], "selectedOffset"),
							r.style.x += c.cos(h, !0) * n,
							r.style.y -= c.sin(h, !0) * n
						} else
							r.style.x = r.style._x, r.style.y = r.style._y, r.style._hasSelected = !1, this._selected[s][o] = !1;
						this.zr.modShape(r.id, r)
					} else
						this.shapeList[u].style._hasSelected && this._selectedMode == "single" && (s = f.get(this.shapeList[u], "seriesIndex"), o = f.get(this.shapeList[u], "dataIndex"), this.shapeList[u].style.x = this.shapeList[u].style._x, this.shapeList[u].style.y = this.shapeList[u].style._y, this.shapeList[u].style._hasSelected = !1, this._selected[s][o] = !1, this.zr.modShape(this.shapeList[u].id, this.shapeList[u]));
	...
	r("_chart", ["require", "echarts/chart/gauge", "echarts/chart/funnel", "echarts/chart/scatter", "echarts/chart/k", "echarts/chart/radar", "echarts/chart/chord", "echarts/chart/force", "echarts/chart/line", "echarts/chart/bar", "echarts/chart/pie"], function (e) {
		...
		e("echarts/chart/k"),
		e("echarts/chart/radar"),
		e("echarts/chart/chord"),
		e("echarts/chart/force"),
