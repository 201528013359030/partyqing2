...
//		"url":SERVER_IP+"/question/web/index.php?r=test/list&uid="+NATIVE_UID+"&p="+page
		"url":SERVER_IP+"/partyqing2/backend/web/index.php?r=leamaterial/api&method=Leamaterial.list.get",
		"arr":{"info":info},
		"type":"post"
	};
	//获取数据
...
//	alert(info);
	var arr = {
//		"url":SERVER_IP+"/question/web/index.php?r=test/list&uid="+NATIVE_UID+"&p="+page
		"url":SERVER_IP+"/partyqing2/backend/web/index.php?r=leamaterial/api&method=Leamaterial.search.get",
		"arr":{"info":info},
		"type":"post"
	};
	//获取数据
...
//		"url":SERVER_IP+"/question/web/index.php?r=test/info&id="+bankid,
			"url":SERVER_IP+"/partyqing2/backend/web/index.php?r=leamaterial/api&method=Leamaterial.data.get",
			"arr":{"info":info},
			"type":"post"
	};
